<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmVerifyAndConfirmOptionForm.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound2.frmVerifyAndConfirmOptionForm" %>
                    ...
                    <tr>
                        <td align="center" colspan="3">
                            ...
                            <asp:Button ID="btnpassword" runat="server" Text="Verify Password" CssClass="InputButton"
                                OnClick="btnpassword_Click" ValidationGroup="password" Style="font-size: medium; font-weight: bold; background-color: red;" />
