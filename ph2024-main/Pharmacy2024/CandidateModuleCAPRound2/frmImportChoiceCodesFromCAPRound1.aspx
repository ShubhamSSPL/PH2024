<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmImportChoiceCodesFromCAPRound1.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound2.frmImportChoiceCodesFromCAPRound1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Import Options from CAP Round-I">
            ...
            <ContentTemplate>
                <div class="table-responsive">
                    <table class="AppFormTable">
                        <tr>
                            <td style="width: 50%;" align="right">Would you like to Import Options filled by You in CAP Round-I</td>
                            <td style="width: 50%;">
                            ...
                            <asp:RadioButton ID="rbnNo" runat="server" GroupName="ImportOptions" Text="&nbsp;&nbsp;No" AutoPostBack="true" OnCheckedChanged="ImportOptions_CheckedChanged" />
                                <asp:CustomValidator ID="cvImportOptions" runat="server" ClientValidationFunction="checkImportOptions" Display="None" ErrorMessage="Please Select Import Options from CAP Round-I Status."></asp:CustomValidator>
                            </td>
                        </tr>
                            ...
                            <td colspan="2">
                                <asp:GridView ID="gvOptionsList" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass="DataGrid" BorderWidth="1px">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="InstituteCode" HeaderText="Institute Code" HtmlEncode="false">
                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Bold="true" Width="5%" CssClass="Header" />
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="middle" CssClass="Item" />
                                        </asp:BoundField>
