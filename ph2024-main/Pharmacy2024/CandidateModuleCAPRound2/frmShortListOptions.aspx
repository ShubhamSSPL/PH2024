<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmShortListOptions.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound2.frmShortListOptions" %>
                            ...
                            <div class="row w-100 mx-auto">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-lg-6 text-left">
                                            <asp:DropDownList ID="ddlTFWSStatus" Width="90%" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTFWSStatus_SelectedIndexChanged">
                    ...
                    <tr>
                        <td colspan="4">
                            <ol class="list-text">
                                ...
                                <li>
                                    <p align="justify">Select Course Name, University, District, Status, Autonomy Status and Minority Status and Click on 'Search Institute' Button. A list of all Institutes under that Course will be displayed.</p>
                                </li>
                                <li>
                                    <p align="justify">You can click on check box given in front of Institutes in Select column to choose Institute of your choice. You can select any number of Institutes. After selecting Institutes Click on 'Add Selected Options' Button.</p>
                                </li>
                                <li>
                                    <p align="justify">You can repeat this process. All options selected by you are saved as 'Your Shortlisted Options'.</p>
                                </li>
                                <li>
                                    <p align="justify">In case you want to remove some options selected by you, then click on check box given in front of Institutes in 'Your Shortlisted Options'. After selecting Institutes Click on 'Delete Selected Options' Button.</p>
                                </li>
                                <li>
                                    <p align="justify">After shortlisting your all options, click on 'Save & Proceed' Button.</p>
                                </li>
                                <li>
                                    <p align="justify"><b>TFWS</b> - Tuition Fee Waiver Scheme. Seats available for admission as per AICTE's Tuition Fee Waiver Scheme under this course.</p>
                                </li>
