...
namespace Pharmacy2024.CandidateModuleCAPRound2
{
    public partial class frmConfirmOptionForm : System.Web.UI.Page
    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            if (reg.GetPreferancedOptionsListOnlyTFWSSelectCap2(objSessionData.PID))
            {
            ...
            {
                Response.Redirect("../CandidateModuleCAPRound2/frmVerifyAndConfirmOptionForm.aspx?tms=101", true);
            }
        }
