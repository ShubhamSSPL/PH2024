    ...
    public partial class frmOptionFormSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound2(objSessionData.PID, "frmOptionFormSummary.aspx");
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.saveOptionFormSummaryStepIDCAPRound2(objSessionData.PID, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    if (objSessionData.StepIDCAPRound2 < 3)
                    {
                        ((SessionData)Session["SessionData"]).StepIDCAPRound2 = 3;
                    }
