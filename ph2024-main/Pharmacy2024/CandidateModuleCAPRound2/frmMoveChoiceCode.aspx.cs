    ...
    public partial class frmMoveChoiceCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound2(objSessionData.PID, "frmMoveChoiceCode.aspx");
        ...
        protected void btnMove_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.moveOptionCAPRound2(objSessionData.PID, PreferenceNo, ChoiceCode, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
