<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPage.Master" AutoEventWireup="true" CodeBehind="frmResetPasswordUsingEMailVerificationStep1.aspx.cs" Inherits="Pharmacy2024.CandidateAccountRecoveryModule.frmResetPasswordUsingEMailVerificationStep1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Reset password using a reset link sent via E-Mail">
