...
{
    public partial class frmEditCancelAdmission : System.Web.UI.Page
    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.editCancelAdmissionByChoiceCode(PID, ChoiceCode, CAPRound, Convert.ToInt64(txtCancellationCharge.Text), txtRemark.Text, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
