<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCancelSelfVerification.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmCancelSelfVerification" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderVisible="false">
        ...
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td>Remark :
                    <br />
                    <asp:TextBox ID="txtComment" runat="server" Width="90%" MaxLength="300"></asp:TextBox>
                    <font color="red"><sup>*</sup></font>
                    <asp:RequiredFieldValidator ID="rfvCandidateName" runat="server" ErrorMessage="Please Enter Cancellation Remark." ControlToValidate="txtComment" Display="None"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td align="center" width="100%">
                    <asp:Button ID="btnProceed" runat="server" Text="Reset the Self Verification and Cancel Seat Acceptance" CssClass="InputButton" OnClick="btnProceed_Click" />
