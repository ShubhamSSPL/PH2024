<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmAllotmentReportForInstitute.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmAllotmentReportForInstitute" %>

<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Choice Code Wise Allotment cum Seat Acceptance Status Report" Width = "100%" Height = "400px" ScrollBars = "auto">
        ...
        <asp:GridView ID="gvReport" runat="server" ShowFooter="true" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass = "DataGrid">
            <Columns>
                ...
                <asp:HyperLinkField DataTextField = "ChoiceCodeDisplay" DataNavigateUrlFields="ChoiceCode,ChoiceCodeDisplay" DataNavigateUrlFormatString = "frmAllotmentReport.aspx?ChoiceCode={0}&ChoiceCodeDisplay={1}" HeaderText = "Choice Code">
