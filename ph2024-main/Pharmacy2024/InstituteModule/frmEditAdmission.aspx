<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmEditAdmission.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmEditAdmission" %>
        ...
        <asp:UpdatePanel runat="server" ID="upConfirmAdmission">
            <ContentTemplate>
                <table class="AppFormTable">
                    ...
                    <tr>
                        <td align="right">Name As Per MHTCET Result</td>
                        <td colspan="2">
