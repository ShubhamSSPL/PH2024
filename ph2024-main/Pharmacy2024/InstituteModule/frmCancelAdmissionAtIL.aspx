<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCancelAdmissionAtIL.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmCancelAdmissionAtIL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Cancel Candidate Admission">
        ...
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <asp:Button ID="btnProceed" runat="server" Text="Cancel Candidate Admission" CssClass="InputButton" OnClick="btnProceed_Click" />
