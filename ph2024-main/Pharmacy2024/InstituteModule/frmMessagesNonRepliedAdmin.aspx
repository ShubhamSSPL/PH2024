<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesNonRepliedAdmin.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmMessagesNonRepliedAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class = "AppFormTableWithOutBorder">
            <tr align = "center">
                <td><a href="../InstituteModule/frmMessagesNonRepliedAdmin.aspx"><font size = "2" color = "red"><b>|Non Replied Messages|</b></font></a></td>
