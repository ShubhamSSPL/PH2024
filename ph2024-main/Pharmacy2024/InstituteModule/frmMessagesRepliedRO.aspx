<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesRepliedRO.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmMessagesRepliedRO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class = "AppFormTableWithOutBorder">
            <tr align = "center">
                ...
                <td><a href="../InstituteModule/frmMessagesRepliedRO.aspx"><font size = "2" color = "red"><b>|Replied Messages|</b></font></a></td>
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Replied Messages Sent By Institutes" Width = "100%" Height = "300px" ScrollBars = "Auto">
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth = "1px" BorderStyle = "Solid" CssClass="DataGrid">
            <Columns>
                ...
                <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode = "false">
                    <ItemStyle Width="24%" HorizontalAlign="Left" CssClass="Item"/>
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
