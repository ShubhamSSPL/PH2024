<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCompositeReportByReligion.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmCompositeReportByReligion" %>

<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Composite Report By Religion" Width = "100%" ScrollBars = "auto">
