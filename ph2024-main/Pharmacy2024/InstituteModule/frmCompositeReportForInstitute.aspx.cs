...
{
    public partial class frmCompositeReportForInstitute : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ContentTable2.HeaderText = "Choice Code Wise Composite Report for " + reg.getInstituteName(InstituteCode);

                    gvReport.DataSource = reg.getCompositeReportForInstitute(InstituteCode, ddlCourseType.SelectedValue, ddlTNA.SelectedValue);
                    gvReport.DataBind();
                    ...
                    for (Int32 i = 0; i < gvReport.Rows.Count; i++)
                    {
                        ...
                        //CAPAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[4].Controls[0]).Text);
                        //CAPAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[5].Controls[0]).Text);
                        CAPAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[4].Controls[0]).Text);
                        CAPCancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[5].Controls[0]).Text);
                        CAPVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[6].Text);
                        ACAPIntake += Convert.ToInt64(gvReport.Rows[i].Cells[7].Text);
                        //ACAPAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[10].Controls[0]).Text);
                        //ACAPAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[11].Controls[0]).Text);
                        ACAPAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[8].Controls[0]).Text);
                        ACAPCancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[9].Controls[0]).Text);
                        ACAPVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[10].Text);
                        CAPMIIntake += Convert.ToInt64(gvReport.Rows[i].Cells[11].Text);
                        //CAPMIAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[16].Controls[0]).Text);
                        //CAPMIAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[17].Controls[0]).Text);
                        CAPMIAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[12].Controls[0]).Text);
                        CAPMICancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[13].Controls[0]).Text);
                        CAPMIVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[14].Text);
                        ACAPMIIntake += Convert.ToInt64(gvReport.Rows[i].Cells[15].Text);
                        //ACAPMIAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[22].Controls[0]).Text);
                        //ACAPMIAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[23].Controls[0]).Text);
                        ACAPMIAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[16].Controls[0]).Text);
                        ACAPMICancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[17].Controls[0]).Text);
                        ACAPMIVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[18].Text);
                        ILIntake += Convert.ToInt64(gvReport.Rows[i].Cells[19].Text);
                        //ILAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[28].Controls[0]).Text);
                        //ILAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[29].Controls[0]).Text);
                        ILAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[20].Controls[0]).Text);
                        ILCancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[21].Controls[0]).Text);
                        ILVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[22].Text);
                        TotalIntake += Convert.ToInt64(gvReport.Rows[i].Cells[23].Text);
                        //TotalAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[34].Controls[0]).Text);
                        //TotalAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[35].Controls[0]).Text);
                        TotalAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[24].Controls[0]).Text);
                        TotalCancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[25].Controls[0]).Text);
                        TotalVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[26].Text);
                        JKIntake += Convert.ToInt64(gvReport.Rows[i].Cells[27].Text);
                        //JKAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[40].Controls[0]).Text);
                        //JKAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[41].Controls[0]).Text);
                        JKAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[28].Controls[0]).Text);
                        JKCancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[29].Controls[0]).Text);
                        JKVacancy += Convert.ToInt64(gvReport.Rows[i].Cells[30].Text);
                        //OAAAdmittedBefore += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[45].Controls[0]).Text);
                        //OAAAdmittedAfter += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[46].Controls[0]).Text);
                        OAAAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[31].Controls[0]).Text);
                        OAACancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[32].Controls[0]).Text);
                        ...
                        TotalEWSAdmitted += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[34].Controls[0]).Text);
                        TotalEWSCancelled += Convert.ToInt64(((HyperLink)gvReport.Rows[i].Cells[35].Controls[0]).Text);
        ...
        protected void ddlTNA_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet ds = reg.getCompositeReportForInstitute(InstituteCode, ddlCourseType.SelectedValue, ddlTNA.SelectedValue);
