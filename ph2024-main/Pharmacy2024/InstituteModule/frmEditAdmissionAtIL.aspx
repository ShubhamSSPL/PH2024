<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmEditAdmissionAtIL.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmEditAdmissionAtIL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <script language="javascript" type = "text/javascript">
        ...
        function isSelectedDateValid(sender, args) {
            var admissionDate = document.getElementById("rightContainer_ContentTable2_txtAdmissionDate").value;
            var reportingDate = document.getElementById("<%=hdnReportingDateTime.ClientID %>").value; //'08/12/2013 00:00 '

            //var splitStartDate = admissionDate.split(' ');
            var startDateArray = admissionDate.split('/');

            //var admDate = new Date(admissionDate).getTime();
            var admDate = new Date(startDateArray[1] + '/' + startDateArray[0] + '/' + startDateArray[2] + ' 00:00:00 AM' ).getTime();
            var rptDate = new Date(reportingDate).getTime();

           // return admDate >= rptDate;
            if (admDate >= rptDate) {
                args.IsValid = false;
                return;
            }
        ...
        function isValidCutOffDate(sender, args) {
            var admissionDate = document.getElementById("rightContainer_ContentTable2_txtAdmissionDate").value;
            var cutOffDate = document.getElementById("<%=hdnCutOffDateTime.ClientID %>").value; //'08/12/2013 00:00 '
            ...
            //var admDate = new Date(admissionDate).getTime();
            var admDate = new Date(startDateArray[1] + '/' + startDateArray[0] + '/' + startDateArray[2] + ' 00:00:00 AM').getTime();
            var ctfDate = new Date(cutOffDate).getTime();
        ...
        function isAdmissionDateValid(sender, args) 
        {
            var dateStr = document.getElementById("rightContainer_ContentTable2_txtAdmissionDate").value;
            if (dateStr.length == 0) 
            {
                args.IsValid = false;
                return;
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Edit Candidate Admission">
        <asp:HiddenField ID="hdnReportingDateTime" runat="server" />
        <asp:HiddenField ID="hdnCutOffDateTime" runat="server" />
        <asp:UpdatePanel runat="server" ID="upConfirmAdmission">
            <ContentTemplate>
                ...
                <tr>
                    ...
                    <tr>
                        <th align = "left" colspan = "4">Admission Details</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">Course Admitted</td>
                        <td colspan = "3"><asp:Label id="lblCourseAllotted" runat="server" Font-Bold = "true"></asp:Label></td>
                    </tr>
                    <tr>
                        <td align="right">Choice Code Admitted</td>
                        <td><asp:Label id="lblChoiceCodeAllotted" runat="server" Font-Bold = "true"></asp:Label></td>
                        <td align="right">Seat Type Admitted</td>
                        <td><asp:Label id="lblSeatTypeAllotted" runat="server" Font-Bold = "true"></asp:Label></td>
                    </tr>
                    <tr>
                        <th align = "left">Fee Details</th>
                    ...
                    <tr id = "trCash" runat = "server">
                        ...
                        <td colspan = "2">
                            <asp:TextBox ID="txtCashAmount" Runat="server" onKeyPress="return numbersonly(event)"></asp:TextBox>
                            <font color="red">*</font>
                    ...
                    <tr id = "trInstitute" runat = "server">
                        <td align="right">Select Institute</td>
                        <td colspan = "3">
                           <asp:DropDownList ID="ddlInstitute" runat="server" Width = "95%" AutoPostBack = "true" OnSelectedIndexChanged = "ddlInstitute_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td colspan = "3">
                            <asp:DropDownList ID="ddlCourse" runat="server" Width = "95%"></asp:DropDownList>
                            <font color = "red"><sup>*</sup></font>
                    ...
                    <tr>
                        <td align="right">Select Seat Type</td>
                        <td colspan = "3">
                            <asp:DropDownList ID="ddlSeatType" runat="server" Width = "95%"></asp:DropDownList>
                            <font color = "red"><sup>*</sup></font>
                            <asp:CompareValidator ID="cvSeatType" runat="server" ControlToValidate="ddlSeatType" Display="None" ErrorMessage="Please Select Seat Type." Operator="NotEqual" ValueToCompare="0"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">Institute Level Merit No</td>
                        <td colspan = "3">
                            <asp:TextBox ID="txtMeritNo" runat="server" MaxLength = "7" onKeyPress="return numbersonly(event)" Width = "100px"></asp:TextBox>
                            <font color = "red"><sup>*</sup></font>
                            <asp:RequiredFieldValidator ID="rfvMeritNo" runat="server" ErrorMessage="Please Enter Institute Level Merit Number." ControlToValidate="txtMeritNo" Display='none'></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revMeritNo" runat="server" ErrorMessage="Institute Level Merit Number should be Numeric." ControlToValidate="txtMeritNo" Display="None" ValidationExpression="[0-9]+"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">Date Of Admission</td>
		                <td >
	                        <asp:TextBox  ID="txtAdmissionDate" runat="server" MaxLength="10"></asp:TextBox>
                            <font color="red"><b>*</b></font>
                            <asp:RequiredFieldValidator ID="rfvAdmissionDate" Runat="server" ErrorMessage="Please Enter Date Of Admission." ControlToValidate="txtAdmissionDate" Display="None"></asp:RequiredFieldValidator>
                            <asp:CustomValidator ID="cvAdmissionDate" runat="server" ControlToValidate="txtAdmissionDate" ClientValidationFunction="isAdmissionDateValid" Display="None" ErrorMessage="Please Enter Proper Date of Admission."></asp:CustomValidator>
                            <asp:CustomValidator ID="cvValidAdmissionDate" runat="server" ControlToValidate="txtAdmissionDate" ClientValidationFunction="isSelectedDateValid" Display="None" ErrorMessage="Date of Admission should be less than or equal to Date of Reporting/Uploading."></asp:CustomValidator>
                        </td>
                        <td align="right">Date Of Reporting/Uploading</td>
                        <td>
                            <asp:Label id="lblReportedOn" runat="server" Font-Bold="True"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">Institute Remark</td>
        ...
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <asp:Button ID="btnProceed" runat="server" Text="Edit Candidate Admission" CssClass="InputButton" OnClick="btnProceed_Click" />
                    <asp:CustomValidator ID="cvIsDateofAdmissionValid" runat="server" ClientValidationFunction="isSelectedDateValid" Display="None" ErrorMessage="Admission Date should not be greater than Date Of Reporting/Uploading."></asp:CustomValidator>
                     <asp:CustomValidator ID="cvIsValidCutOffDate" runat="server" ClientValidationFunction="isValidCutOffDate" Display="None" ErrorMessage="Admission Date should not be greater than Cut-off Date."></asp:CustomValidator>
