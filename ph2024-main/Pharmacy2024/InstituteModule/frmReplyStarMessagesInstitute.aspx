<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" AutoEventWireup="true" CodeBehind="frmReplyStarMessagesInstitute.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmReplyStarMessagesInstitute" %>
        ...
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="DataGrid" OnRowCommand="gvMessages_RowCommand" OnRowDataBound="gvMessages_RowDataBound">
            <Columns>
                <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode = "false">
                    <ItemStyle Width="35%" HorizontalAlign="Left" CssClass="Item" VerticalAlign="Top" />
               ...
               <%-- <asp:TemplateField HeaderText = "Reply Message">
                    <ItemTemplate>
                        ...
                        <br />
                        <asp:checkbox id="chkIsStarMarked" runat="server" Text="Mark as Star" Checked='<%# DataBinder.Eval(Container,"DataItem.IsStarMarked")%>'/>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText = "Reply Message">
                    <ItemTemplate>
                        ...
                        <asp:TextBox ID="txtRepliedMessage" runat="server" MaxLength = "1000" Height="80" TextMode="MultiLine" Width="100%"></asp:TextBox>
                        <br />
                         <asp:checkbox id="chkIsStarMarked" runat="server" Text="Mark as Star" Checked='<%# DataBinder.Eval(Container,"DataItem.IsStarMarked")%>' Enabled="false"/>
                    </ItemTemplate>
                    <ItemStyle Width="60%" HorizontalAlign="Center" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:TemplateField>
                <asp:ButtonField HeaderText = "Reply" ButtonType = "Button" CommandName = "Reply" Text = "Reply" ControlStyle-CssClass = "InputButton">
                    <ItemStyle Width="5%" HorizontalAlign="Center" CssClass="Item" VerticalAlign="Bottom" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
