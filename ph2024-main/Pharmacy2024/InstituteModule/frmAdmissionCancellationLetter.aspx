<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmAdmissionCancellationLetter.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmAdmissionCancellationLetter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <script language="javascript" type = "text/javascript">
        ...
        {
            window.open("frmPrintAdmissionCancellationLetter.aspx?PID=<% = PID %>&ChoiceCode=<% = ChoiceCode %>&CAPRound=<% = CAPRound %>", "Password", "width=1000px,height=500px,resizable=yes,scrollbars=yes");
        }
    </script>
        ...
        <table class="AppFormTable">
            ...
            <tr> 
                <td colspan = "4">
                    ...
                    <br />
                    <p align = "justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        We herewith declare that, we are cancelling the confirmed admission of this Candidate for the acedamic year <%= AdmissionYear %> based on the written consent of the Candidate. All the submitted original documents  are returned to the Candidate. The fees paid by the Candidate is refunded after deductting the cancellation charges mentioned above.
                    </p>
                </td>
            </tr>
            <tr>
