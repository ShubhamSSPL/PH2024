<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesComposeInstitute.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmMessagesComposeInstitute" %>
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../InstituteModule/frmMessagesComposeInstitute.aspx"><font size="2" color="red"><b>&nbsp;&nbsp;|&nbsp;&nbsp;Compose Message&nbsp;&nbsp;|&nbsp;&nbsp;</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Compose Message">
            ...
            <tr>
                <td>
                    <font color="red">
                        <ol class="list-text">
                            <b>Note :</b>
                            <li>If you have already sent a message and that is not replied by ADMIN, then please don't send message again for same purpose.</li>
                        </ol>
                    </font>
                    <br />
                </td>
        ...
        <div class="table-responsive" style="padding: 0px 20px;">
            ...
            <div class="msgtable">
                ...
                <div class="msgtbRight">
                    <input id="fileInput1" type="file" runat="server" style="height: 100%; display: none;" class="width-password" />
                    (Only .JPG, .JPEG, .PDF Formats Supported)
                    <br />
