<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSeatMatrixVerificationStatusReport.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmSeatMatrixVerificationStatusReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Seat Matrix Verification Status Report">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="card">
                ...
                <div class="card-body">
                    <asp:GridView ID="gvInstituteList" runat="server" AutoGenerateColumns="False" Width="100%" OnPreRender="gvReport_PreRender" CssClass="Datagrid  DataGridForBootstrap">
                        <Columns>
                            ...
                            <asp:BoundField DataField="VerificationStatus" HeaderText="Is Seat Matrix Found OK">
    ...
    <script>
        var handleDataTableButtons = function () {
            "use strict";
            0 !== $('#<%= gvInstituteList.ClientID %>').length && $('#<%= gvInstituteList.ClientID %>').DataTable({
                dom: "Bfrtip",
                paging: true,
                buttons: [{
                    extend: "excel",
                    ...
                    title: 'Seat Matrix Verification Status Report'
                }],
                responsive: !0,
                ordering: false,
                info: true,
