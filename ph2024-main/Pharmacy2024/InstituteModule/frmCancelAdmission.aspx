<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCancelAdmission.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmCancelAdmission" %>
            ...
            <ContentTemplate>
                <table class="AppFormTable">
                    ...
                    <tr>
                        ...
                        <td colspan = "3"><asp:TextBox ID="txtRemark" runat="server" TextMode = "MultiLine" Width = "98%" Rows = "3"></asp:TextBox>
                            <font color="red"><sup>*</sup></font>
                        </td>
                        <asp:RequiredFieldValidator ID="rfReasonforCancellation" runat="server" ErrorMessage="Please Enter Reason for Cancellation" ControlToValidate="txtRemark" Display="None"></asp:RequiredFieldValidator>
                    </tr> 
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>
