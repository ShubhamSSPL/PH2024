<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesSentRO.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmMessagesSentRO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox2" runat="server" HeaderVisible="false">
        <table class = "AppFormTableWithOutBorder">
            <tr align = "center">
                ...
                <td><a href="../InstituteModule/frmMessagesComposeRO.aspx"><font size = "2"><b>|Compose Message|</b></font></a></td>
                <td><a href="../InstituteModule/frmMessagesSentRO.aspx"><font size = "2" color = "red"><b>|Sent Messages|</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Sent Messages to Institutes" Height = "200px" ScrollBars = "Auto">
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="DataGrid">
            <Columns>
                ...
                <asp:BoundField DataField="SentTo" HeaderText="Sent To" HtmlEncode = "false">
                    <ItemStyle Width="13%" HorizontalAlign="Center" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
                <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode = "false">
                    <ItemStyle Width="70%" HorizontalAlign="Left" CssClass="Item"  />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
    ...
    <br />
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderText="Sent Messages to Admin" Height = "200px" Width = "100%" ScrollBars = "Auto">
        <asp:GridView ID="gvMessagesAdmin" runat="server" AutoGenerateColumns="False" Width="100%" CssClass = "DataGrid">
            <Columns>
                ...
                <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode = "false">
                    <ItemStyle Width="40%" HorizontalAlign="Left" CssClass = "Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass = "Header" />
                </asp:BoundField>
                <asp:BoundField DataField="SentDateTime" HeaderText="Sent Time">
                    <ItemStyle Width="10%" HorizontalAlign="Center" CssClass = "Item" />
                ...
                <asp:BoundField DataField="RepliedMessage" HeaderText="Reply">
                    <ItemStyle Width="33%" HorizontalAlign="Left" CssClass = "Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass = "Header" />
                </asp:BoundField>
        ...
        <table runat = "server" id = "tblMsgAdmin" visible="false" class = "AppFormTable">
            <tr>
                <th height = "60" align="center" valign = "middle">
                    <asp:Label ID="Label1" runat="server" Text="There is no Message in your Sent Messages to Admin" Font-Bold="True" Font-Size="Small"></asp:Label>
                </th>
            </tr>
        </table>
    </cc1:ContentBox>
