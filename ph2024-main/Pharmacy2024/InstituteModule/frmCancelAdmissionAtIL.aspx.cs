...
{
    public partial class frmCancelAdmissionAtIL : System.Web.UI.Page
    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.cancelAdmissionAtIL(PID, ChoiceCode, Convert.ToInt64(txtCancellationCharge.Text), txtRemark.Text, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    ...
                    if (Global.SendSMSToCandidate == 1)
                        synCommon.SendInformationSMS(sMSTemplate, SynCommon.TemplateSystemType.CanceledAdmissionInstitueAtIL);
