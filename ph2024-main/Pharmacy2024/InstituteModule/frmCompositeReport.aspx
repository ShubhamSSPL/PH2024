<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCompositeReport.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmCompositeReport" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Candidate List">
        ...
        <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" Width="100%" CssClass = "DataGrid">
            <Columns> 
                ...
                <asp:BoundField DataField = "ReportingStatus" HeaderText = "Reporting Status">
                    <ItemStyle HorizontalAlign="Center" CssClass = "Item" Width="8%" />
                    <HeaderStyle HorizontalAlign="Center" CssClass = "Header" />
                </asp:BoundField>
                <asp:BoundField DataField = "ReportingDateTime" HeaderText = "Reporting Date Time">
