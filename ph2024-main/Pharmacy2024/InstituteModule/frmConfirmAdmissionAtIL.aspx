<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmConfirmAdmissionAtIL.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmConfirmAdmissionAtIL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Admit Candidate at Institute Level">
        <asp:UpdatePanel runat="server" ID="upConfirmAdmission">
            <ContentTemplate>
                ...
                <tr>
                    ...
                    <tr>
                         <td align="right" colspan="2">Mobile No Registered.</td>
                        <td colspan="2"><asp:Label id="lblMobileNo" runat="server" Font-Bold = "true"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <table id="tblOtp" runat="server" class="AppFormTable" visible="false">
                         <tr>
                             <td align="right" style="width: 40%">Enter One Time Password (OTP) </td>
                             <td>
                                 <asp:TextBox ID="txtOneTimePassword" runat="server" autocomplete="off" MaxLength="6" onKeyPress="return numbersonly(event)"> </asp:TextBox>
                                 <font color="red"><sup>*</sup></font>
                                 <asp:RequiredFieldValidator ID="rfvOneTimePassword" runat="server" ControlToValidate="txtOneTimePassword" Display="None" ErrorMessage="Please Enter One Time Password (OTP)." ValidationGroup="otp"></asp:RequiredFieldValidator>
                                 <asp:RegularExpressionValidator ID="revOneTimePassword" runat="server" ControlToValidate="txtOneTimePassword" Display="None" ErrorMessage="One Time Password (OTP) Should be of 6 Digits." ValidationExpression="\d{6}" ValidationGroup="otp"></asp:RegularExpressionValidator>
                                 <asp:Button ID="btnCall" runat="server" CssClass="InputButton" OnClick="btnCall_Click" Text="Retry on Call" ValidationGroup="call" Visible="false" />
                             </td>
                         </tr>
                    </table>
                    <tr>
        ...
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <asp:Button ID="btnProceed" runat="server" Text="Admit Candidate" CssClass="InputButton" OnClick="btnProceed_Click" />
            ...
            <tr runat="server" id="trotpbtn" visible="false">
                <td align="center" colspan="3">
                    <br />
                    <br />
                    <asp:Button ID="btnVerifyOtp" runat="server" Text="Verify OTP & Confirm Admission"
