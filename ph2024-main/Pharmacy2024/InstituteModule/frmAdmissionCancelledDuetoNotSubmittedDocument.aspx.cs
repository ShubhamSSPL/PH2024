...
{
    public partial class frmAdmissionCancelledDuetoNotSubmittedDocument : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    string UserTypeID = "CancelledDuetoNotSubmittedDocument";

                    gvCandidateList.DataSource = new dbUtility().GetAdmissionCancelledDuetoNotSubmittedDocument(UserTypeID, Session["UserLoginID"].ToString());
        ...
        {
            public DataSet GetAdmissionCancelledDuetoNotSubmittedDocument(string UserTypeID, string UserLoginID)
            {
                SqlParameter[] param =
                    {
