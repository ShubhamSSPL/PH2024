<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmInstituteSummary.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmInstituteSummary" %>

<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %>

<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
     <style>
        #rightContainer_ContentBox2 {
            top:20% !important;
        }
        #rightContainer_ContentBox2_UpdatePanel1{
            height:400px;
            overflow-y:scroll;
        }
    ...
    <script type="text/javascript" src="../OasisModules_Files/Scripts/ContentBox.js"></script>
    ...
    <cc1:ContentBox ID="ContentBox7" runat="server" HeaderText="Course Details">
            ...
            <ContentTemplate>
                <asp:GridView ID="gvChoiceCodeList" runat="server" DataKeyNames = "ChoiceCode" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass = "DataGrid" OnRowCommand = "gvChoiceCodeList_RowCommand">
                    <Columns>
                        ...
                        <asp:BoundField DataField="IsGov" HeaderText="Is Govt">
                            <ItemStyle HorizontalAlign="Center" CssClass = "Item" Width="7%" />
                            <HeaderStyle HorizontalAlign="Center" CssClass = "Header" />
                        </asp:BoundField>
    ...
    <cc1:ContentBox ID="ContentBox2" runat="server" BoxType = "PopupBox" width="70%" HeaderText="Seat Distribution">
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                <table class="AppFormTable">
                    ...
                    <tr>
                        <td style="width: 30%" align="right">Total Intake</td>
                        <td style="width: 20%"><asp:Label ID="lblTotalIntake" runat="server" Font-Bold = "true"></asp:Label></td>
                        <td style="width: 30%" align="right">CAP (Excluding Minority) Intake</td>
                        <td style="width: 20%"><asp:Label ID="lblCAPIntake" runat="server" Font-Bold = "true"></asp:Label></td>
                    </tr>
                    <tr>
                ...
                <table class="AppFormTable">
                    ...
                    <tr>
                         <td align = "center" colspan="13"><b><asp:Label ID="lblPWDCommon" runat="server"></asp:Label></b></td><%--PWD Common Reserved Seats : 1--%>
                    </tr>
                    <tr>
                    ...
                    <tr>
                         <td align = "center" colspan="13"><b><asp:Label ID="lblDEFCommon" runat="server"></asp:Label></b></td><%--DEF Common Reserved Seats : 1--%>
                    </tr>
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>
