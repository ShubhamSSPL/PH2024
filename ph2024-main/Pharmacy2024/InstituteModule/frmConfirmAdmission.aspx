<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmConfirmAdmission.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmConfirmAdmission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Confirm Admission">
        <asp:UpdatePanel runat="server" ID="upConfirmAdmission">
            <ContentTemplate>
                <table class="AppFormTable">
                    ...
                    <tr>
                        <th align = "left" colspan = "4">Required Document Details</th>
                    </tr>
                    <tr>
                        <td colspan = "4">
                            <asp:GridView ID="gvDocuments" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth = "1px" CssClass="DataGrid" OnRowDataBound="gvDocuments_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Submitted">
                                        <ItemTemplate><asp:RadioButton ID="rbnYes" runat="server" Text = "&nbsp;Submited" GroupName = "YesNo" /></ItemTemplate>  
                                        <ItemStyle HorizontalAlign="Center" CssClass="Item" Width = "12%" />
                                        <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Not Submitted">
                                        <ItemTemplate><asp:RadioButton ID="rbnNo" runat="server" Text = "&nbsp;Not Submited" GroupName = "YesNo" /></ItemTemplate>  
                                ...
                                <ItemStyle HorizontalAlign="Center" Width="8%" />
                                    ...
                                    <asp:TemplateField Visible="False">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsSubmittedAtinstitute" runat="server" Text='<%# Eval("IsSubmittedAtinstitute") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField> 
                                    <asp:TemplateField Visible="False">
                                        <ItemTemplate>
                    ...
                    <tr>
		                ...
		                <td colspan = "3">
	                        <asp:TextBox  ID="txtAdmissionDate" runat="server" Enabled="false" MaxLength="10"></asp:TextBox>
        ...
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <asp:Button ID="btnProceed" runat="server" Text="Confirm Candidate" CssClass="InputButton" OnClick="btnProceed_Click" />
