<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCompositeReportForAdmin.aspx.cs" Inherits="Pharmacy2024.InstituteModule.frmCompositeReportForAdmin" %>

<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Region Wise Composite Report" Width = "100%" Height="400px" ScrollBars = "auto">
