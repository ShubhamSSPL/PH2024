...
var iNettuts = {
    ...
    init : function () {   
        this.attachStylesheet('../SynthesysModules_Files/inettuts/inettuts.js.css');
        this.sortWidgets();
    ...
    addWidgetControls : function () {
        ...
        $(settings.widgetSelector, $(settings.columns)).each(function () {
            ...
            if (thisWidgetSettings.editable) {
                ...
                $('<div class="edit-box" style="display:none;"/>')
                    .append('<ul><li class="item"><label>Change the title?</label><input value="' + $('h6',this).text() + '"/></li>')
                    .append((function(){
        ...
        $('.edit-box').each(function () {
            $('input',this).keyup(function () {
                $(this).parents(settings.widgetSelector).find('h6').text( $(this).val().length>10 ? $(this).val().substr(0,10)+'...' : $(this).val() );
                iNettuts.savePreferences();
            });
...
//            //path: '/'
//        });
            document.getElementById('ctl00_rightContainer_HdnCookie').value=cookieString;        
            var atk;
        atk = new Synthesys.AjaxTimeKeeper(new Array(4,8,12),document.getElementById('ctl00_rightContainer_ContentTable1_LblPanel2'),'<b>Fetching</b>', '../SynthesysModules_Files/Images/BigProgress.gif');
            atk.Start('AppForm_WelcomePage.SaveData',cookieString,SaveData_Callback);  
    ...
    sortWidgets : function () {
        ...
        var cookie=document.getElementById('ctl00_rightContainer_HdnCookie').value;
