		...
		*/
		...
		this.renderSingleAgendaItem = function(agi){
			...
			if((DateUtil.daysDifference(firstRenderDate,lastRenderDate) + firstDtIndex) > 6){
				...
				//this.getCalendarDayObjByDate(firstRenderDate).jqyObj[0].parentNode.previousSibling.childNodes
//				var temp=this.getCalendarDayObjByDate(firstRenderDate);
//				for(var i=0;i<temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes.length;i++)
//				{
//				  if(temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].innerText.trim()==String(firstRenderDate.getDay()))
//				  {
//				    temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
//				  }
//				  
//				}
//				 temp=this.getCalendarDayObjByDate(lastDaySameWeekDate);
//				for(var i=0;i<temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes.length;i++)
//				{
//				  if(temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].innerText.trim()==String(lastDaySameWeekDate.getDay()))
//				  {
//				    temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
//				  }
//				  
...
//						 temp=this.getCalendarDayObjByDate(firstDayNextWeekDate);
//				for(var i=0;i<temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes.length;i++)
//				{
//				  if(temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].innerText.trim()==String(firstDayNextWeekDate.getDay()))
//				  {
//				    temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
//				  }
//				  
...
//				  
//				}
//				 temp=this.getCalendarDayObjByDate(lastRenderDate);
//				for(var i=0;i<temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes.length;i++)
//				{
//				  if(temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].innerText.trim()==String(lastRenderDate.getDay()))
//				  {
//				    temp.jqyObj[0].parentNode.previousSibling.previousSibling.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
//				  }
//				  
...
//				}	
		...
		this.addMoreDivToDays = function(startDayObj,endDayObj,moreDivHeight){
			...
			d.css("top",startY+"px");
			//d.css("left",(startX+8)+"px");
			d.css("left",(startX)+"px");
			d.css("width",width+"px");
			d.css("height",moreDivHeight+"px");
			startDayObj.addMoreDiv(d);
            //startDayObj.setCss("background-color","#00C000");
            temp=startDayObj;
           
			for(var i=0;i<startDayObj.jqyObj[0].parentNode.previousSibling.childNodes.length;i++)
			{
			  if(startDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i].innerHTML.trim()==parseInt(String(startDayObj.getDate()).split(" ")[2])+'&nbsp;')
			  {
			    //startDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
			    startDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i].className=startDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i].className+" small-event";
			    var f=$(startDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i]);
			    f.bind(
				'click',
				{
...
//			 temp=endDayObj;
//			for(var i=0;i<endDayObj.jqyObj[0].parentNode.previousSibling.childNodes.length;i++)
//			{
//			  if(endDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i].innerText.trim()==String(endDayObj.getDate()).split(" ")[2])
//			  {
//			    endDayObj.jqyObj[0].parentNode.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
//			  }
//			  
//			}
			...
			while(DateUtil.daysDifferenceDirection(nextDt,endDt) >= 0){
				...
				nextDt = DateUtil.getNextDay(nextDt);
				 temp=startDayObj;
			    for(var i=0;i<nextDatObj.jqyObj[0].parentNode.previousSibling.childNodes.length;i++)
			    {
			      if(nextDatObj.jqyObj[0].parentNode.previousSibling.childNodes[i].innerHTML.trim()==parseInt(String(nextDatObj.getDate()).split(" ")[2])+'&nbsp;')
			      {
			        //nextDatObj.jqyObj[0].parentNode.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
			        nextDatObj.jqyObj[0].parentNode.previousSibling.childNodes[i].className=nextDatObj.jqyObj[0].parentNode.previousSibling.childNodes[i].className+" small-event";
			        var f=$(nextDatObj.jqyObj[0].parentNode.previousSibling.childNodes[i]);
			        f.bind(
				    'click',
				    {
					    // pass calendar, start date, and agenda items so we have access to them in the click handler function.
...
//			    for(var i=0;i<nextDt.jqyObj[0].parentNode.previousSibling.childNodes.length;i++)
//			    {
//			      if(nextDt.jqyObj[0].parentNode.previousSibling.childNodes[i].innerText.trim()==String(nextDt.getDate()).split(" ")[2])
//			      {
//			        nextDt.jqyObj[0].parentNode.previousSibling.childNodes[i].style.backgroundColor="#3399FF";
//			      }
//    			  
//			    }
			}			
...
//			}
		...
		this.addAgendaItemPer = function(item,id){
		
			this.agendaItems.put(id,item);
	...
	var jFrontierCalPlugin = function(
		...
		this.showMonth = function(calId,year,month){
			if(calId != null && year != null && month != null && year.length == 4 && (month.length == 1 || month.length == 2)){
				calId = stripNumberSign(calId);
				// strip any preceeding 0's
				if(month.length == 2) month = month.replace(/^[0]+/g,"");
