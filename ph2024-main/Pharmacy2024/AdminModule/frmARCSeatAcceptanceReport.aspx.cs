...
{
    public partial class frmARCSeatAcceptanceReport : System.Web.UI.Page
    {
        ...
        protected void ddlSeatAcceptanceStatusType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ShowMessage shInfo = (ShowMessage)Master.FindControl("ShowMsg");
            try
            {
        ...
        protected void ddlSeatAcceptanceType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ShowMessage shInfo = (ShowMessage)Master.FindControl("ShowMsg");
            try
            {
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet dsDashboard = new DBUtilityAllotmentReport().getARCCountReport(ddlCAPRound.SelectedValue, "0", "0", ddlSeatAcceptanceStatusType.SelectedValue, ddlSeatAcceptanceType.SelectedValue, "0", "0");
        ...
        {
            string fileName = "ARCSeatAcceptanceReport_" + DateTime.Now.ToString() + ".xls";
    ...
    //public class DBUtilityDailyReport
    //{
