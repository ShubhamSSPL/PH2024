<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesRepliedAdminToCandidate.aspx.cs" Inherits="Pharmacy2024.AdminModule.frmMessagesRepliedAdminToCandidate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class = "AppFormTableWithOutBorder">
            <tr align = "center">
                <td><a href="../AdminModule/frmMessagesNonRepliedAdminToCandidate.aspx"><font size = "2"><b>| Non Replied Messages |</b></font></a></td>
                <td><a href="../AdminModule/frmMessagesRepliedAdminToCandidate.aspx"><font size = "2" color = "red"><b>| Replied Messages |</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Replied Messages">
        ...
        <asp:GridView ID="gvMessages" runat="server" DataKeyNames="MessageID" AutoGenerateColumns="false" OnRowDataBound="gvMessages_RowDataBound" OnSelectedIndexChanging="gvMessages_SelectedIndexChanging" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Message">
                    ...
                    <ItemStyle Width="60%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item"/>
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:TemplateField> 
