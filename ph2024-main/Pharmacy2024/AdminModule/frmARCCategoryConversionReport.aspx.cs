...
{
    public partial class frmARCCategoryConversionReport : System.Web.UI.Page
    {
        ...
        protected void ddlConversionReason_SelectedIndexChanged(object sender, EventArgs e)
        {
            ShowMessage shInfo = (ShowMessage)Master.FindControl("ShowMsg");
            try
            {
        ...
        protected void ddlAllotmentCancellationStatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ShowMessage shInfo = (ShowMessage)Master.FindControl("ShowMsg");
            try
            {
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet dsDashboard = new DBUtilityAllotmentReport().getARCCountReport(ddlCAPRound.SelectedValue, "0", "0", "0", "0", ddlConversionReason.SelectedValue, ddlAllotmentCancellationStatus.SelectedValue);
        ...
        {
            string fileName = "ARCCategoryConversionReport_" + DateTime.Now.ToString() + ".xls";
