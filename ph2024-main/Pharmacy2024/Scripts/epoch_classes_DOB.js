...
Epoch.prototype.calConfig = function () //PRIVATE: initialize calendar variables
{
    ...
    this.displayYearInitial = 2005; //the initial year to display on load
    this.displayMonthInitial = 0; //the initial month to display on load (0-11)
    this.rangeYearLower = 1950;
    this.rangeYearUpper = 2024;
    this.minDate = new Date(1950, 0, 1);
    this.maxDate = new Date(2024, 0, 1);
...
Epoch.prototype.setLang = function ()  //all language settings for Epoch are made here.  Check Date.dateFormat() for the Date object's language settings
{
    ...
    this.months_sh = new Array('January', 'Febuary', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December');
