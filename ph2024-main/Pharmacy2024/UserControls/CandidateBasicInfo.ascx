<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CandidateBasicInfo.ascx.cs" Inherits="Pharmacy2024.UserControls.CandidateBasicInfo" %>


<table class="AppFormTable">
    <tr>
        <td style="border-top-width: 0px;" align="left">
            <font size="3">
                        Application ID : 
                        <asp:Label id="lblApplicationID" runat="server" Font-Bold="True"></asp:Label>
                       <br />
                        Version No : 
                        <asp:Label id="lblVersionNo" runat="server" Font-Bold="True"></asp:Label> <br />
               <%-- Course Applied	:
