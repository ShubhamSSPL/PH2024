<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceStatusCapRound3.aspx.cs" Inherits="Pharmacy2024.StaticPages.frmSeatAcceptanceStatusCapRound3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" HeaderText="Admission Status Report CAP Round III" runat="server">
        <div class="table-responsive">
