<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmInstituteList_BATU.aspx.cs" Inherits="Pharmacy2024.StaticPages.frmInstituteList_BATU" %>
<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %> 

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable1" HeaderText = "List of Institutes affiliated to Dr. Babasaheb Ambedkar Technological University, Lonere(BATU) and Participating in CAP" runat="server">
