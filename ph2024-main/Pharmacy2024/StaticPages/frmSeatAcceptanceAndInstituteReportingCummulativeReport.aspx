<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceAndInstituteReportingCummulativeReport.aspx.cs" Inherits="Pharmacy2024.StaticPages.frmSeatAcceptanceAndInstituteReportingCummulativeReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" HeaderText="Seat Acceptance and Institute Reporting Cumulative Report" runat="server">
        <div class="table-responsive">
          <%--  <asp:UpdatePanel runat="server" ID="upSpecialReservation">
                <ContentTemplate>--%>
                    <table class="AppFormTable" id="tblAll" runat="server">
                        <tr>
                            <td colspan="2">
                                <center><b>Seat Acceptance and Institute Reporting Cumulative Report</b>
                                <asp:GridView ID="gvAll" runat="server" AutoGenerateColumns="False" Width="60%" CellPadding="5" CssClass="DataGrid" OnRowCreated="gvAll_RowCreated" ShowHeader="false">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SeatAcceptance" HeaderText="Seat Acceptance">
                                            <ItemStyle Width="10%" HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" CssClass="Item" />
                                            <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" CssClass="Header" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="CummulativeSeatAcceptance" HeaderText="Cumulative Seat Acceptance">
                                            <ItemStyle Width="10%" HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" CssClass="Item" />
                                            <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" CssClass="Header" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="CummulativeReporting" HeaderText="Cumulative Reporting">
                                            <ItemStyle Width="10%" HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" CssClass="Item" />
                                            <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" CssClass="Header" />
                                        </asp:BoundField>
                                    </Columns>
