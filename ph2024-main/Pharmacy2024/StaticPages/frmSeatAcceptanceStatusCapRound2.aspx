<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceStatusCapRound2.aspx.cs" Inherits="Pharmacy2024.StaticPages.frmSeatAcceptanceStatusCapRound2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" HeaderText="Admission Status Report CAP Round II" runat="server">
        <div class="table-responsive">
