<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmApplicationFacilitationCenters.aspx.cs" Inherits="Pharmacy2024.StaticPages.frmApplicationFacilitationCenters" %>
<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %> 

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable1" HeaderText = "List of Scrutiny Centers (SC)" runat="server">
        <asp:GridView ID="gvAFCList" runat="server" AutoGenerateColumns="False" Width="100%" CssClass = "DataGrid table-responsive">
            <Columns> 
