<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCheckFinalMeritStatus.aspx.cs" Inherits="Pharmacy2024.StaticPages.frmCheckFinalMeritStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="cbCheckResult" runat="server" HeaderText="Final Merit Status (Only for Maharashtra State and All India Candidates)">
        <table class="AppFormTable">
            <tr>
                <td colspan="4">
                    ...
                    <p align="justify">
                        <b>All the eligible Candidates who have submitted Application Form on or before 26/09/2024 Up to 05:00 PM and who have raised grievances during 29/09/2024 to 01/10/2024  up to 5.00 PM are considered for Final Merit List and assigned a Merit Number.<%-- The merit is prepared on the basis of marks obtained by the candidate at qualifying examination and in case of tie as specified in sub-section (3) of rule 8.--%>
                    ...
                    <br />
                    <%-- <p align="justify">
                        <b>Due to COVID-19 outbreak and present lockdown, and to curb its spread, the Competent Authority has prescribed the following methods for the activities post allotment: 
                        </b>
                    </p>
                    <br />--%>
                    <font color="red"><b>Important Instructions for the Candidate:-</b></font>
                    <br />
                    <ol class="list-text">
                        <li runat="server" id="li1" visible="true">
                            <p align="justify">
                                Check the Final Merit Status through candidate’s Login & Verify the correctness of the Final Merit Number.
                            </p>
                        </li>
                        <li runat="server" id="Li2" visible="true">
                            <p align="justify">
                                Candidate shall ensure that the information shown on the Final Merit details of his/her claims related with Name, Qualifying Marks, category, gender, reservation, special reservation made by himself/herself in the applications form are correct. 
                            </p>
                        </li>
...
<br /><br /> In case of OBC Candidates, duration for submitting Caste Validity certificate will be as per the Maharashtra State Government Resolution No - संकिर्ण-2024/प्र.क्र.75/ आरक्षण-5 dated 05 September, 2024.
                        ...
                        <%-- <li runat="server" id="li9" visible="true">
                            <p align="justify">
                        ...
                        <%--<li runat="server" id="li10" visible="true">
                            <p align="justify">
                        ...
                        <li>
                            <p align="justify">
                                In later stage, if it is found that the seat allotted to the candidate on the false claims made in the application by the candidate, then such allotment/admission taken in the allotted institute shall be cancelled automatically.
                        ...
                        <li>
                            <p align="justify">
                                The merit list gives the relative position of the candidate and it does not guarantee admission to any course/ institute.
                        ...
                        <li>
                            <p align="justify">
                                In order to participate in the CAP (subject to fulfillment of the eligibility requirements of respective CAP round), it is MANDATORY to fill & Confirm the Online Option Form through Candidates Login for respective CAP Round. Check Schedule of Activities on website.
                        ...
                        <li>
                            <p align="justify">
                                For Any Admission related query Contact +91-9175108612, 18002660160 <%--[कोणत्याही प्रवेश संबंधित माहितीसाठी +91-8208653903, +91-8857834644
                                                    +91-9730310006 वर या 10:00 AM to 06:00 PM कार्यालयीन वेळेत संपर्क साधा--%>.
                            </p>
                        </li>
                    </ol>
                </td>
            ...
            <tr>
                <th colspan="2">Enter Your Application ID and Date of Birth to View Your Final Merit Status
                    <br />
    ...
    <cc1:ContentBox ID="cbDisplayResult" runat="server" HeaderVisible="false">
        <table class="AppFormTableNew">
            <tr>
                ...
                <td style="width: 80%; border-left-width: 0px; border-right-width: 0px;" align="center">
                    <b>
                        ...
                        <br />
                        <br />
                        Final Merit Status for Admission to First Year Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D Admissions <%= AdmissionYear %> </b>
                </td>
            ...
            <%--     <tr>
                <td align="center" colspan="3"><font size = "2">Application ID : <asp:Label id="lblApplicationID" runat="server" Font-Bold="True"></asp:Label></font></td>
            </tr>--%>
        </table>
        <table class="AppFormTableNew">
            <tr>
        ...
        <table class="AppFormTableNew">
            <tr>
                <th align="left" colspan="2">
                    <b>Your Final Merit Status is...</b>
                </th>
            </tr>
            ...
            <tr id="trKonkanStateGeneralMeritNo" runat="server" visible="false">
                <td align="right">Konkan State General Merit No
                </td>
                <td>
                    <asp:Label ID="lblKonkanStateGeneralMeritNo" runat="server" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            <tr id="trKonkanStateCategoryMeritNo" runat="server" visible="false">
                <td align="right">Konkan State Category Merit No
                </td>
                <td>
                    <asp:Label ID="lblKonkanStateCategoryMeritNo" runat="server" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            ...
            <tr id="trJKMeritNo" runat="server" visible="false">
                <td style="width: 35%" align="right">J&K Merit No
                </td>
                <td style="width: 65%">
                    <asp:Label ID="lblJKMeritNo" runat="server" Font-Bold="true"></asp:Label>
                </td>
            </tr>
            <tr id="trNRIMeritNo" runat="server" visible="false">
                <td style="width: 35%" align="right">NRI Merit No
                </td>
                <td style="width: 65%">
                    <asp:Label ID="lblNRIMeritNo" runat="server" Font-Bold="true"></asp:Label>
                </td>
            </tr>
...
<br /><br /> In case of OBC Candidates, duration for submitting Caste Validity certificate will be as per the Maharashtra State Government Resolution No - संकिर्ण-2024/प्र.क्र.75/ आरक्षण-5 dated 05 September, 2024.
            ...
            <tr>
                <td colspan="4">
                    <b>Instructions for First Year Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D Admissions  <%= AdmissionYear %></b>
                    <p align="justify">
                        <b>All the eligible Candidates who have submitted Application Form on or before 26/09/2024 Up to 05:00 PM and who have raised grievances during 29/09/2024 to 01/10/2024  up to 05.00 PM are considered for Final Merit List and assigned a Merit Number. <%--The merit is prepared on the basis of marks obtained by the candidate at qualifying examination and in case of tie as specified in sub-section (3) of rule 8.--%>
                            <%--[ज्या उमेदवाराने केंद्रीभूत प्रवेश प्रक्रिये अंतर्गत प्रवेश मिळण्यासाठी दिनांक ३१-१२-२०२० किंवा त्या दिनांकापूर्वी आवेदनपत्र सादर केलेले आहेत अशा उमेदवारांची नावे तात्पुरती गुणवत्ता यादी तयार करण्यासाठी विचारात घेण्यात आलेली असून त्यांना अर्हता परीक्षेतील गुणांच्या आधारे किंवा पोटनियम (३) मध्ये विनिर्दिष्ट केलेल्या निकषानुसार गुणानुक्रम देण्यात आला आहे.] --%>
                        </b>
                    </p>
                    <br />
                    ...
                    <ol class="list-text">
                        ...
                        <%-- <li runat="server" id="li7" visible="true">
                            <p align="justify">
                                # - Non Creamy Layer Certificate (NCL) should be uploaded online till the last date of “Self Verification & Seat Acceptance “ as per Allotment of CAP Round-I to claim Category benefit for admission, otherwise you will be treated as General Candidate.
                            </p>
                        </li>--%>
                        <%-- <li runat="server" id="li8" visible="true">
                            <p align="justify">
                                @ - Economically Weaker Section (EWS) Certificate should be uploaded online till the last date of “Self Verification & Seat Acceptance “ as per Allotment of CAP Round-I to claim Category benefit for admission, otherwise you will be treated as General Candidate.
                            </p>
                        </li>--%>
            ...
            <tr>
                <td colspan="2">
                    <font color="red"><b>Published On : 04/10/2024</b></font>
                </td>
            </tr>
        </table>
        <br />
