<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenu.Master" AutoEventWireup="true" CodeBehind="frmOptionFormSummary.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound4.frmOptionFormSummary" %>
                    ...
                    <tr>
                        <td colspan="4">
                            <ol class="list-text">
                                ...
                                <li><p align = "justify">If you want to Move a Preferenced Choice Code to a particular position, then click on 'Move Choice Code' Button.</p></li>
                            </ol>
                        </td>
                    </tr>
                </table>
