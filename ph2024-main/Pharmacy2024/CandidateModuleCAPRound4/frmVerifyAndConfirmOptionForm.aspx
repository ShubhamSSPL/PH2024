<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenu.Master" AutoEventWireup="true" CodeBehind="frmVerifyAndConfirmOptionForm.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound4.frmVerifyAndConfirmOptionForm" %>
    ...
    <%--<table class="AppFormTable">
            <tr>
                <th colspan="4" align="left">
                    <font size="2">First Option Given By You</font>
                </th>
            </tr>
             <tr>
                    <td colspan = "4">
        ...
        <br />
            ...
            <tr>
                <th colspan="4" align="center">
                    <font size="2">Confirm Your Option Form</font>
                </th>
            </tr>
        </table>--%>
    <%--</cc1:ContentBox>--%>
    <cc1:ContentBox ID="cbPassword" runat="server" HeaderText="Confirm Option Form">
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td colspan="3">
                    <p align="justify">
                        <font color="red" size="2">जर उमेदवारास त्याच्या विकल्प नमुन्यातील पहिल्या पसंतीक्रमांकावरील
                            जागेचे वाटप झाल्यास असे वाटप प्रणालीतून आपोआप गोठविले जाईल व उमेदवार या जागेचा स्वीकार
                            करेल. असे उमेदवार केंद्रीभूत प्रवेश प्रक्रियेच्या (कॅप) पुढील फेरींमध्ये सहभागी
                            होण्यास पात्र नसतील. असे उमेदवार प्रवेश उपस्थिती केंद्रावर जागास्वीकृती करिता कागदपत्राची
                            पडताळणी व जागा स्विकृती शुल्क भरण्यासाठी हजर होतील. तदनंतर असे उमेदवार वाटप करण्यात
                            आलेल्या जागेवर प्रवेश घेण्यासाठी वाटप करण्यात आलेल्या संस्थेमध्ये हजर होतील. असे
                            उमेदवार जर प्रवेश उपस्थिती केंद्रावर जागास्वीकृती करिता हजर झाले नाहीत तर ते त्यांना
                            वाटप करण्यात आलेल्या जागेवरील हक्क आपोआप गमावतील आणि ती जागा पुढील वाटपासाठी उपलब्ध
                            होईल. अश्या उमेदवारांकरिता करण्यात आलेले हे जागावाटप अंतिम असेल;
                            <br />
                            <br />
                            ...
                            Such candidates shall then report to ARC for verification of documents and payment
                            of seat acceptance fee. Thereafter such candidates shall report to the allotted
                            institute and seek admission on the allotted seat. If such candidate does not report
                            to ARC for confirmation of seat acceptance, their claim on the allotted seat shall
                            stand forfeited automatically and the seat shall become available for fresh allotment.
                            For such candidate, the allotment so made shall be the final allotment. </font>
                    </p>
                </td>
            </tr>
        </table>
                ...
                <table id="tblOtp" class="AppFormTable" runat="server">
                    ...
                    <tr>
                        <td align="center" colspan="3">
                            <br />
                            <br />
                            <asp:Button ID="btnVerifyOtp" runat="server" Text="Verify OTP & Confirm Option Form"
