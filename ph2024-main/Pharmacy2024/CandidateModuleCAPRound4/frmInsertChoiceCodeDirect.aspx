<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenu.Master" AutoEventWireup="true" CodeBehind="frmInsertChoiceCodeDirect.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound4.frmInsertChoiceCodeDirect" %>
                ...
                <table class="AppFormTable">
                    <tr>
                        ...
                        <td style="width:60%;">
                            ...
                            <asp:Button ID="btnVerifyChoiceCode" runat="server" Text="Verify Choice Code" CssClass="InputButton" BackColor="Red" OnClick="btnVerifyChoiceCode_Click" />
                    ...
                    <tr id="trInstituteName" runat="server" visible="false">
                        ...
                        <td><asp:Label ID="lblInstituteName" runat="server" Font-Bold="true"></asp:Label></td>
                    </tr>
                    <tr id="trCourseName" runat="server" visible="false">
                        <td align="right">Course Name</td>
                        <td><asp:Label ID="lblCourseName" runat="server" Font-Bold="true"></asp:Label></td>
                    </tr>
                    <tr id="trInvalid" runat="server" visible="false">
                        <td colspan="2" align="center"><asp:Label ID="lblInvalid" runat="server" Font-Bold="true" Font-Size="Small" ForeColor="Red"></asp:Label></td>
                    </tr>
                    <tr>
