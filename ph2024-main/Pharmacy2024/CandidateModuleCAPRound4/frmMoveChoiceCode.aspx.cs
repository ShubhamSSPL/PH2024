    ...
    public partial class frmMoveChoiceCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound4(objSessionData.PID, "frmMoveChoiceCode.aspx");
        ...
        protected void getPreferencedOptionsList()
        {
            ...
            try
            {
                ...
                Int32 PreferenceCount = reg.getPreferencesCountCAPRound4(objSessionData.PID);
        ...
        protected void btnMove_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.moveOptionCAPRound4(objSessionData.PID, PreferenceNo, ChoiceCode, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
