    ...
    public partial class frmInsertChoiceCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound4(objSessionData.PID, "frmInsertChoiceCode.aspx");
                    ...
                    ddlUniversity.DataSource = reg.getUniversityListByPID(4, objSessionData.PID);
        ...
        protected void ddlUniversity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ddlInstitute.DataSource = reg.getInstituteListByUniversityID(4, objSessionData.PID, UniversityID);
        ...
        protected void ddlInstitute_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ddlChoiceCode.DataSource = reg.getChoiceCodeListByInstituteID(4, objSessionData.PID, InstituteID);
        ...
        protected void btnInsert_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.insertOptionCAPRound4(objSessionData.PID, PreferenceNo, ChoiceCode, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
