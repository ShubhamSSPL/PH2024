<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenu.Master" AutoEventWireup="true" CodeBehind="frmShortListOptions.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound4.frmShortListOptions" %>
<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <style>
            #rightContainer_ContentTable1_gvOptionsList input[type='checkbox'] { width: 20px; height: 20px;} 
            #rightContainer_ContentTable1_gvSelectedOptionsList input[type='checkbox'] { width: 20px; height: 20px;}
    </style>
        ...
        <asp:UpdatePanel runat="server" ID="upShortListOptions">
            <ContentTemplate>
                <table class="AppFormTable">
                    ...
                    <tr>
                        <td style="width:25%;" align ="right">Select University</td>
                        <td style="width:25%;"><asp:DropDownList id="ddlUniversity" Runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlUniversity_SelectedIndexChanged"></asp:DropDownList></td>
                        <td style="width:25%;" align ="right">Select District</td>
                        <td style="width:25%;"><asp:DropDownList id="ddlDistrict" Runat="server"></asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td align ="right">Select Course Status</td>
                        <td><asp:DropDownList id="ddlCourseStatus1" Runat="server"></asp:DropDownList></td>
                        <td align ="right">Select Course Autonomy Status</td>
                        <td><asp:DropDownList id="ddlCourseStatus2" Runat="server"></asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td align ="right">Select Course Minority Status</td>
                        <td><asp:DropDownList id="ddlCourseStatus3" Runat="server"></asp:DropDownList></td>
                        <td align ="right">Select TFWS Status</td>
                        <td>
                            <asp:DropDownList id="ddlTFWSStatus" Runat="server">
