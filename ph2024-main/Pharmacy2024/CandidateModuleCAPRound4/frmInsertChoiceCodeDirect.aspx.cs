    ...
    public partial class frmInsertChoiceCodeDirect : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound4(objSessionData.PID, "frmInsertChoiceCodeDirect.aspx");
        ...
        protected void btnVerifyChoiceCode_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet ds = reg.verifyChoiceCode(4, objSessionData.PID, ChoiceCodeDisplay);
        ...
        protected void btnInsertDirect_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.insertOptionDirectCAPRound4(objSessionData.PID, PreferenceNo, ChoiceCodeDisplay, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
