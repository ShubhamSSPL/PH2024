    ...
    public partial class frmShortListOptions : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound4(objSessionData.PID, "frmShortListOptions.aspx");
                    ...
                    if (objSessionData.OptionFormStatusCAPRound4 == 'A' || objSessionData.StepIDCAPRound4 < 0)
                    {
                        Response.Redirect("../CandidateModuleCAPRound4/frmOptionForm.aspx?tms=101", true);
                    }

                    ddlCourse.DataSource = reg.getCourseListByPID(4, objSessionData.PID);
                    ddlCourse.DataTextField = "CourseName";
                    ddlCourse.DataValueField = "CourseCode";
                    ddlCourse.DataBind();
                    ddlCourse.Items.Insert(0, new ListItem("-- Select Course --", "0"));

                    ddlUniversity.DataSource = Global.MasterUniversityCAPRound4;
                    ...
                    ddlDistrict.DataSource = reg.getMasterDistrictForUniversity(4, 0);
                    ddlDistrict.DataTextField = "DistrictName";
                    ddlDistrict.DataValueField = "DistrictName";
                    ddlDistrict.DataBind();
                    ddlDistrict.Items.Insert(0, new ListItem("All", "All"));

                    ddlCourseStatus1.DataSource = Global.MasterCourseStatus1CAPRound4;
                    ...
                    ddlCourseStatus2.DataSource = Global.MasterCourseStatus2CAPRound4;
                    ...
                    ddlCourseStatus3.DataSource = Global.MasterCourseStatus3CAPRound4;
        ...
        protected void ddlUniversity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ddlDistrict.DataSource = reg.getMasterDistrictForUniversity(4, UniversityID);
                ddlDistrict.DataTextField = "DistrictName";
                ddlDistrict.DataValueField = "DistrictName";
                ddlDistrict.DataBind();
                ddlDistrict.Items.Insert(0, new ListItem("All", "All"));
        ...
        protected void getSelectedOptionsList()
        {
            ...
            try
            {
                ...
                gvSelectedOptionsList.DataSource = reg.getSelectedOptionsListCAPRound4(objSessionData.PID);
        ...
        protected void getOptionsList()
        {
            ...
            try
            {
                ...
                if (ddlCourse.SelectedValue != "0")
                {
                    ...
                    gvOptionsList.DataSource = reg.getOptionsListCAPRound4(objSessionData.PID, CourseCode, UniversityID, DistrictName, CourseStatus1, CourseStatus2, CourseStatus3,TFWSStatus);
        ...
        public void btnAddSelectedOptions_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (OptionsList.Length > 27)
                {
                    ...
                    switch (reg.saveOptionsCAPRound4(objSessionData.PID, OptionsList, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                    {
                        case 0:
        ...
        public void btnDeleteSelectedOptions_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (OptionsList.Length > 27)
                {
                    ...
                    switch (reg.deleteOptionsCAPRound4(objSessionData.PID, OptionsList, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                    {
                        case 0:
                            shInfo.SetMessage("There is some problem in Data Saving. Please try again.", ShowMessageType.UserError);
                            break;
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.saveShortlistedOptionsCAPRound4(objSessionData.PID, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
                        shInfo.SetMessage("Please Shortlist Atleast One Institute.", ShowMessageType.Information);
                        break;
                    case 1:
                        if (objSessionData.StepIDCAPRound4 < 1)
                        {
                            ((SessionData)Session["SessionData"]).StepIDCAPRound4 = 1;
                        }
