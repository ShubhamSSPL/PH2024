<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="WelcomePageARA.aspx.cs" Inherits="Pharmacy2024.ApplicationPages.WelcomePageARA" %>
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderVisible = "false">
        ...
        <center> 
            <asp:Label ID = "lblHeader" runat = "server" Font-Names="Bookman Old Style" Font-Size = "Medium">
                Welcome for Admission to First Year Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D the Academic Year <%= AdmissionYear %>
            </asp:Label>
        </center>
        <br />
