...
{
    public partial class frmUploadTRYERTX : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(frmUploadTRYERTX));
            if (!IsPostBack)
            {
            ...
            try
            {
               ...
               // new SqlParameter("@DocumentID", DocumentID),
                //new SqlParameter("@FilePath", FilePath),
                  ...
                  //new SqlParameter("@ModifiedBy", "AdminCET"),
        ...
        private class dbUtilitySEBC
        {
            ...
            public DataSet saveUploadedDocument(Int64 PID, Int64 DocumentID, string FileName, string AbsoluteFilePath, string OriginalFileName, string FileUploadedBy, string FileUploadedByIPAddress)
            {
                SqlParameter[] param =
                    ...
                    new SqlParameter("@FileUploadedBy","AdminCET"),
