...
{
    public partial class frmProformaO : System.Web.UI.Page
    {
        public Int64 PID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    PID = objSessionData.PID;
                    ChoiceCode = Convert.ToInt64(Request.QueryString["ChoiceCode"]);
                    CAPRound = Convert.ToInt32(Request.QueryString["CAPRound"]);
                    ...
                    {
                        Response.Redirect("../CandidateAdmissionReportingModule/frmConfirmPassword.aspx");
                    }
                }
                catch (Exception ex)
                {
