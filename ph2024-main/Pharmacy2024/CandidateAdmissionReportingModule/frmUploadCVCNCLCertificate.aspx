<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmUploadCVCNCLCertificate.aspx.cs" Inherits="Pharmacy2024.CandidateAdmissionReportingModule.frmUploadCVCNCLCertificate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <script>
                ...
                if (data.length > 7) {
                    ...
                    if (documentID == "21") {
                        ...
                        if (hidJUD == "0") {
                            ...
                            var message = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadCVCNCLCertificate.UploadDoc(data, documentID, hidJUD, hidDID, hidTID, fileName, fileExt);
     ...
     <table class="AppFormTableWithOutBorder" id="tblnote" runat="server">
            <tr>
                <td>
                    <font color="red">
                        <ol class="list-text"><b>Note :</b>
                            <li><p align="justify"><font color="red">The SC, ST, VJ/DT- NT(A), NT(B), NT(C), NT(D), SBC and EWS Candidates who submitted receipt of Caste/Tribe Validity Certificate, Non Creamy Layer Certificate, EWS Certificate during registration, e-verification or physical document verification and confirmation period should upload and verify original Caste/ Tribe Validity Certificate, Non Creamy Layer Certificate, EWS Certificate at Physical Scrutiny Center or E-Scrutiny Center and submit original certificate to the admitted institute on or before 16/12/2024 up to 03.00 P.M. otherwise these candidates admission will get automatically cancelled and shall be considered as Open category candidates for next institute level round provided candidate full fill eligibility criteria for open category.
                ...
                <td colspan="2">
                    <ol class="list-text">
                        ...
                        <li>Allotment of Candidate will be cancelled and candidate will convert to OPEN Category. Eligible for Next Round.</li>
                         <li>Those candidate who have submitted the receipt of CVC/TVC/NCL/ Proforma V (EWS) at the time of application form filling and confirmation and now could not able to submit the original CVC/TVC/NCL/EWS certificate till the Last date of seat acceptance and reporting to the institute for CAP round I as per schedule can convert themselves into open / non-ews and will be able to complete seat acceptance and institute reporting for CAP round I. </li>
                        <li>Once you converted your self into OPEN/ NON EWS category then you are considered Only in OPEN/ NON EWS category for seat allotment in the next CAP round / additional institutional round.</li>
                        <li>OPEN/ NON EWS converted candidate will not be able to convert back into reserved / EWS category. </li>
                    </ol>
                </td>
            </tr>
            <tr>
...
<br /><br /> In case of OBC Candidates, duration for submitting Caste Validity certificate will be as per the Maharashtra State Government Resolution No - संकिर्ण-2024/प्र.क्र.75/ आरक्षण-5 dated 05 September, 2024.
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="btnEWSYes" runat="server" Text="Upload EWS" CssClass="InputButton"
                        OnClick="btnEWSYes_Click" />
                </td>
                <td align="center">
                    <asp:Button ID="btnEWSNo" runat="server" Text="Convert to (NO) EWS" CssClass="InputButton"
...
<br /><br /> In case of OBC Candidates, duration for submitting Caste Validity certificate will be as per the Maharashtra State Government Resolution No - संकिर्ण-2024/प्र.क्र.75/ आरक्षण-5 dated 05 September, 2024.
    ...
    <cc1:ContentBox ID="ContentBoxEWSOpen" runat="server" HeaderText="Convert to (NO) EWS Not having EWS Certificate"
        Visible="False">
        <br />
        <table class="AppFormTable">
            <tr>
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="btnEWSConvertToOpen" runat="server" Text="Process to Convert to (NO) EWS" 
...
<%--    document.getElementById('<%=flUpload.ClientID %>').value = "";--%>
            ...
            if (documentId == "21" || documentId == "22") {
                ...
                var ds = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadCVCNCLCertificate.FillJuridiction(documentId);
                var categoryID = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadCVCNCLCertificate.getCategoryID();
        ...
        function getDistrict(JurisdictionID) {
            ...
            var dsDistrict = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadCVCNCLCertificate.getDistrictForJuridiction(JurisdictionID);
        ...
        function getTaluka(DistrictID) {
            ...
            opt.value = "0";
            if (DistrictID != 0) {
                var dsTaluka = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadCVCNCLCertificate.getTalukaForDistrict(DistrictID);
