<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmUploadNCLCertificate.aspx.cs" Inherits="Pharmacy2024.CandidateAdmissionReportingModule.frmUploadNCLCertificate" %>
                ...
                if (data.length > 7) {
                    ...
                    if (documentID == "21") {
                        ...
                        if (hidJUD == "0") {
                            ...
                            var message = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadNCLCertificate.UploadDoc(data, documentID, hidJUD, hidDID, hidTID, fileName, fileExt);
...
<%--    document.getElementById('<%=flUpload.ClientID %>').value = "";--%>
            ...
            if (documentId == "21" || documentId == "22") {
                ...
                var ds = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadNCLCertificate.FillJuridiction(documentId);
                var categoryID = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadNCLCertificate.getCategoryID();
        ...
        function getDistrict(JurisdictionID) {
            ...
            var dsDistrict = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadNCLCertificate.getDistrictForJuridiction(JurisdictionID);
        ...
        function getTaluka(DistrictID) {
            ...
            opt.value = "0";
            if (DistrictID != 0) {
                var dsTaluka = Pharmacy2024.CandidateAdmissionReportingModule.frmUploadNCLCertificate.getTalukaForDistrict(DistrictID);
