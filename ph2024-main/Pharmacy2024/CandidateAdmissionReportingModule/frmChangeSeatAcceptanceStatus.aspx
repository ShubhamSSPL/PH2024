<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmChangeSeatAcceptanceStatus.aspx.cs" Inherits="Pharmacy2024.CandidateAdmissionReportingModule.frmChangeSeatAcceptanceStatus" %>
                ...
                <td style="background-color: #def3de; border: 1px solid green">
                    ...
                    <ol class="list-text" type="a">
                      ...
                      <%--  <li>
                        ...
                        <li>
                            <p align="justify">
                                Last date for online Seat Acceptance of allotted seat is <b>16/12/2024 Up to 3 P.M.</b>
                                वाटप करण्यात आलेल्या जागेवर, ऑनलाइन पद्धतीने जागा स्वीकृती करण्याची अंतिम दिनांक <b>16/12/2024 Up to 3 P.M.</b> आहे.
                            </p>
                        </li>

                        <li>
                            <p align="justify">
                                Last date for Reporting(Confirmation) of Admission in allotted Institute is <b>16/12/2024 Up to 5 P.M.</b>
                        ...
                        <li>
                            <p align="justify">
                               After freezing the allotted seat, such candidate shall report to the allotted institute and seek admission on the allotted seat. If such candidate does not report to the allotted insttiute his claim on the allotted seat shall stand forfeited automatically. 
                                ...
                                ज्या उमेदवाराने त्यास देऊ केलेली जागा स्वतः गोठविली असे उमेदवार वाटप करण्यात आलेल्या जागेवर प्रवेश घेण्यासाठी वाटप करण्यात आलेल्या संस्थेमध्ये हजर होतील. असे उमेदवार वाटप झालेल्या संस्थेमध्ये विहित वेळेमध्ये प्रवेशासाठी हजर न झाल्यास असे उमेदवार त्यांना वाटप करण्यात आलेल्या जागेवरील हक्क आपोआप गमावतील . </p>
                        </li>
                        <li>
                            <p align="justify">
                                For such candidate, the allotment so made shall be the final allotment. <%--Such candidate shall not be eligible for participation in the subsequent CAP rounds;--%>
अशा उमेदवारांकरिता करण्यात आलेले हे जागावाटप अंतिम असेल. <%--व असे उमेदवार केंद्रीभूत प्रवेश प्रक्रियेच्या (कॅप) पुढील फेरींमध्ये सहभागी होण्यास पात्र नसतील;--%>
                            </p>
                        </li>
                    ...
                    <br />
                    <br />
                    <center><asp:Button ID="btnFreeze" runat="server" Text="Freeze & Proceed >>>" CssClass="InputButton" OnClick="btnFreeze_Click" /></center>
                    <br />
                </td>
            </tr>
        </table>
