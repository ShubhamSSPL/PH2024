<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceForm.aspx.cs" Inherits="Pharmacy2024.CandidateAdmissionReportingModule.frmSeatAcceptanceForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OpenPopUpWindow() {
            window.open("frmPrintSeatAcceptanceForm.aspx", "Password", "width=1000px,height=500px,resizable=yes,scrollbars=yes");
        }
    </script>
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            ...
            <%--      <tr>
                <td><font size="3" color="blue"><b>Note : </b>Please Pay Seat Acceptance Fee. To Pay Seat Acceptance Fee, </font>
                    <asp:Button ID="btnPay" runat="server" CssClass="InputButton" BackColor="#5cb85c" Text=" Click Here " Height="40px" Font-Size="Medium" Font-Bold="true" OnClick="btnPay_Click"></asp:Button></td>
            </tr>--%>
        </table>
        <br />
        ...
        <table id="tblExmDetail" runat="server" class="AppFormTable" visible="false">
            <tr>
                <th style="border-top-width: 0px;" align="left" colspan="4">Exam Name Details </th>
            </tr>
            <tr>
