<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="PaymentDetails.aspx.cs" Inherits="Pharmacy2024.FeeProcess.PaymentDetails" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <ccm:ContentBox ID="cntPrev" runat="server" HeaderText="Paid Transactions Details">
        ...
        <br />
        <asp:GridView ID="grdPrevData" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" OnRowCancelingEdit="grdPrevData_RowCancelingEdit" OnRowCommand="grdPrevData_RowCommand" Width="100%" CellPadding="5" CssClass = "DataGrid ">
            <Columns>
                <asp:TemplateField HeaderText="Sr. No.">
                    <ItemTemplate>
                        <%# int.Parse(DataBinder.Eval(Container,"RowIndex").ToString()) +1 %>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Item" Width="5%" />
                ...
                <asp:BoundField DataField="Amount" HeaderText="Total Fee">
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Item" Width="10%" />
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Header" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="PaymentMode" HeaderText="Payment Mode" HtmlEncode="false">
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Item" Width="30%" />
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Header" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="Cancel" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnCancel" runat="server" ImageUrl="~/Images/cancel.jpg" CausesValidation="false" ToolTip="Cancel Transaction" CommandName="Cancel" Visible='<%# Eval("IsCancellable") %>' CommandArgument='<%# Eval("ReferenceNo") %>' />
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Item" Width="5%" />
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Header" />
            ...
            <tr>
                <td>
                    <font color = "red">
                        <p align = "justify"><font color = "red"><b>Instructions :</b></font></p>
                        <ul class="list-text">
                            <li><p align = "justify"><font color = "red">Following is your attempted / failed transactions list.</font></p></li>
                            <li><p align = "justify"><font color = "red">Before proceeding to payment, please check your account for any deduction. If amount has been deducted then please wait for some time and then again come on this interface through link given in left side.</font></p></li>
                        </ul>
                    </font>
                </td>
            </tr>
        ...
        <asp:GridView ID="grdFail" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass = "DataGrid table-responsive">
            <Columns>
                ...
                <asp:BoundField DataField="Reason" HeaderText="Reason" HtmlEncode="false">
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Item" Width="25%" />
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="middle" Font-Names="Verdana" CssClass = "Header" />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
    ...
    <ccm:ContentBox ID="cbProceed" runat="server" HeaderVisible="false">
        <br />
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center"><asp:Button runat="server" ID="btnPay" CssClass="InputButton" onclick="btnPay_Click" Text="Proceed To Payment >>>" /></td>
            </tr>
        </table>
        <br />
    </ccm:ContentBox>
