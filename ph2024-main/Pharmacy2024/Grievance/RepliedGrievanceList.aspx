<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="RepliedGrievanceList.aspx.cs" Inherits="Pharmacy2024.Grievance.RepliedGrievanceList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Replied Tickets">
                    ...
                    <ContentTemplate>
                        <div class="row text-center">
                            <div class="col-md-12">
                                ...
                                <asp:Button ID="btnReplied" runat="server" Text="Replied Tickets" CssClass="btn btn-primary m-3" BackColor="blue" OnClick="btnReplied_Click" CausesValidation="false" />
                            </div>
                        </div>
                        <div class="row">
