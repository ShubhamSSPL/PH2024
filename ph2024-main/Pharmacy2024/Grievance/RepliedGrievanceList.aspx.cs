...
{
    public partial class RepliedGrievanceList : System.Web.UI.Page
    {
        ...
        protected void GetGrievanceList()
        {
            ...
            try
            {
                ...
                gvGrievanceList.DataSource = new BusinessServiceImp().GetGrievanceListByStatus(Convert.ToInt32(Session["UserTypeID"]), Session["UserLoginID"].ToString(), "R", txtSearch.Text, GrievanceCategoryID);
        ...
        protected void gvGrievanceList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (GrievanceID > 0)
                {
                    Response.Redirect("../Grievance/ViewGrievance.aspx?GID=" + GrievanceID + "&Flag=R", true);
                }
            }
            catch (System.Threading.ThreadAbortException t)
            {
