<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="ReplyGrievance.aspx.cs" Inherits="Pharmacy2024.Grievance.ReplyGrievance" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Reply Ticket">
        <div class="row card-body w-100">
            <div class="col-md-12">
                ...
                <div id="divReply" runat="server" class="row mt-2">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label">Replied Message <span class="required">*</span></label>
                            <asp:TextBox ID="txtRepliedGrievance" runat="server" MaxLength="500" CssClass="form-control" TextMode="MultiLine" Height="120"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvRepliedGrievance" runat="server" ErrorMessage="Please Enter Replied Message." ControlToValidate="txtRepliedGrievance" Display="None"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-12 text-center">
                        <asp:Button ID="btnReply" runat="server" Text="Reply" CssClass="btn btn-success btn-sm btnwidth" OnClick="btnReply_Click" />
