<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="CheckGrievanceStatus.aspx.cs" Inherits="Pharmacy2024.Grievance.CheckGrievanceStatus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Check Ticket Status">
        <div class="row w-100" style="padding-left:5px;padding-right:5px;">
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="section">
                                    <asp:GridView ID="gvGrievanceList" runat="server" AutoGenerateColumns="false" CssClass="table mahait-table text-center mahait-dt admisstion_ms_content_gv" OnRowDataBound="gvGrievanceList_RowDataBound" OnRowCommand="gvGrievanceList_RowCommand">
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="View" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BorderWidth="1px" ItemStyle-BorderWidth="1px" ItemStyle-BorderColor="#EEEEEE" HeaderStyle-BorderColor="#EEEEEE" HeaderStyle-Wrap="false" ItemStyle-Wrap="false" HeaderStyle-Width="8%">
                                                <ItemTemplate>
