<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmARA_ROWiseFeeCollection.aspx.cs" Inherits="Pharmacy2024.ARAModule.frmARA_ROWiseFeeCollection" %>
<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %> 

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Region Wise Fee Collection Report" Width = "100%" Height="400px" ScrollBars = "auto">
        ...
        <br />
        <asp:GridView ID="gvReport" ShowHeader="true" ShowFooter = "true" runat="server" CellPadding="10" CellSpacing="10" AutoGenerateColumns="False" Width="100%" 
            CssClass = "DataGrid"  >
            <Columns> 
