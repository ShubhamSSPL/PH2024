<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmInstitute_EditUploadRequiredDocument.aspx.cs" Inherits="Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function cb(data, fileName, fileExt) {
              ...
              //  sleep(10000);
                if (data.length > 10) {
                    var PID = $("#<%=hdnCurrentPersonalID.ClientID %>").get(0).value;
                    ...
                    if (documentID == "21") {
                        ...
                        if (hidJUD == "0") {
                            ...
                            var message = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.UploadDoc(data, PID, documentID, hidJUD, hidDID, hidTID, fileName, fileExt, checkBarcode, barcode);
    ...
    <ccm:ContentBox ID="contentAppleSarkarBarti" runat="server" BoxType="ContentBox" Width="80%" Height="500px" Style="display: none;" HeaderText="Upload Document">
        ...
        <div runat="server" id="divuploaddoc">
            ...
            <table class="AppFormTable">
             ...
             <asp:HiddenField runat="server" ID="hdnCurrentPersonalID" />
            <asp:HiddenField runat="server" ID="hdnCurrentDocId" />
        ...
        <script>
            function viewUploadDocumentDiv(e) {
                e.preventDefault();
                if (Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.InsertUpdateDocumentFetchData(document.getElementById('<%=hidResponse.ClientID %>').value, $("#<%=hdnCurrentDocId.ClientID %>").get(0).value)) {
                    document.getElementById('<%=divup.ClientID %>').style.display = "block";
            ...
            function ValidateBarcode(e) {
                ...
                if (document.getElementById('<%=txtbarcode.ClientID %>').value > 0) {
                    ...
                    var dsResponse = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.FetchDocument(docID, document.getElementById('<%=txtbarcode.ClientID %>').value);
    ...
    <script type="text/javascript">
        ...
        function OpenTestPopup(cntrl) {
           ...
           // var docIDarray = ["1", "2", "11", "21", "22", "25", "32", "34"];
            ...
            var PID = corrRow.cells[corrRow.cells.length - 2].getElementsByTagName("input")[0].value;
            $("#<%=hdnCurrentPersonalID.ClientID %>").get(0).value = PID;
            ...
            if (docIDarray.includes(documentId)) {
               ...
               <%-- document.getElementById('<%=contentFileTest.ClientID %>').style.display = "block";--%>
                ...
                LoadDistrictTalukaJuridicaiton($("#<%=hdnCurrentDocId.ClientID %>").get(0).value, $("#<%=hdnCurrentPersonalID.ClientID %>").get(0).value);
                document.getElementById('<%=traaplesarkar.ClientID %>').style.display = 'none';
                document.getElementById('<%=trDocFetchbtn.ClientID %>').style.display = 'none';
                document.getElementById('<%=txtbarcode.ClientID %>').value = '';
                document.getElementById('<%=trBarcode.ClientID %>').style.display = 'none';
        ...
        function getDistrict(JurisdictionID) {
            ...
            var categoryID = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.getCategoryID();
            ...
            var dsDistrict = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.getDistrictForJuridiction(JurisdictionID);
        ...
        function getTaluka(DistrictID) {
            ...
            opt.value = "0";
            if (DistrictID != 0) {
                var dsTaluka = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.getTalukaForDistrict(DistrictID);
        ...
        function OpenViewDocumentPopUp(cntrl) {
            ...
            if (IsBarcodeFetch == "Y") {
                var dsResponse = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.GetDocumentFetchData(personalID, documentID);
          ...
          <%--  if (IsBarcodeFetch == "Y") {
                var dsResponse = Pharmacy2024.CandidateModule.frmInstitute_EditUploadRequiredDocument.GetDocumentFetchData(personalID, documentID);
                var obj = JSON.parse(dsResponse.json);
                if (obj.value.ApplicantName != null) {
                    if (documentID == 21) {
        ...
        function LoadDistrictTalukaJuridicaiton(documentId,PID) {
            if (documentId == "21" || documentId == "22") {
                ...
                var ds = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.FillJuridiction(documentId,PID);
                var categoryID = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.getCategoryID(PID);
    ...
    <script type="text/javascript" lang="javascript">
      //  Pharmacy2024.CandidateModule.frmInstitute_EditUploadRequiredDocument
        ...
        function OpenPOPup(cntrl) {
            ...
            if (documentId == "21" || documentId == "22") {
                ...
                var ds = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.FillJuridiction(documentId);
                var categoryID = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.getCategoryID();
                if (ds.value.Tables[0].Rows.length > 0) {
                    for (var i = 0; i < ds.value.Tables[0].Rows.length; i++) {
                        var opt = document.createElement("option");
            ...
            if (files.length > 0) {
                ...
                if (documentID == "21") {
                    ...
                    if (hidJUD == "0") {
                        ...
                        var message = Pharmacy2024.ARAModule.frmInstitute_EditUploadRequiredDocument.UploadDoc(files, documentID, hidJUD, hidDID, hidTID);
                        if (message.value == "The File has been uploaded.") {
                            $('#<%=btnUploadComplete.ClientID %>').show();
                            $('#<%=btnUploadComplete.ClientID %>').click();
                        }
