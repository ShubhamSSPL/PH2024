...
{
    public partial class frmInstVerifiedRO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                gvReport.DataSource = reg.getRODashboardForMV(RegionName, 'B');
                gvReport.DataBind();
                ...
                if (gvReport.Rows.Count == 0)
                {
                    ...
                    lblMsg.Text = "Institutes verified by RO not found.";                    
                }
            }
        }
    }
