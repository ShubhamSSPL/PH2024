<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmViewDocuments.aspx.cs" Inherits="Pharmacy2024.MVModule.frmViewDocuments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $('#rightContainer_contentFileUpload_flUpload').change(function () {
                ...
                var blnValid = false;
                var _validFileExtensions = [".jpg", ".jpeg", ".pdf", ".png"];//".bmp", ".zip", ".rar"
                           ...
                           <asp:TemplateField HeaderText="Upload" Visible ="false">
                            ...
                            <asp:TemplateField HeaderText="View">
                                <ItemTemplate>                                
                                    ...
                                    <img src="~/Images/document_new_22.png" id="imgDoc" Style="cursor: pointer; max-width: 40px" onclick="javascript:OpenViewDocumentPopUp(this)" runat="server" />
                ...
                <td colspan="2">
                    <p align="justify">
                        ...
                        <p align="justify">
                            ...
                            <br />
                            A candidate belonging to ‘Creamy Layer’ amongst the categories VJ/DT-NT(A), NT(B), NT(C), NT(D), SBC, OBC must note that the provision of reservation is NOT applicable to him/her. A candidate claiming benefit of reservation under the categories VJ/DT-NT(A), NT(B), NT(C), NT(D), SBC, OBC above will be required to produce <b>&quot;Non-Creamy Layer Certificate&quot;</b> in the name of the candidate as specified in the <b>Government Resolution No. CBC-10/2008/C.R.697/BCW-5</b>, dated 27th February 2009 or its updated version from time to time. <b>This certificate should be valid up to 31st March <%=NextYear%>.</b> <%--However, such a Non-Creamy Layer Certificate shall be produced in any case on or before the last date of filling up of Application Form, failing which the category claim, will not be granted.--%>
                        </p>
    ...
    <ccm:ContentBox ID="contentFileUpload" runat="server" HeaderText="Upload File" BoxType="PopupBox" Width="40%">
        ...
        <table class="AppFormTable">
            <tr>
                <td align="center">
                    <asp:Button ID="btnSaveUpload"  OnClientClick="return checkfrmupload('22');" runat="server" CssClass="InputButtonRed" Style="display: none" Text="Upload" OnClick="btnSaveUpload_Click" />
                                ...
                                <tr>
                                    <td>
                                        <button type="button" onclick="zoominPopUp()">
                                            <img src="../Images/zoom-in.png" width="15" height="15"></button></td>
                                    <td>
                                        <button type="button" onclick="zoomoutPopUp()">
                                            <img src="../Images/zoom-out.png" width="15" height="15">
                                        </button>
                                    </td>
                                </tr>
                            </table>
 ...
 <%--   <script type="text/javascript">
    ...
    <script type="text/javascript" lang="javascript">
        Pharmacy2024.AFCModule.frmUploadRequiredDocuments
