<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="ARANoOfInstConfirmedByDTEList.aspx.cs" Inherits="Pharmacy2024.MVModule.ARANoOfInstConfirmedByDTEList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    <p align = "justify"><b>Note:</b></p>
     ...
     <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="List Of Institutes Confirmed by DTE" Width = "100%" ScrollBars = "auto">
