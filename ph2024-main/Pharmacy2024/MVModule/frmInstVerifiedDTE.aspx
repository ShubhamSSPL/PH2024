<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmInstVerifiedDTE.aspx.cs" Inherits="Pharmacy2024.MVModule.frmInstVerifiedDTE" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Merit list (Institute) Verified By DTE" Width = "100%" ScrollBars = "auto">
        ...
        <asp:GridView ID="gvReport" runat="server" ShowFooter="false" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass = "DataGrid">
            <Columns>                               
                ...
                <asp:HyperLinkField Text="View Certificate" DataNavigateUrlFields="InstituteCode" DataNavigateUrlFormatString = "frmMLVCertificate.aspx?InstituteCode={0}" HeaderText = "Certificate" Target="_blank">
                    <ItemStyle HorizontalAlign="Left" Width="10%" CssClass = "Item" Wrap = "false" />
                    <HeaderStyle HorizontalAlign="Center" CssClass = "Header" />
                    <FooterStyle HorizontalAlign="Center" CssClass = "Footer" />
                </asp:HyperLinkField>
                <asp:HyperLinkField Text="View Report" DataNavigateUrlFields="InstituteCode" DataNavigateUrlFormatString = "CandidateApprovalStatus.aspx?InstituteCode={0}" HeaderText = "Institute-wise Candidate List (Proforma B)" Target="_blank">
                    <ItemStyle HorizontalAlign="Left" Width="10%" CssClass = "Item" Wrap = "false" />
                    <HeaderStyle HorizontalAlign="Center" CssClass = "Header" />
                    <FooterStyle HorizontalAlign="Center" CssClass = "Footer" />
                </asp:HyperLinkField>
