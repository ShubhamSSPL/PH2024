<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmMeritListVerificationDTE.aspx.cs" Inherits="Pharmacy2024.MVModule.frmMeritListVerificationDTE" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Candidate List" Width = "100%" ScrollBars = "auto">
        ...
        <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass = "DataGrid" AllowSorting="True"
            ...
            <Columns> 
                ...
                <asp:TemplateField HeaderText = "Discrepancy Details">
                    <ItemTemplate>
                        <asp:Label ID="lblMVSubDiscrepency" runat="server" Text='<%#Bind("MVSubDiscrepancyID") %>' Visible = "false" />
                        <asp:Label ID="lblSelectedDisc" runat="server" Text='' Visible = "true" />                
                        <asp:DropDownCheckBoxes ID="ddlSubMVDiscrepency" runat="server" AddJQueryReference="True" UseButtons="false" UseSelectAllNode="false" AutoPostBack="true"  OnSelectedIndexChanged="SelectedIndexChangedSubDics">
                                <Style SelectBoxWidth="200" DropDownBoxBoxWidth="250" DropDownBoxBoxHeight="150" />
                                <Texts SelectBoxCaption="-- Select Discrepancy Type --" />
                         </asp:DropDownCheckBoxes>
                    </ItemTemplate>
                ...
                <asp:TemplateField>
                    <HeaderTemplate >
                        <asp:Label ID="lblDescription" runat="server" Text="Remarks" />
                    </HeaderTemplate>
                    <ItemTemplate>                    
        ...
        <asp:GridView ID="gvOthers" runat="server" AutoGenerateColumns="False" CssClass = "DataGrid" AllowSorting="True"
            ...
            <Columns> 
                ...
                <asp:TemplateField HeaderText = "Discrepancy Details">
                    <ItemTemplate>MVSubDiscrepancyID
                        <asp:Label ID="lblMVSubDiscrepency" runat="server" Text='<%#Bind("MVSubDiscrepancyID") %>' Visible = "false" />
                        <asp:Label ID="lblSelectedDisc" runat="server" Text='' Visible = "true" />                
                        <asp:DropDownCheckBoxes ID="ddlSubMVDiscrepency" runat="server" AddJQueryReference="True" UseButtons="false" UseSelectAllNode="false" AutoPostBack="true"  OnSelectedIndexChanged="SelectedIndexChangedSubDics">
                                <Style SelectBoxWidth="200" DropDownBoxBoxWidth="250" DropDownBoxBoxHeight="150" />
