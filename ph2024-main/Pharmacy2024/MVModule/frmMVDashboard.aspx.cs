...
{    
    public partial class frmMVDashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                gvDashboard.DataSource = reg.getRODashboardForMV(RegionName, 'R');
                gvDashboard.DataBind();

                gvDashboardSO.DataSource = reg.getRODashboardForMV(RegionName, 'C');
