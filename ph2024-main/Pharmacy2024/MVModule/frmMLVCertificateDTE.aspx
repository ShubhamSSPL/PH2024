<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMLVCertificateDTE.aspx.cs" Inherits="Pharmacy2024.MVModule.frmMLVCertificateDTE" %>
        ...
        <div style="padding:10px;">
          ...
          <%--  <table cellspacing="0" class="AppFormTable">
           ...
           <%--     <asp:HyperLinkField DataTextField = "InstituteName" DataNavigateUrlFields="InstituteCode" DataNavigateUrlFormatString = "frmAllotedChoiceCodeList.aspx?InstituteCode={0}" HeaderText = "Institute Code">
            ...
            <br />
            <%--<textarea id="txtRemarks"  rows="5" cols="100" maxlength="500">
               
            </textarea>--%>
            <asp:TextBox runat="server" ID="txtRemarks" MaxLength ="500" TextMode="MultiLine" Rows="5" Columns="100"></asp:TextBox>
            <br /><br />
...
<%--            <table class="AppFormTableWithOutBorder">
                ...
                <tr>
                    <td style="text-align: center">
                        <p style="font-size:12px">As per Joint Director Report vide their letter no: ------------------------------------------------------------- dated ---/---/2021. Admissions shown in column no 4 except admissions with Sr. No marked in column 5 are approved. Sr. No of admissions shown in column 6 & 7 are not approved.</p>
                    </td>
                </tr>
            </table>
             <br /><br /> <br /><br />
        ...
        <div><center><asp:Button ID="btnSubmit" runat="server" Text="Verify Institutes" CssClass="InputButton" OnClientClick="return confirm('Are you sure you want to verify institute?');" OnClick="btnSubmit_Click" /></center></div>
    </form>
</body>
</html>
>
