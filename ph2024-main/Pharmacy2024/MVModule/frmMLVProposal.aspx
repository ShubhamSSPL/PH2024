<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmMLVProposal.aspx.cs" Inherits="Pharmacy2024.MVModule.frmMLVProposal" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
   ...
   <table class="AppFormTable">       
            <tr>                
                ...
                <td>
                    <asp:TextBox ID="txtInstCode" runat="server" MaxLength="4" Width="200px" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="hlViewDetails" runat="server">View Varification Details</asp:HyperLink>
                </td>                
            </tr>
            <tr>
            ...
            <tr>
                <td align="right">Is verified by DTE:</td>
                <td>
                    <asp:Label ID="lblDTEStatus" runat="server" Text="" Width="100%" Height="25px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right">Proposal Submission Date:</td>
                <td>
                    <asp:TextBox ID="txtProposalDate" runat="server" MaxLength="10" ReadOnly="false" Style="width: 250px;" 
                        BorderColor="#003366" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox>&nbsp;
                                    ...
                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server"
                                        FilterType="Custom,Numbers" TargetControlID="txtProposalDate" ValidChars="/">
                                    </ajaxToolkit:FilteredTextBoxExtender>
                                    <ajaxToolkit:CalendarExtender ID="calendarButtonExtender" runat="server" Enabled="True"
                                        Format="dd/MM/yyyy" PopupButtonID="Image1" TargetControlID="txtProposalDate" PopupPosition="BottomLeft" CssClass="MyCalendar">
                                    </ajaxToolkit:CalendarExtender>--%>
                </td>
            </tr>
            <tr>
                <td align="right">Physical Proposal Submitted:</td>
                <td>
