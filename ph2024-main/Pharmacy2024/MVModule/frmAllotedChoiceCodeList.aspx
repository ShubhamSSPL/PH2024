<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmAllotedChoiceCodeList.aspx.cs" Inherits="Pharmacy2024.MVModule.frmAllotedChoiceCodeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
     <cc1:ContentBox ID="cbChoiceCD" runat="server" HeaderText="Choice Code Wise Allotment cum Seat Acceptance" Width = "100%" ScrollBars = "auto">
        ...
        <asp:GridView ID="gvReport" runat="server" ShowFooter="false" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass = "DataGrid">
            <Columns>
                ...
                <asp:HyperLinkField DataTextField = "ChoiceCodeDisplay" DataNavigateUrlFields="ChoiceCode,ChoiceCodeDisplay" DataNavigateUrlFormatString = "frmMeritListVerification.aspx?ChoiceCode={0}&ChoiceCodeDisplay={1}" HeaderText = "Choice Code">
    ...
    <cc1:ContentBox ID="cbVerified" runat="server" HeaderText="Verification Completed Status" Width = "100%"  ScrollBars = "auto">
