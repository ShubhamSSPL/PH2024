...
{
    public partial class ARAReports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string ftrCode = "";
                if (Request.QueryString["FilterCode"] != null)
                {
                    ftrCode = Request.QueryString["FilterCode"].ToString();
                }
                if (ftrCode == "A")
                    lblReportName.Text = "List of Institutes where processing fees not applicable.";
                else if (ftrCode == "B")
                    lblReportName.Text = "List of Institutes Verified by DTE and proposal submitted to ARA.";
                else if (ftrCode == "C")
                    lblReportName.Text = "List of Institutes Verified by DTE but proposal not submitted to ARA.";
                else if (ftrCode == "D")
                    lblReportName.Text = "List of Institutes Not verified by DTE.";
                else if (ftrCode == "E")
                    lblReportName.Text = "List of Institutes having zero admissions.";
                else if (ftrCode == "G")
                    lblReportName.Text = "List of Institutes - Pharm. D.";
                else
                    lblReportName.Text = "List of Institutes - B. Pharmacy.";
                gvReport.DataSource = reg.ARAReportforMV(ftrCode);
                gvReport.DataBind();
