<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmProposalSubmittedInst.aspx.cs" Inherits="Pharmacy2024.MVModule.frmProposalSubmittedInst" %>
<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %> 
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
     <cc1:ContentBox ID="cbChoiceCD" runat="server" HeaderText="List of Institutes Submitted Physical Proposal to ARA for
         First Year Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D" Width = "100%" ScrollBars = "auto">
