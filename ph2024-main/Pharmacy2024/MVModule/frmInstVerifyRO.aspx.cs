...
{
    public partial class frmInstVerifyRO : System.Web.UI.Page
    {
       ...
       public void fillGrid()
        {
            ...
            gvReport.DataSource = reg.getRODashboardForMV(RegionName, 'A');
            gvReport.DataBind();
            if(gvReport.Rows.Count==0)
            {
                ...
                lblMsg.Text = "Institutes not found for pending for RO verification or Institutes not verified by SO.";
        ...
        //                    reg.saveInstituteVarificationStatus(InstCode, 'Y', CreatedBy, CreatedIPAddress, 'R');
        //                }
        //            }
