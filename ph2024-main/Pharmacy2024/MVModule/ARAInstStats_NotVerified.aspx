<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARAInstStats_NotVerified.aspx.cs" Inherits="Pharmacy2024.MVModule.ARAInstStats_NotVerified" %>
    ...
    <form id="form1" runat="server">
        ...
        --%>
                ...
                <tr>
                    ...
                    <td style='width: 93%;' align='center'>
                        <b><font size='3'>Admission Regulating Authority, Government of Maharashtra</font><br />
                            ...
                            <br />
                            <font size='2'>Institutewise Report From Directorate (Pending for DTE Verification)</font>
                            <br />
                ...
                <tr >
                    <td style="text-align: left">
                        <h5 style="margin-top:10px;">
                            Name of the Course: First Year Engineering (B.E. / B.Tech.) <br />
                        </h5>
                    </td>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="InstituteName" HeaderText="Institute <br/> Name <br/>(3)" HtmlEncode="false">
                    <ItemStyle HorizontalAlign="Center" CssClass = "Item" Wrap="true" />
                    <HeaderStyle HorizontalAlign="Center" CssClass = "Header" Wrap="false" />
                    <FooterStyle HorizontalAlign="Center" CssClass = "Header" Wrap="false" />
                </asp:BoundField>
