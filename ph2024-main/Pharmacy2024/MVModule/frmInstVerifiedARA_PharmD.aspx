<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageARA.Master" AutoEventWireup="true" CodeBehind="frmInstVerifiedARA_PharmD.aspx.cs" Inherits="Pharmacy2024.MVModule.frmInstVerifiedARA_PharmD" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Merit list (Institute) Verified By DTE" Width = "100%" ScrollBars = "auto">
        ...
        <asp:GridView ID="gvReport" runat="server" ShowFooter="false" AutoGenerateColumns="False" Width="100%" 
            ...
            <Columns>
               ...
               DataNavigateUrlFormatString = "/ARAModule/frmPrintARAApprovalLetterInst.aspx?InstituteCode={0}&TAdm={1}&AAdm={2}&RAdm={3}&CAdm={4}&TIn={5}&Course=D" 
