<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmReplyMessagesCandidateToAdmin.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmReplyMessagesCandidateToAdmin" %>
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <div class="table-responsive">
            <table class="AppFormTableWithOutBorder">
                <tr align="center">
                    <td><a href="../CandidateModule/frmMessagesNonRepliedCandidate.aspx"><font size="2" color="red"><b>| Non Replied Messages |</b></font></a></td>
            ...
            <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="DataGrid" OnRowCommand="gvMessages_RowCommand" OnRowDataBound="gvMessages_RowDataBound">
                <Columns>
                    <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode="false">
                        <ItemStyle Width="35%" HorizontalAlign="Left" VerticalAlign="Top" CssClass="Item" />
