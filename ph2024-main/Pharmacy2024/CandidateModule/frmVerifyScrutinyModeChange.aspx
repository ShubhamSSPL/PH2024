<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmVerifyScrutinyModeChange.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmVerifyScrutinyModeChange" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function EndRequestHandler() {
            if (document.getElementById("rightContainer_cbPassword_LOTP") != null) {
                showRetryTiemout();
            }
        }
        window.onload = load;
    ...
    <cc1:ContentBox ID="cbPassword" runat="server" HeaderText="Confirm SC Verification Mode Change">
                    ...
                    <table id="tblPasword" class="AppFormTable" runat="server">
                         <tr runat="server" id="trPassOTPNote">
                            <td align="center" style="width: 50%; color:red" colspan="2">
                                <b>To change Scrutiny Mode, you have to enter your Login password, then OTP will be sent to your registered  <asp:Label ID="lblMaskMobileno1" runat="server" Font-Bold="true"></asp:Label> mobile number.</b>
                            </td>
                        </tr>
                    ...
                    <table id="tblOtp" class="AppFormTable" runat="server">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <asp:Label ID="LOTP" runat="server" Visible="false"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" colspan="3">
