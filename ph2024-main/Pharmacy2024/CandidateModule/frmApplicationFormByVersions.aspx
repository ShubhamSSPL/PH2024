<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmApplicationFormByVersions.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmApplicationFormByVersions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="right">Application Form Version No
                </td>
                <td>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderVisible="false" Visible="false">
       ...
       <tr>
            ...
            <%--<tr>
                <th colspan="4" align="left">List of Documents Required at the time of Document Verification and Confirmation at Scrutiny Center.</th>
            </tr>--%>
            <tr>
                <table class="AppFormTable">
                    ...
                    <tr id="trDocumentsSubmitted2" runat="server">
                        <td colspan="4">
                            <asp:GridView ID="gvDocumentsSubmitted" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="DataGrid" OnRowDataBound="gvDocuments_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Document Name" DataField="DocumentName" HtmlEncode="false">
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="800%" CssClass="Header" />
                    ...
                    <tr id="tr1" runat="server" visible="false">
                        <td>
                            <asp:Label ID="Label1" runat="server" ForeColor="Red"><b>Remark : </b></asp:Label></td>
                    </tr>
                    <tr id="trComments" runat="server" visible="false">
                        <td>
                            <asp:Label ID="lblComments" runat="server"><b>Comments : </b></asp:Label></td>
                    </tr>
                </table>
            </tr>
