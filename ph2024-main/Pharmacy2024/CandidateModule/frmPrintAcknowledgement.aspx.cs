...
namespace Pharmacy2024.CandidateModule
{
    public partial class frmPrintAcknowledgement : System.Web.UI.Page
    {
            ...
            if (!Request.FilePath.Contains("StaticPages/HomePage"))
            {
                ...
                if (!IsPostBack)
                {
                    try
                    {
                        ...
                        string Versionno = "";
                        if (Request.QueryString["VersionNo"] != null)
                        {
                            Versionno = Request.QueryString["VersionNo"].ToString();
                        }
                        //Int64 PID = Convert.ToInt64(Session["UserLoginID"].ToString().Replace(Global.ApplicationFormPrefix, ""));
        ...
        private void LoadFromversionNo(string Versionno)
        {
            ...
            Int32 ApplicationFeeToBePaid = reg.getApplicationFeeToBePaid(PID);
            Int32 ApplicationFeePaid = reg.getApplicationFeePaidAmount(PID);
            PersonalInformation obj = reg.GetPersonalInformationByAcknowledgementVersionNo(PID, Convert.ToInt32(Versionno));
            ...
            List<DocumentDetails> lstDocuments = reg.GetPersonalInformationByAcknowledgementVersionNoDocuments(PID, Convert.ToInt32(Versionno));
            ...
            List<DiscrepancyDetails> lstDiscrepancy = reg.GetAcknowledgementVersionNoDiscrepancy(PID, Convert.ToInt32(Versionno));
