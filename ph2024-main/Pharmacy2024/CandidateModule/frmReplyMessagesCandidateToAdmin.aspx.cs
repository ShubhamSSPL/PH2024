...
{
    public partial class frmReplyMessagesCandidateToAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    {
                        Response.Redirect("../CandidateModule/frmMessagesNonRepliedCandidate.aspx");
                    }
                    else
                    {
                        ...
                        gvMessages.DataSource = reg.getRepliedMessagesListToCandidate(From);
                        gvMessages.DataBind();
