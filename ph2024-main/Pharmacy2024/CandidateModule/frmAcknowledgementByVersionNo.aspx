<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmAcknowledgementByVersionNo.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmAcknowledgementByVersionNo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    <script lang="javascript" type="text/javascript">
        ...
        function OpenPopUpWindow() {
            ...
            window.open("frmPrintAcknowledgement?VersionNo=" + opt.value + "&PID=" + <% = PID %>, "Password", "width=1000px,height=500px,resizable=yes,scrollbars=yes");
        }
    </script>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderVisible="false" Visible="false">
        ...
        <table class="AppFormTable">
            ...
            <tr id="trDocumentsNotSubmitted2" runat="server">
                ...
                <tr>
                    <td>
                        <table id="tblDiscrepancy" runat="server" width="100%" visible="false">
                            <tr>
                                <td>
