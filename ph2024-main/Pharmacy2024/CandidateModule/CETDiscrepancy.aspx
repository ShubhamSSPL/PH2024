<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="CETDiscrepancy.aspx.cs" Inherits="Pharmacy2024.CandidateModule.CETDiscrepancy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <table id="tblCETDetails" runat="server" class="AppFormTable">
        ...
        <tr id="trCET3" runat="server">
            <td align="right" colspan="2"><asp:Label ID="lblSubjectName1" runat="server" Text="" ></asp:Label> </td>
            <td colspan="2">
                <asp:Label ID="lblCETMathMarks" runat="server" Font-Bold="true"></asp:Label></td>
        </tr>
        <tr id="trCET4" runat="server">
            <td align="right" colspan="2"><asp:Label ID="lblGroupName1" runat="server" Text="" ></asp:Label> </td>
            <td colspan="2">
    ...
    <table class="AppFormTable" id="tblNewCETDetails" runat="server">
        ...
        <tr id="trCETRollNo" runat="server">
            ...
            <td>
                <asp:TextBox ID="txtCETRollNo" runat="server" MaxLength="14" onKeyPress="return numbersonly(event)"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="revCETRollNo" runat="server" Display="None" ValidationExpression="\d{14}" ControlToValidate="txtCETRollNo"></asp:RegularExpressionValidator>
            </td>
        </tr>
