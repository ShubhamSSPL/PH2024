<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmUploadRequiredDocumentsStep.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <style>
        ...
        #rightContainer_contentDocumentConferamtion .HeadDiv a {
            display: none;
        }
    </style>
                ...
                if (data.length > 10) {
                    ...
                    if (documentID == "21") {
                        ...
                        if (hidJUD == "0") {
                            ...
                            var message = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.UploadDoc(data, documentID, hidJUD, hidDID, hidTID, fileName, fileExt, checkBarcode, barcode, CandidateBarcode);
            ...
            <tr>
                <td colspan="4">
                    <font color="red">
                        ...
                        <ul class="list-text">
                            <li>
                                <p align="justify"><font color="red">Please Use Latest Version Of <b>Google Chrome</b> or <b>Mozilla Firefox</b> To Upload Documents.</font></p>
                            </li>
                            <li>
                                <p align="justify"><font color="red">File Types Allowed : <b>
                                    <asp:Label ID="lblFileTypesAllowed" runat="server"></asp:Label></b>.</font></p>
                            </li>
                            <li>
                                <p align="justify"><font color="red">Maximum File Size Allowed : <b>
                                    <asp:Label ID="lblMaxFileSize" runat="server"></asp:Label></b>.</font></p>
                            </li>
                        </ul>
                    </font>
                </td>
                ...
                <td colspan="2">
                    <p align="justify">
                        ...
                        <p align="justify">
                            <b><u>Non-Creamy Layer Certificate</u> :-</b>
                            <br />
                            A candidate belonging to ‘Creamy Layer’ amongst the categories VJ/DT-NT(A), NT(B), NT(C), NT(D), SBC, SEBC and OBC must note that the provision of reservation is NOT applicable to him/her. A candidate claiming benefit of reservation under the categories VJ/DT-NT(A), NT(B), NT(C), NT(D), SBC, SEBC and OBC above will be required to produce <b>&quot;Non-Creamy Layer Certificate&quot;</b> in the name of the candidate as specified in the <b>Government Resolution No. CBC-10/2008/C.R.697/BCW-5</b>, dated 27th February 2009 or its updated version from time to time. <b>This certificate should be valid up to 31st March <%=NextYear%>.</b> <%--However, such a Non-Creamy Layer Certificate shall be produced in any case on or before the last date of filling up of Application Form, failing which the category claim, will not be granted.--%>
                        </p>
                    </p>
                </td>
            </tr>
                ...
                <tr>
                    <td>
                        <div class="modal-body p-0">
                            ...
                            <div id="divDocument" class="doc-container img-fluid"></div>
                        </div>
                    </td>
                </tr>
            </table>
    ...
    <ccm:ContentBox ID="contentAppleSarkarBarti" runat="server" BoxType="ContentBox" Width="80%" Height="500px" Style="display: none;" HeaderText="Upload Document">
                            ...
                            <div class="row w-100 mx-auto">
                                ...
                                <div class="col-sm-9">
                                    <b>
                                        <label id="lbldoumentuplodName"></label>
                                        <br />
                                        <label style="color: #8c1a41;">(Upload scan copy of Original Document only.)</label>
                                        <br />
                                        <label id="lbldoumentInstruction" style="color: #8c1a41;"></label>
                                        <%--<br />--%>
                                        <label id="lblNationalitynot" style="color: red; font-size: 15px;">Aadhaar Card is not valid document for Nationality.<br />For Nationality, Please upload School Leaving Certificate or Birth Certificate or Passport or Nationality Certificate.</label>
                                    </b>
                                </div>
                                <div class="col-1">
                                    <button type="button" onclick="closeUpload()" style="width: 30px; height: 10px;" title="Close">
        ...
        <script>
            function viewUploadDocumentDiv(e) {
                e.preventDefault();
                if (Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.InsertUpdateDocumentFetchData(document.getElementById('<%=hidResponse.ClientID %>').value, $("#<%=hdnCurrentDocId.ClientID %>").get(0).value)) {
                    document.getElementById('<%=divup.ClientID %>').style.display = "block";
            ...
            function ValidateBarcode(e) {
                ...
                if (document.getElementById('<%=txtbarcode.ClientID %>').value > 0) {
                    ...
                    var dsResponse = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.FetchDocument(docID, document.getElementById('<%=txtbarcode.ClientID %>').value);
    ...
    <script type="text/javascript">
        ...
        function OpenTestPopup(cntrl) {
            ...
            if (documentId == 22) {
                document.getElementById("lbldoumentInstruction").innerText = "Receipt of CVC/TVC is not Acceptable.";
            }
            else if (documentId == 24) {
                document.getElementById("lbldoumentInstruction").innerText = "Receipt of NCL is not Acceptable.";
            }
            else if (documentId == 36) {
                document.getElementById("lbldoumentInstruction").innerText = "Receipt of EWS is not Acceptable.";
            }
            else {
                document.getElementById("lbldoumentInstruction").style.display = "none";
            }
        ...
        function getDistrict(JurisdictionID) {
            ...
            var categoryID = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.getCategoryID();
            ...
            var dsDistrict = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.getDistrictForJuridiction(JurisdictionID);
        ...
        function getTaluka(DistrictID) {
            ...
            opt.value = "0";
            if (DistrictID != 0) {
                var dsTaluka = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.getTalukaForDistrict(DistrictID);
        ...
        function OpenViewDocumentPopUp(cntrl) {
            ...
            if (IsBarcodeFetch == "Y") {
                var dsResponse = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.GetDocumentFetchData(personalID, documentID);
        ...
        function LoadDistrictTalukaJuridicaiton(documentId) {
            if (documentId == "21" || documentId == "22") {
                ...
                var ds = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.FillJuridiction(documentId);
                var categoryID = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.getCategoryID();
            ...
            document.getElementById("lblNationalitynot").style.display = "none";
            ...
            if (documentId == "1" || documentId == "2" || documentId == "11") {
                ...
                document.getElementById("lblNationalitynot").style.display = "revert";
            }
        }
    </script>
    <%--<script type="text/javascript">
    ...
    <script type="text/javascript" lang="javascript">
        Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep
            ...
            if (files.length > 0) {
                ...
                if (documentID == "21") {
                    ...
                    if (hidJUD == "0") {
                        ...
                        var message = Pharmacy2024.CandidateModule.frmUploadRequiredDocumentsStep.UploadDoc(files, documentID, hidJUD, hidDID, hidTID);
                        if (message.value == "The File has been uploaded.") {
                            $('#<%=btnUploadComplete.ClientID %>').show();
                            $('#<%=btnUploadComplete.ClientID %>').click();
                        }
