<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmApplicationForm.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmApplicationForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder" id="tblPrint1" runat="server">
            ...
            <%--<tr>
                <td><font size="3" color="blue"><b>Note : </b> To Edit/Delete/Change the Uploaded Documents, </font><asp:button id="btnUploadDocuments" runat="server" CssClass="InputButton"  BackColor="#5cb85c" Text=" Click Here " Height="40px" Font-Size="Medium" Font-Bold="true" onclick="btnUploadDocuments_Click"></asp:button></td>
            </tr>--%>
	    </table>
        <br />
        <table class="AppFormTable" id="tblHeader1" runat="server" >
            <tr>
                <td style="width:89%; border-right-width:0px"><font size = "2"><b>First Year of Four Year Degree Course in Pharmacy & First Year of Six Year Post Graduate Degree Course in Pharm. D. for the Academic Year <%= AdmissionYear %></b></font></td>
        ...
        <table class="AppFormTable  ">
            ...
            <tr>
                ...
                <td ><asp:Label id="lblNationality" runat="server" Font-Bold = "true"></asp:Label></td>
            </tr> 
       ...
       <tr>
            ...
            <tr id = "trDiplomaTotalMarks" runat = "server" visible="false">
                <td align="right"><asp:Label id="lblDiplomaTotalMarks" runat="server">Diploma Aggregate Marks</asp:Label></td>
                <td align="center"><asp:Label id="lblDiplomaTotalMarksObtained" runat="server" Font-Bold = "true"></asp:Label></td>
                <td align="center"><asp:Label id="lblDiplomaTotalMarksOutOf" runat="server" Font-Bold = "true"></asp:Label></td>
                <td align="center"><asp:Label id="lblDiplomaTotalPercentage" runat="server" Font-Bold = "true"></asp:Label></td>
            </tr>
            <tr> 
            ...
            <tr>
                ...
                <td colspan="3"><asp:Label ID="lblHSCPassingStatus" runat="server" Font-Bold = "true"></asp:Label></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><asp:Label ID = "lblAppearedForNEET" runat = "server" Font-Bold = "true"></asp:Label></td>
                <td align = "right"><asp:Label id="lblNEETRollNoHeader" runat="server">Roll No</asp:Label></td>
                <td><asp:Label ID = "lblNEETRollNo" runat = "server" Font-Bold = "true"></asp:Label></td>
            </tr>
            <tr id = "trNEETScore1" runat = "server">
                <td align = "right">Physics</td>
                <td><asp:Label ID = "lblNEETPhysicsScore" runat = "server" Font-Bold = "true"></asp:Label></td>
                <td align = "right">Chemistry</td>
                <td><asp:Label ID = "lblNEETChemistryScore" runat = "server" Font-Bold = "true"></asp:Label></td>
            </tr>
            <tr id = "trNEETScore2" runat = "server">
                <td align = "right">Biology (Botany & Zoology)</td>
                <td><asp:Label ID = "lblNEETBiologyScore" runat = "server" Font-Bold = "true"></asp:Label></td>
                <td align = "right">Total</td>
                <td><asp:Label ID = "lblNEETTotalScore" runat = "server" Font-Bold = "true"></asp:Label></td>
            </tr>
        </table>
            </div>
        <table class="AppFormTable" style="background: #ffeaaa; padding: 5px;">
        ...
        <table class="AppFormTable">
            <tr>
                <th align = "left" style="border-top-width:0px;">List of Documents Required at the time of Document Verification and Confirmation at Scrutiny Center</th>
            </tr>
            <tr>
                <td>
            ...
            <tr id = "trEligibilityRemark" runat = "server" visible = "false">
                <td><asp:Label ID="lblEligibilityRemark" runat="server" ForeColor="Red" Font-Size="Medium"><b>Remark : </b></asp:Label></td>
            </tr>
        </table>
        <table class="AppFormTable" id="tblFooter1" runat="server">
            ...
            <tr>
                ...
                <td style="width: 40%" align = "center" valign = "bottom" rowspan = "4"> 
                    <asp:Image ID="imgSignature1" width="133" Height="57" runat="server" AlternateText="Candidate Signature" Visible="true" />
                    <br />
