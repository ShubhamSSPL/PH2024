<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesNonRepliedCandidate.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmMessagesNonRepliedCandidate" %>
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <div class="table-responsive">
            <table class="AppFormTableWithOutBorder">
                <tr align="center">
                    <td><a href="../CandidateModule/frmMessagesNonRepliedCandidate.aspx"><font size="2" color="red"><b>| Non Replied / New Messages |</b></font></a></td>
