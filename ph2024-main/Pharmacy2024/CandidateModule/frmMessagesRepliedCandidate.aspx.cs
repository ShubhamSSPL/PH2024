...
{
    public partial class frmMessagesRepliedCandidate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    gvMessages.DataSource = reg.GetRepliedMessagesToCandidateByAdmin(Session["UserLoginID"].ToString());
                    gvMessages.DataBind();
