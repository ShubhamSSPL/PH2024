<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="frmPrintApplicationForm.aspx.cs" Inherits="Pharmacy2024.CandidateModule.frmPrintApplicationForm" %>
    ...
    <body onload = "window.print();">
        <form id="form1" runat="server"> 
            ...
            <table class="AppFormTable">
                <tr>
                    <td style="width:75%;"><font size = "2"><b>First Year Degree in Pharmacy & First Year of Six Year Post Graduate Degree Course in Pharm. D. for the Academic Year <%= AdmissionYear %></b></font></td>
                    <td style="width:25%;border-left-width:0px; border-right-width:0px;" align = "right"><font size = "2"><b>Application Form</b></font></td>
                </tr>
            </table>
            <table class="AppFormTable">
                <tr>
