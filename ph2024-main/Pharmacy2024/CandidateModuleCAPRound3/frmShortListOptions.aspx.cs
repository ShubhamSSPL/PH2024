    ...
    public partial class frmShortListOptions : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound3(objSessionData.PID, "frmShortListOptions.aspx");
                    ...
                    if (objSessionData.OptionFormStatusCAPRound3 == 'A' || objSessionData.StepIDCAPRound3 < 0)
                    {
                        Response.Redirect("../CandidateModuleCAPRound3/frmOptionForm.aspx?tms=101", true);
                    }

                    ddlCourse.DataSource = reg.getCourseListByPID(3, objSessionData.PID);
                    ddlCourse.DataTextField = "CourseName";
                    ddlCourse.DataValueField = "CourseCode";
                    ddlCourse.DataBind();
                    ddlCourse.Items.Insert(0, new ListItem("-- Select Course --", "0"));

                    ddlUniversity.DataSource = Global.MasterUniversityCAPRound3;
                    ...
                    ddlDistrict.DataSource = reg.getMasterDistrictForUniversity(3, 0);
                    ddlDistrict.DataTextField = "DistrictName";
                    ddlDistrict.DataValueField = "DistrictName";
                    ddlDistrict.DataBind();
                    ddlDistrict.Items.Insert(0, new ListItem("All", "All"));

                    ddlCourseStatus1.DataSource = Global.MasterCourseStatus1CAPRound3;
                    ...
                    ddlCourseStatus2.DataSource = Global.MasterCourseStatus2CAPRound3;
                    ...
                    ddlCourseStatus3.DataSource = Global.MasterCourseStatus3CAPRound3;
        ...
        protected void ddlUniversity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ddlDistrict.DataSource = reg.getMasterDistrictForUniversity(3, UniversityID);
                ddlDistrict.DataTextField = "DistrictName";
                ddlDistrict.DataValueField = "DistrictName";
                ddlDistrict.DataBind();
                ddlDistrict.Items.Insert(0, new ListItem("All", "All"));
        ...
        protected void getSelectedOptionsList()
        {
            ...
            try
            {
                ...
                gvSelectedOptionsList.DataSource = reg.getSelectedOptionsListCAPRound3(objSessionData.PID);
        ...
        protected void getOptionsList()
        {
            ...
            try
            {
                ...
                if (ddlCourse.SelectedValue != "0")
                {
                    ...
                    gvOptionsList.DataSource = reg.getOptionsListCAPRound3(objSessionData.PID, CourseCode, UniversityID, DistrictName, CourseStatus1, CourseStatus2, CourseStatus3, TFWSStatus);
        ...
        public void btnAddSelectedOptions_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (OptionsList.Length > 27)
                {
                    ...
                    {
                        switch (reg.saveOptionsCAPRound3(objSessionData.PID, OptionsList, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                        {
                            case 0:
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                objSessionData.StepIDCAPRound3 = 4;
                                objSessionData.OptionFormStatusCAPRound3 = 'A';
                    ...
                    {
                        ContentTable1.Focus();
                        shInfo.SetMessage("You Do Not Add More Than 300 College's.you add only remaining " + ((300 - gvSelectedOptionsList.Rows.Count)) + "  Colleges", ShowMessageType.Information);
                    }
                }
        ...
        public void btnDeleteSelectedOptions_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (OptionsList.Length > 27)
                {
                    ...
                    switch (reg.deleteOptionsCAPRound3(objSessionData.PID, OptionsList, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                    {
                        case 0:
                            shInfo.SetMessage("There is some problem in Data Saving. Please try again.", ShowMessageType.UserError);
                            break;
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.saveShortlistedOptionsCAPRound3(objSessionData.PID, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
                        shInfo.SetMessage("Please Shortlist Atleast One Institute.", ShowMessageType.Information);
                        break;
                    case 1:
                        if (objSessionData.StepIDCAPRound3 < 1)
                        {
                            ((SessionData)Session["SessionData"]).StepIDCAPRound3 = 1;
                        }
