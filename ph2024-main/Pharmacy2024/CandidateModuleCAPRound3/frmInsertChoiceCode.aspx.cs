    ...
    public partial class frmInsertChoiceCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound3(objSessionData.PID, "frmInsertChoiceCode.aspx");
                    ...
                    ddlUniversity.DataSource = reg.getUniversityListByPID(3, objSessionData.PID);
        ...
        protected void getPreferencedOptionsList()
        {
            ...
            try
            {
                ...
                gvPreferencedOptionsList.DataSource = reg.getPreferancedOptionsListCAPRound3(objSessionData.PID);
        ...
        protected void ddlUniversity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ddlInstitute.DataSource = reg.getInstituteListByUniversityID(3, objSessionData.PID, UniversityID);
        ...
        protected void ddlInstitute_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ddlChoiceCode.DataSource = reg.getChoiceCodeListByInstituteID(3, objSessionData.PID, InstituteID);
        ...
        protected void btnInsert_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.insertOptionCAPRound3(objSessionData.PID, PreferenceNo, ChoiceCode, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
