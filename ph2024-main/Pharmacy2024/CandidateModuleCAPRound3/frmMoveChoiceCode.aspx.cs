...
{
    public partial class frmMoveChoiceCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound3(objSessionData.PID, "frmMoveChoiceCode.aspx");
                    ...
                    if (objSessionData.OptionFormStatusCAPRound3 == 'A' || objSessionData.StepIDCAPRound3 < 2)
                    {
        ...
        public void showPreferenceNo(DropDownList ddlPreferenceNo, Int32 PreferenceCount)
        {
            ...
            for (Int32 i = 1; i <= PreferenceCount - 1; i++)
            {
        ...
        protected void getPreferencedOptionsList()
        {
            ...
            try
            {
                ...
                ddlChoiceCode.DataSource = ds;
                ddlChoiceCode.DataTextField = "ChoiceCodeDetails";
                ...
                ddlChoiceCode.Items.Remove(ddlChoiceCode.Items.FindByText(""));
        ...
        protected void btnMove_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Int64 ChoiceCode = Convert.ToInt64(ddlChoiceCode.Text);

                switch (reg.moveOptionCAPRound3(objSessionData.PID, PreferenceNo, ChoiceCode, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
                        shInfo.SetMessage("Invalid Choice Code or You have not given any preference to this Choice Code.", ShowMessageType.Information);
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        shInfo.SetMessage("Choice Code Moved Successfully.", ShowMessageType.Information);
                        break;
                    default:
