<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmOptionFormSummary.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound3.frmOptionFormSummary" %>
                    ...
                    <tr>
                        <td colspan="4">
                            <ol class="list-text">
                                ...
                                <li><p align = "justify">Carefully check the Preferences given by you to Courses and Institutes displayed below.</p></li>
                                <li><p align = "justify">If you again wish to change the Preferences click on the 'Change preferences' Button.</p></li>
                                <li><p align = "justify">If you are sure about the preferences set for courses and Institutes then click on 'Confirm Options' Button.</p></li>
                                <li><p align = "justify">Once you Confirm your Preferences, you will not be able to Edit it.</p></li>
                                <li><p align = "justify">If you want to Insert a Choice Code to a particular position, then click on 'Insert Choice Code' Button.</p></li>
                                <li><p align = "justify">If you want to Move a Preference Choice Code to a particular position, then click on 'Move Choice Code' Button.</p></li>
                            </ol>
                        </td>
                    </tr>
                </table>
