    ...
    public partial class frmVerifyAndConfirmOptionForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    Int32 PreferenceCount = reg.getPreferencesCountCAPRound3(objSessionData.PID);
                    if (PreferenceCount > 300)
                    {
                        tblPasword.Visible = false;
                        tblOtp.Visible = false;
                        Response.Redirect("../CandidateModuleCAPRound3/frmShortListOptions?tms=101");
                    ...
                    //DataSet ds = reg.getPreferancedOptionsListCAPRound3(objSessionData.PID);
        ...
        protected void btnVerifyOtp_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (strInvalidChoiceCodes.Length > 6)
                {
                    Response.Redirect("../CandidateModuleCAPRound3/frmConfirmOptionForm.aspx?tms=101");
                }
                ...
                if (Captcha1.UserValidated)
                {
                    ...
                    if (reg.verifyOTP(ApplicationID, txtOneTimePassword.Text, 14))
                    {
                        switch (reg.confirmOptionFormCAPRound3(objSessionData.PID, DataEncryption.EncryptDataByHashSHA1(hdnPassword.Value), Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                        {
                            case 0:
                            ...
                            case 2:
                                ...
                                //DataSet ds = reg.GetSMSEmailContent(objSessionData.PID, "OptionFormConfirmCAPIII", UserInfo.GetIPAddress(), Global.IsOTPVerificationRequired);
                                //SMS objSMS = new SMS();
                                //if (ds.Tables[1] != null)
                                //{
                                ...
                                break;
                            case 3:
                                if (objSessionData.StepIDCAPRound3 < 4)
                                {
                                    objSessionData.StepIDCAPRound3 = 4;
                                }

                                if (objSessionData.OptionFormStatusCAPRound3 == 'C')
                                {
                                    objSessionData.OptionFormStatusCAPRound3 = 'A';
                                }
                                ...
                                sMSTemplate1.RoundNumber = "III";
                                if (Global.SendSMSToCandidate == 1)
                                    synCommon1.SendInformationSMS(sMSTemplate1, SynCommon.TemplateSystemType.OptionFormConfirmCAP);
                                //SMS objSMS1 = new SMS();
                                //DataSet ds1 = reg.GetSMSEmailContent(objSessionData.PID, "OptionFormConfirmCAPIII", UserInfo.GetIPAddress(), Global.IsOTPVerificationRequired);
        ...
        protected void btnpassword_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    if (Global.IsOTPVerificationRequiredForOptionForm3 == 1)
                    {
                        tblPasword.Visible = false;
                        tblOtp.Visible = true;
                        tblPasword.Visible = false;
                        ...
                        sMSTemplate.PID = PID;
                        SynCommon synCommon = new SynCommon();
                        if (synCommon.SendOTPSMS(sMSTemplate, SynCommon.TemplateSystemType.CAPOptionFormIIIOTP))
                        {
                        ...
                        //SMS objSMS = new SMS();
                        //DataSet ds = reg.GetSMSEmailContent(objSessionData.PID, "CAPOptionFormIII", UserInfo.GetIPAddress(), Global.IsOTPVerificationRequired);
                        //if (ds.Tables[1] != null)
                        //{
                        //    if (ds.Tables[1].Rows.Count > 0)
                        //    {
                    ...
                    else
                    {
                        ...
                        switch (reg.confirmOptionFormCAPRound3(objSessionData.PID, DataEncryption.EncryptDataByHashSHA1(hdnPassword.Value), Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                        {
                            ...
                            case 2:
                                ...
                                sMSTemplate.CurrentDateTime = DateTime.Now.ToString();
                                if (Global.SendSMSToCandidate == 1)
                                    synCommon.SendInformationSMS(sMSTemplate, SynCommon.TemplateSystemType.OptionFormConfirmCAPIII);
                                //DataSet ds = reg.GetSMSEmailContent(objSessionData.PID, "OptionFormConfirmCAPIII", UserInfo.GetIPAddress(), Global.IsOTPVerificationRequired);
                                //SMS objSMS = new SMS();
                                //if (ds.Tables[1] != null)
                                //{
                            ...
                            case 3:
                                ...
                                sMSTemplate1.CurrentDateTime = DateTime.Now.ToString();
                                if (Global.SendSMSToCandidate == 1)
                                    synCommon1.SendInformationSMS(sMSTemplate1, SynCommon.TemplateSystemType.OptionFormConfirmCAPIII);
                                //SMS objSMS1 = new SMS();
                                //DataSet ds1 = reg.GetSMSEmailContent(objSessionData.PID, "OptionFormConfirmCAPIII", UserInfo.GetIPAddress(), Global.IsOTPVerificationRequired);
                                //if (ds1.Tables[0] != null)
                                //{
