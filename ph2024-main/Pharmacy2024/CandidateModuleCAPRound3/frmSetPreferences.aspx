<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmSetPreferences.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound3.frmSetPreferences" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <script language="javascript" type = "text/javascript">
        ...
        function checkPreferancesCount(sender, args)
        {
            if (Counter > 300) {
                args.IsValid = false;
                return;
            ...
            <tr>
                <td align="center">
                    ...
                    <asp:CustomValidator ID="cvPreferances" runat="server" ErrorMessage="Please Set Preferences for Atleast One Choice Code." ClientValidationFunction="checkone" Display="None"></asp:CustomValidator>
                     <asp:CustomValidator ID="cvCheckpassPreferances" runat="server" ErrorMessage="You can not select Institutes more than 300." ClientValidationFunction="checkPreferancesCount" Display="None"></asp:CustomValidator>
                    ...
                    <tr>
                        <td colspan="4">
                            <ol class="list-text">
                                ...
                                <li><p align = "justify">To set Preference click on check box of respective Choice code one by one.</p></li>
                                <li><p align = "justify">Only preference given by candidate will be considered for next step.</p></li>
                                <li><p align = "justify">You can reset the preferences by clicking on 'Reset My Preferences' Button.</p></li>
                                <li><p align = "justify">After giving preferences to all your selected Choice Code, click on 'Save & Proceed' Button.</p></li>
                            </ol>
                        </td>
                    </tr>
                </table>
