        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    DataSet ds = reg.getCurrentLinkCAPRound3(objSessionData.PID, "frmOptionForm");
                    ...
                    {
                        Response.Redirect("../CandidateModuleCAPRound3/frmCandidateDeclarationForReceipt.aspx", true);
                    }
                    ...
                    if (objSessionData.StepIDCAPRound3 == 0 && reg.getSelectedOptionsListCAPRound3(objSessionData.PID).Tables[0].Rows.Count == 0 && (reg.isOptionFormConfirmedCAPRound1(objSessionData.PID) || reg.isOptionFormConfirmedCAPRound2(objSessionData.PID)))
                    {
                        Response.Redirect("../CandidateModuleCAPRound3/frmImportChoiceCodesFromCAPRound2.aspx");
                    }
                    ...
                    {
                        DataSet dsPersonalInformation = reg.getPersonalInformationCAPRound3(objSessionData.PID);
                        ...
                        //if (dsPersonalInformation.Tables[0].Rows[0]["CategoryForAdmission"].ToString().Contains("$"))
                        //    trCVC.Visible = true;
                        //if (dsPersonalInformation.Tables[0].Rows[0]["CategoryForAdmission"].ToString().Contains("#"))
                        //    trNCL.Visible = true;
                        ...
                        DataSet dsInstructions = reg.getInstructionsCAPRound3(objSessionData.PID);
                        ...
                        DataSet dsOptionFormConfirmationDetails = reg.getOptionFormConfirmationDetailsCAPRound3(objSessionData.PID);
