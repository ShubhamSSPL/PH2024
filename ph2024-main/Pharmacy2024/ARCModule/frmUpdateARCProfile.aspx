<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmUpdateARCProfile.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmUpdateARCProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function isDateValid(sender, args) {
            var dateStr = document.getElementById("ctl00_rightContainer_ContentTable2_txtCoordinatorDOB").value;
            if (dateStr.length == 0) {
                args.IsValid = false;
                return;
            }
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Update ARC Profile">
        <table class="AppFormTable">
            <tr>
                <th colspan="4" align="left">ARC Details</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <asp:TextBox ID="txtARCAddress" runat="server" TextMode="MultiLine" Width="70%"></asp:TextBox>
                    <font color="red"><sup>*</sup></font>
                    <asp:RequiredFieldValidator ID="rfvARCAddress" runat="server" ControlToValidate="txtARCAddress" Display="None" ErrorMessage="Please Enter ARC Address."></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td style="width: 25%;" align="right">ARC Phone No.</td>
                <td style="width: 25%;">
                    <asp:TextBox ID="txtARCPhoneNo" runat="server" MaxLength="15" onKeyPress="return numbersonly(event)" Width="90%"></asp:TextBox>
                    <font color="red"><sup>*</sup></font>
                    <asp:RequiredFieldValidator ID="rfvARCPhoneNo" runat="server" ControlToValidate="txtARCPhoneNo" Display="None" ErrorMessage="Please Enter ARC Phone No."></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="cvARCPhone" runat="server" ControlToValidate="txtARCPhoneNo" Display="None" ErrorMessage="Please Enter Proper ARC Phone No." Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
                <td style="width: 25%;" align="right">ARC Fax No.</td>
                <td style="width: 25%;">
                    <asp:TextBox ID="txtARCFaxNo" runat="server" MaxLength="15" onKeyPress="return numbersonly(event)" Width="90%"></asp:TextBox>
                    <font color="red"><sup>*</sup></font>
                    <asp:RequiredFieldValidator ID="rfvARCFaxNo" runat="server" ControlToValidate="txtARCFaxNo" Display="None" ErrorMessage="Please Enter ARC Fax No."></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="cvARCFax" runat="server" ControlToValidate="txtARCFaxNo" Display="None" ErrorMessage="Please Enter Proper ARC Fax No." Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>
                </td>
            </tr>
            <tr>
