        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ds.Merge(reg.getARCList(UserTypeID, UserLoginID));
                    ViewState["ds"] = ds;
            ...
            try
            {
                ...
                if (chkSMS.Checked)
                {
                    ...
                    if (Sms.Count > 0)
                    {
                        ...
                        // ShowMessage shInfo = (ShowMessage)Master.FindControl("ShowMsg");
                        SMS sMS = new SMS();
                        ////IRestResponse response = sMS.SendBulkSMS(msg91, "Custom Message");
