<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceCancellationAcknowledgement.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmSeatAcceptanceCancellationAcknowledgement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function OpenPopUpWindow() {
            window.open("frmPrintSeatAcceptanceCancellationAcknowledgement.aspx?PID=<% = PID %>", "Password", "width=1000px,height=500px,resizable=yes,scrollbars=yes");
        }
    </script>
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <input id="btnPrint1" type="button" runat="server" value="Print Seat Acceptance Cancellation Acknowledgement" class="InputButton" onclick="javascript: OpenPopUpWindow()" />
                </td>
            </tr>
            <tr>
                <td>
                    <div id="Note">
                        <font color="red">
                            <ol class="list-text">
                                ...
                                <li>The online system will print <b>Seat Acceptance Cancellation Acknowledgement</b>.</li>
        ...
        <table class="AppFormTable">
            <tr>
                ...
                <td style="border-left-width: 0px;" align="right"><font size="2"><b>Seat Acceptance Cancellation Acknowledgement</b></font></td>
            </tr>
        </table>
        <table class="AppFormTable">
            <tr>
                ...
                <td style="width: 80%; border-top-width: 0px; border-left-width: 0px;" align="center">
                    <b>
                        ...
                        <br />
                        <br />
                        Receipt-cum-Acknowledgement of Cancellation of Seat Acceptance Form for Admission to First Year of Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D for the Academic Year <%= AdmissionYear %>
                    </b>
                </td>
        ...
        <table id="tblSeatAcceptanceStatusDetails" runat="server" class="AppFormTable" visible="false">
            ...
            <tr>
                ...
                <td style="width: 25%" align="right">Confirmation at ARC</td>
                <td style="width: 25%">
        ...
        <table class="AppFormTable">
            <tr>
                <td style="border-top-width: 0px;" colspan="2">
                    ...
                    <p align="justify">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        I have read all the rules of admission and Information brochure for admission to UG courses <%=CurrentYear%> and on understanding these Rules, I have filled this Seat Acceptance Cancellation Form for Admission to First Year of Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D for the Academic Year <%= AdmissionYear %>. The information given by me in this application is true to the best of my knowledge &amp; belief. If at later stage, it is found that I have furnished wrong information and/or submitted false certificate(s), I am aware that my admission stands cancelled and fees paid by me will be forfeited. Further I will be subject to legal and/or penal action as per the provisions of the law.
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Cancelled On :
                    <asp:Label ID="lblCancelledOn" runat="server" Font-Bold="True"></asp:Label></td>
            ...
            <tr>
                <td>Cancelled By :
                    <asp:Label ID="lblCancelledBy" runat="server" Font-Bold="True"></asp:Label></td>
            </tr>
        </table>
        <br />
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center" width="100%">
                    <input id="btnPrint2" type="button" runat="server" value="Print Seat Acceptance Cancellation Acknowledgement" class="InputButton" onclick="javascript: OpenPopUpWindow()" />
                </td>
            </tr>
        </table>
        <br />
