<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmEditSeatAcceptanceFeeDetails.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmEditSeatAcceptanceFeeDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function checkPaymentMode(sender, args) {
            if (document.getElementById("ctl00_rightContainer_ContentTable2_rbnOnline").checked) {
            }
            else {
                args.IsValid = false;
            }
                        ...
                        <td>
                            <font color="red">
                                <ol class="list-text">
                                    ...
                                    <br />
                                    <li>
                                        <p align="justify"><font color="red">The Seat Acceptance Fee is <b>Rs. 1,000/-</b> for All Candidates.</font></p>
                                    </li>
                                    <li>
                                        <p align="justify"><font color="red">The candidate can pay the seat acceptance fee by Online Mode.</font></p>
                                    </li>
                                    <li>
                                        <p align="justify"><font color="red">The Candidate has to pay the Seat Acceptance Fee during First Reporting only.</font></p>
                                    </li>
                                    <li>
                                        <p align="justify"><font color="red">Failure to report in person for Seat Acceptance will be considered as if the Candidate has Rejected the Offered Seat.</font></p>
                                    </li>
                                </ol>
                            </font>
                            <br />
