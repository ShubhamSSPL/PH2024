<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmResetPassword.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmResetPassword" %>
        ...
        <asp:UpdatePanel runat="server" ID="upResetPassword">
            <ContentTemplate>
                <table class="AppFormTable">
                    <tr>
                        <td style="width: 40%" align="right">Select User Type</td>
                        <td style="width: 60%">
