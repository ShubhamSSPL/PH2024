        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    {
                        Response.Redirect("../ARCModule/frmMessagesNonRepliedRO.aspx");
                    }
                    else
                    {
            ...
            try
            {
                ...
                if (e.CommandName == "Reply")
                {
                    if (RepliedMessage.Length > 0)
                    {
                        ...
                        {
                            shInfo.Visible = true;
                            shInfo.SetMessage("<b>Technical Problem In Saving Data. Please Try After sometime.</b>", ShowMessageType.Information);
                        }
                    }
                    else
                    {
