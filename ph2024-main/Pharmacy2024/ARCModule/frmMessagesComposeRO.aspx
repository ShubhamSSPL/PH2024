<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesComposeRO.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmMessagesComposeRO" %>
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../ARCModule/frmMessagesComposeRO.aspx"><font size="2" color="red"><b>|Compose Message|</b></font></a></td>
                ...
                <table class="AppFormTable" id="tblMessage" runat="server">
                    <tr>
                        ...
                        <td style="width: 85%;">
                            ...
                            &nbsp;&nbsp;
                            <asp:RadioButton ID="rbnARC" runat="server" CssClass="AClass" Text=" ARC" GroupName="Broadcast" AutoPostBack="True" OnCheckedChanged="Broadcast_CheckedChanged" />
                            <br />
