    ...
    public partial class frmMessagesNonRepliedAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    gvMessages.DataSource = reg.getAdminNonRepliedMessages("ARC");
                    gvMessages.DataBind();
        ...
        protected void gvMessages_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            try
            {
                ...
                //Server.Transfer("../ARCModule/frmReplyMessagesAdmin.aspx");
                ...
                Response.Redirect("../ARCModule/frmReplyMessagesAdmin.aspx?From=" + From + "&Sender=" + Sender.Replace("<br />", " "));
            }
            catch (Exception ex)
            {
                Logging.LogException(ex, "[Page Level Error]");
