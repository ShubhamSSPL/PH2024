<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesNonRepliedRO.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmMessagesNonRepliedRO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Non-Replied Messages Sent By ARCs">
