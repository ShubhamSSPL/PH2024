<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesSentRO.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmMessagesSentRO" %>
    ...
    <cc1:ContentBox ID="ContentBox2" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../ARCModule/frmMessagesSentRO.aspx"><font size="2" color="red"><b>|Sent Messages|</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Sent Messages to ARCs" Height="200px" Width="100%" ScrollBars="Auto">
