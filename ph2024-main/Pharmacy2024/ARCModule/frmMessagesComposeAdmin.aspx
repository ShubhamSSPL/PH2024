<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmMessagesComposeAdmin.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmMessagesComposeAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                <td><a href="../ARCModule/frmMessagesNonRepliedAdmin.aspx"><font size="2"><b>|Non Replied Messages|</b></font></a></td>
                <td><a href="../ARCModule/frmMessagesRepliedAdmin.aspx"><font size="2"><b>|Replied Messages|</b></font></a></td>
                <td><a href="../ARCModule/frmMessagesComposeAdmin.aspx"><font size="2" color="red"><b>|Compose Message|</b></font></a></td>
        ...
        <asp:UpdatePanel runat="server" ID="upExamCenter" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                <table class="AppFormTable" id="tblMessage" runat="server">
                    <tr>
                        <td style="width: 25%;" align="right">To</td>
                        <td style="width: 75%;">
                            ...
                            &nbsp;&nbsp;
                            <asp:CheckBox ID="chkBroadcastARC" runat="server" CssClass="AClass" Text=" ALL ARC" AutoPostBack="True" OnCheckedChanged="Broadcast_CheckedChanged" />
                            &nbsp;&nbsp;
                        ...
                        <td>
                            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth="1px" BorderStyle="Solid" CssClass="DataGrid">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="RO/ARC Code" DataField="LoginID">
                                    ...
                                    <asp:BoundField HeaderText="RO/ARC Name" DataField="Name">
