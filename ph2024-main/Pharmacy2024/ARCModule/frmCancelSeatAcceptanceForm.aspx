<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmCancelSeatAcceptanceForm.aspx.cs" Inherits="Pharmacy2024.ARCModule.frmCancelSeatAcceptanceForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Cancel Seat Acceptance Confirmation Status">
        <table class="AppFormTable">
            ...
            <tr>
                ...
                <td align="right">MH Merit Score</td>
                <td>
            ...
            <tr>
                ...
                <td align="right">AI Merit Score</td>
                <td>
        ...
        <%--<table class="AppFormTable" id="tblUploadCancelledCheque" runat="server" visible="false">
            <tr>
                <th style="border-top-width:0px;" align="left" colspan="2">Upload Cancelled Cheque</th>
            </tr>
            <tr>
                <td style="width: 25%" align="right">Upload Cancelled Cheque</td>
                <td style="width: 75%">
                    <asp:FileUpload ID="fileCancelledCheque" runat="server" />
                    <font color = "red"><sup>*</sup></font> (Only .JPG, .JPEG, .PNG Formats Supported)
                    <asp:RequiredFieldValidator ID="rfvCancelledCheque" runat="server" ControlToValidate="fileCancelledCheque" Display="None" ErrorMessage="Please Enter Cancelled Cheque Path."></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="cvCancelledCheque" runat="server" ClientValidationFunction="validateCancelledChequeUpload" Display="None" ErrorMessage="Please Upload Cancelled Cheque Having Extension .jpg, .jpeg or .png." ></asp:CustomValidator>
                </td>
            </tr>
        </table>--%>
        <table class="AppFormTable">
            <tr>
                <th style="border-top-width: 0px;" align="left" colspan="2">Reason for Cancellation</th>
            </tr>
            <tr>
                <td style="width: 25%" align="right">Reason for Cancellation</td>
                <td style="width: 75%">
                    <asp:TextBox ID="txtComments" runat="server" Width="99%" Height="50px" MaxLength="250" TextMode="MultiLine"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvComments" runat="server" ControlToValidate="txtComments" Display="None" ErrorMessage="Please Enter Reason for Cancellation."></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
        <br />
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <asp:Button ID="btnProceed" runat="server" Text="Cancel Seat Acceptance Form" CssClass="InputButton" OnClick="btnProceed_Click" />
