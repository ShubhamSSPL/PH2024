<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPage.Master" AutoEventWireup="true" CodeBehind="Content_Dynamic.aspx.cs" Inherits="CMS_Content_Dynamic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function PrintPage() {
            ...
            var header = '<table  style="border-collapse:collapse;width:100%"><tr><td style="font-size:18px; font-weight:bold; font-family:vardana; border-bottom:1px solid #cecece;">' + document.getElementById("rightContainer_cbxContent_tdllblContentTitle").innerHTML + '</td><td style="font-size:14px; font-weight:normal;text-align:right; font-family:vardana; border-bottom:1px solid #cecece;">' + document.getElementById("rightContainer_cbxContent_lblUpdationDate").innerHTML + '<br/><br/></td></tr></table>';

            var data = table.innerHTML;

            var WinPrint =
                window.open('', '', 'left=0,top=0,width=800%,height=500%,toolbar=0,scrollbars=1,status=0');
            var htmlContent = '<html><head><link href="../SynthesysModules_Files/Style/MainStyle.css" type="text/css" rel="stylesheet" /></head><body>' + header + '<br><br>' + data + '</body> </html>'
    ...
    <ccm:ContentBox ID="cbxContent" HeaderVisible="false" runat="server" HorizontalAlign="Left"
        HeaderText="" Collapsed="true">
