<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPage.Master" AutoEventWireup="true" CodeBehind="frmResetPasswordUsingEMailVerificationStep3.aspx.cs" Inherits="Pharmacy2024.OthersAccountRecoveryModule.frmResetPasswordUsingEMailVerificationStep3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Reset password using a reset link sent via E-Mail">
        <table class = "AppFormTable">
            <tr>
                <th align = "left">DTE just sent a password reset link to your Registered E-Mail ID.</th>
            </tr>
            <tr>
                <td>
                    <br /><br />
