<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPage.Master" AutoEventWireup="true" CodeBehind="frmResetPasswordUsingOTPStep2.aspx.cs" Inherits="Pharmacy2024.OthersAccountRecoveryModule.frmResetPasswordUsingOTPStep2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Reset password using verification code sent via text message (SMS)">
        <table class = "AppFormTable">
            <tr>
                <th align = "left">DTE will sent a verification code via text message (SMS) to following Mobile Number.</th>
            </tr>
            <tr>
