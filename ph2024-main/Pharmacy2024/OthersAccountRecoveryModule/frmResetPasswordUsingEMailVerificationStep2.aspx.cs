    ...
    public partial class frmResetPasswordUsingEMailVerificationStep2 : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        lblEMailID.Text = reg.verifyOthersEMailID(LoginID);
                    }
                }
                catch (Exception ex)
                {
        ...
        protected void btnContinue_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.sendOthersEMailVerificationCodeForResetPassword(LoginID, EMailVerificationCode))
                {
                    this.Context.Items["LoginID"] = LoginID;
                    Server.Transfer("~/OthersAccountRecoveryModule/frmResetPasswordUsingEMailVerificationStep3.aspx");
                }
                else
                {
