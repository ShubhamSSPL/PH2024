<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPage.Master" AutoEventWireup="true" CodeBehind="frmResetPasswordUsingEMailVerificationStep5.aspx.cs" Inherits="Pharmacy2024.OthersAccountRecoveryModule.frmResetPasswordUsingEMailVerificationStep5" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Reset Your Password">
        ...
        <table class="AppFormTable">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" MaxLength = "13" onmouseover="ddrivetip('Please Enter Confirm New Password.')" onmouseout="hideddrivetip()" onKeyDown="return DisableCopyPaste(event)" onMouseDown="return DisableCopyPaste(event)"></asp:TextBox>
                    <font color = "red"><sup>*</sup></font>
