<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPage.Master" AutoEventWireup="true" CodeBehind="frmResetPasswordUsingSecurityQuestionStep1.aspx.cs" Inherits="Pharmacy2024.OthersAccountRecoveryModule.frmResetPasswordUsingSecurityQuestionStep1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Reset password using Security Question & its Answer">
        <table class="AppFormTable">
            ...
            <tr>
                <td style="width: 40%" align="right">Login ID</td>
                <td style="width: 60%">
                    <asp:TextBox ID="txtLoginID" runat="server" MaxLength="10" onmouseover="ddrivetip('Please Enter Login ID.')" onmouseout="hideddrivetip()"></asp:TextBox>
