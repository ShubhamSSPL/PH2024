<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/StaticMasterPage.Master" AutoEventWireup="true" CodeBehind="frmResetPasswordUsingSecurityQuestionStep2.aspx.cs" Inherits="Pharmacy2024.OthersAccountRecoveryModule.frmResetPasswordUsingSecurityQuestionStep2" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Reset Your Password">
        ...
        <table class="AppFormTable">
            <tr>
                ...
                <td style="width: 60%;">
                    <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" MaxLength = "13" onKeyDown="return DisableCopyPaste(event)" onMouseDown="return DisableCopyPaste(event)" onmouseover="ddrivetip('Please Enter New Password. It must be 8 to 13 character long and must have at least one Upper case alphabet, one Lower case alphabet, one numeric value and one special character.')" onmouseout="hideddrivetip()"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtConfirmPassword" runat="server" TextMode="Password" MaxLength = "13" onKeyDown="return DisableCopyPaste(event)" onMouseDown="return DisableCopyPaste(event)" onmouseover="ddrivetip('Please Enter Confirm New Password.')" onmouseout="hideddrivetip()"></asp:TextBox>
                    <font color = "red"><sup>*</sup></font>
