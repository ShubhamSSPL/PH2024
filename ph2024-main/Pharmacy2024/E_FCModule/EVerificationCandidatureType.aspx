<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EVerificationCandidatureType.aspx.cs" Inherits="Pharmacy2024.E_FCModule.EVerificationCandidatureType" %>
                    ...
                    <td style="vertical-align: top;">
                        <div class="row w-100 mx-auto">
                            <div class="col-sm-6 mb-3">
                                <table class="AppFormTable">
                                    <tr>
                                        <th align="left" colspan="4">Candidature Type Details</th>

                                    </tr>
                                    <tr>
                                        <td style="width: 25%;" align="right">Candidature Type</td>
                                        <td style="width: 15%;" colspan="3">
                                            <asp:Label ID="lblCandidatureType" runat="server" Width="250px" Font-Bold = "true"></asp:Label><br />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
	                                    <td align="right" colspan="2">Home University</td>
		                                <td colspan="2""><asp:Label id="lblHomeUniversity" runat="server" Font-Bold = "true"></asp:Label></td>
                                    </tr>
                                    
                                    <tr id="trHSCTaluka" runat="server">
                                        <td align="right" colspan="2"> <asp:Label ID="lblQ3" runat="server"></asp:Label></td>
                                        <td colspan="2">
                                            <asp:Label ID="lblHSCTaluka" runat="server" Font-Bold = "true"></asp:Label><br />
                                        </td>
                                    </tr>
                                    <tr id="trHSCVillage" runat="server">
                                        <td align="right" colspan="2"> <asp:Label ID="lblQ4" runat="server"></asp:Label></td>
                                        <td colspan="2">
                                            <asp:Label ID="lblHSCVillage" runat="server" Font-Bold = "true"></asp:Label><br />
                                        </td>
                                    </tr>
                                </table>
                            </div>
