<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EVerificationNEETDetails.aspx.cs" Inherits="Pharmacy2024.E_FCModule.EVerificationNEETDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="NEET / CET Details">
                    ...
                    <td style="vertical-align: top;">
                        <div class="row w-100 mx-auto">
                            <div class="col-sm-6 mb-3">
                                <table class="AppFormTable" id="tblJEE" runat="server">
                                    <tr>
                                        <th align="left" colspan="4">NEET / CET Details</th>
                                    ...
                                    <tr id="trNEETScore1" runat="server">
                                        ...
                                        <td align="right">Chemistry Percentile</td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        function OpenViewDocumentPopUp(cntrl) {
            ...
            //corrRow.cells[corrRow.cells.length - 5].innerText
            if (IsBarcodeFetch == "Y") {
                var dsResponse = Pharmacy2024.E_FCModule.EVerificationNEETDetails.GetDocumentFetchData(personalID, documentID);
