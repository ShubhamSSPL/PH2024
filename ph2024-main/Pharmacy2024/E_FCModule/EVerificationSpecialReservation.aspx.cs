...
{
    public partial class EVerificationSpecialReservation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(EVerificationSpecialReservation));
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    lblTFWS.Text = obj.FinalAppliedForTFWS;
                    lblIsOrphan.Text = obj.FinalIsOrphan;
                    lblOrphanRegistrationNo.Text = obj.OrphanRegistrationNo;
                    lblOrphanHasRelative.Text = obj.OrphanHasRelative;
                    if (obj.FinalIsOrphan == "No")
                    {
                    ...
                    if (obj.FinalLinguisticMinorityDetails != "Not Applicable" || obj.FinalReligiousMinorityDetails != "Not Applicable")
                        lblAppliedForMinoritySeats.Text = "Yes";
                    else
                        lblAppliedForMinoritySeats.Text = "No";
                    lblLinguisticMinority.Text = obj.FinalLinguisticMinorityDetails;
                    lblMotherTongue.Text = obj.MotherTongue;
                    lblReligiousMinority.Text = obj.FinalReligiousMinorityDetails;
                    lblReligion.Text = obj.Religion;
                    //if (CourseAppliedFor == "HMCT" || CourseAppliedFor == "SCT")
                    //{
                    //lblPWDHeader.Text = "PWD, Defence and TFWS Details";
                    trAppliedForTFWS1.Visible = true;
                    trAppliedForTFWS2.Visible = true;
                    //}
                    //else
                    //{
                    //    lblPWDHeader.Text = "PWD and Defence Details";
                    //    trAppliedForTFWS1.Visible = false;
                    //    trAppliedForTFWS2.Visible = false;
