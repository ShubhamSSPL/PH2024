...
{
    public partial class EVerificationScannedImages : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    // imgSignature.ImageUrl = "../CandidateModule/frmGetScannedImages.aspx?PID=" + PID.ToString() + "&ImageType=Signature";
                }
                catch (Exception ex)
                {
        ...
        //        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        //        {
        //            if (i == CurrentDocID + 1 && i != ds.Tables[0].Rows.Count)
        //            {
        //                string docpath = ds.Tables[0].Rows[i]["FilePath"].ToString();
        //                string docName = ds.Tables[0].Rows[i]["DocumentName"].ToString();
        //                string docfun = "LoadDocument('" + docpath + "','" + docName + "');";
        ...
        //                ViewState["CurrentDocID"] = CurrentDocID;
        //            }
