...
{
    public partial class frmNEETConfirmedCandidateList : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    //{
                        ...
                        AFCID = 99;//Convert.ToInt32(Session["UserID"].ToString());
                    //}

                    gvCandidateList.DataSource = reg.GetNEETConfiredCandidateList(RegionID, InstituteID, AFCID, ConfirmationDate);
        ...
        protected void ddlDate_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                gvCandidateList.DataSource = reg.GetEFCConfiredCandidateList(RegionID, InstituteID, AFCID, ConfirmationDate);
                gvCandidateList.DataBind();
