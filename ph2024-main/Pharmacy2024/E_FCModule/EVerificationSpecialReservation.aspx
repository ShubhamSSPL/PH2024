<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EVerificationSpecialReservation.aspx.cs" Inherits="Pharmacy2024.E_FCModule.EVerificationSpecialReservation" %>
                ...
                <td style="vertical-align: top;">
                    <div class="row w-100 mx-auto">
                        <div class="col-sm-6 mb-3">
                            <table class="AppFormTable">
                                <tr>
                                    <th align="left" colspan="2">Special Reservation </th>

                                </tr>
                                <tr>
                                    <td style="width: 25%;" align="right">Person with Disability</td>
                                    <td style="width: 15%;">
                                        <asp:Label ID="lblPHType" runat="Server"></asp:Label></td>
                                </tr>
                                <tr>
                                    <td align="right">Defence Type</td>
                                    <td>
                                        <asp:Label ID="lblDefenceType" runat="Server"></asp:Label></td>
                                </tr>
                                <tr id="trAppliedForTFWS1" runat="server" visible="false">
                                    <td align="right">Annual Family Income</td>
                                    <td>
                                        <asp:Label ID="lblAnnualFamilyIncome" runat="server" Font-Bold="true"></asp:Label></td>
                                </tr>
                                <tr id="trAppliedForTFWS2" runat="server" visible="false">
                                    <td align="right">Applied for TFWS (Tuition Fee Waiver Scheme)</td>
                                    <td>
                                        <asp:Label ID="lblTFWS" runat="Server"></asp:Label>
                                        <%-- <asp:Label ID="lblAppliedForTFWS" runat="server" ForeColor="red" Font-Bold="true" Visible="false">You are Not Eligible for TFWS Seats because Your Parents having Annual Income Above 8 Lacs.</asp:Label>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <th colspan="2" align="left">Orphan Details</th>
                                </tr>
                                <tr>
                                    <td align="right">Orphan </td>
                                    <td>
                                        <asp:Label ID="lblIsOrphan" runat="Server"></asp:Label></td>

                                </tr>
                                <tr id="trOrphan1" runat="server" visible="false">
                                    <td align="right">Orphan Registration No</td>
                                    <td>
                                        <asp:Label ID="lblOrphanRegistrationNo" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr id="trOrphan2" runat="server" visible="false">
                                    <td aligln="right">Any Relative ?</td>
                                    <td>
                                        <asp:Label ID="lblOrphanHasRelative" runat="Server"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr id="trMinority" runat="server">
                                    ...
                                    <td>
                                        <asp:Label ID="lblAppliedForMinoritySeats" runat="Server"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr id="trLinguisticMinority" runat="server">
                                    ...
                                    <td>
                                        <asp:Label ID="lblLinguisticMinority" runat="server"></asp:Label>
                                        <asp:Label ID="lblLinguisticMinorityMsg" runat="server" ForeColor="red" Font-Bold="true" Visible="false">You are Not Eligible for Linguistic Minority because Your Mother Tongue is Marathi. </asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr id="trReligiousMinority" runat="server">
                                    ...
                                    <td>
                                        <asp:Label ID="lblReligiousMinority" runat="server"></asp:Label>
                                        <asp:Label ID="lblReligiousMinorityMsg" runat="server" ForeColor="red" Font-Bold="true" Visible="false">You are Not Eligible for Religious Minority because Your Religion is Hindu.</asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
