...
{
    public partial class frmAFCWiseApplicationFormListForFCVerificationReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    gvAFCWiseReport.DataSource = reg.getAFCWiseApplicationFormListForFCVerification(RegionID);
                    ...
                    hpr.NavigateUrl = "PendingApplicatonVerification.aspx?RegionID=" + RegionID.ToString() + "&InstituteID=99";
                    hpr.Text = "<b>Total</b>";
