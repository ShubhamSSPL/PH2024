<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="PendingApplicatonVerification.aspx.cs" Inherits="Pharmacy2024.E_FCModule.PendingApplicatonVerification" %>

<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Candidate List For Application Form E-Verification Confirmation Pending">
        ...
        <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="DataGrid table-responsive" OnRowCommand="gvReport_RowCommand">
            <Columns>
                ...
                <asp:BoundField DataField = "ModifyOn" HeaderText = "Submitted Date Time">
