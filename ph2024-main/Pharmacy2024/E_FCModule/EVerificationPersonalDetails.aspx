<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EVerificationPersonalDetails.aspx.cs" Inherits="Pharmacy2024.E_FCModule.EVerificationPersonalDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
                    ...
                    <td style="vertical-align: top;">
                        <div class="row w-100 mx-auto">
                            <div class="col-sm-6  ">
                                <table class="AppFormTable">
                                    <tr>
                                        <th align="left" colspan="2">Personal Details</th>


                                    </tr>
                                    <tr style="background-color: #7febd7;">
                                        <td style="width: 25%;" align="right">Candidate's Name</td>
                                        <td style="width: 15%;">
                                            <asp:Label ID="lblCandidateName" runat="server" Width="250px"></asp:Label><br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblFatherName" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="background-color: #7febd7;">
                                        <td align="right">Mother's Name</td>
                                        <td>
                                            <asp:Label ID="lblMotherName" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="background-color: #7febd7;">
                                        <td align="right">Gender</td>
                                        <td>
                                            <asp:Label ID="lblGender" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="background-color: #7febd7;">
                                        <td align="right">DOB (DD/MM/YYYY)</td>
                                        <td>
                                            <asp:Label ID="lblDOB" runat="server" Width="70%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">Religion</td>
                                        <td>
                                            <asp:Label ID="lblReligion" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">Region</td>
                                        <td>
                                            <asp:Label ID="lblRegion" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">Mother Tongue</td>
                                        <td>
                                            <asp:Label ID="lblMotherTongue" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">Annual Family Income</td>
                                        <td>
                                            <asp:Label ID="lblAnnualFamilyIncome" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="background-color: #7febd7;">
                                        <td align="right">Nationality</td>
                                        <td>
                                            <asp:Label ID="lblNationality" runat="server" Width="90%"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function OpenViewDocumentPopUp(cntrl) {
            ...
            //corrRow.cells[corrRow.cells.length - 5].innerText
            if (IsBarcodeFetch == "Y") {
                var dsResponse = Pharmacy2024.E_FCModule.EVerificationPersonalDetails.GetDocumentFetchData(personalID, documentID);
     ...
     <%--       document.getElementById('<%=lblLoadDocumentName.ClientID %>').innerHTML = DocumentName;--%>
        ...
        function HideMarkDiscripencyDoc(filePath, DocumentName) {
            ...
            switch (extension) {
                ...
                case 'jpeg':
                case 'bmp':
                    document.getElementById('<%=divLoadDocument.ClientID %>').innerHTML = '<img style="width:100%;height:450px;" src="' + filePath + '">';
                    break;
                case 'zip':
                case 'rar':
                    document.getElementById('<%=divLoadDocument.ClientID %>').innerHTML = '<iframe src="' + filePath + '" autostart="true" style="width:100%;height:450px;">';
                    break;
                case 'pdf':
                    document.getElementById('<%=divLoadDocument.ClientID %>').innerHTML = '<embed src="' + filePath + '#toolbar=0" autostart="true" style="width:100%;height:450px;">';
        ...
        function MarkDiscripency() {
            ...
            //            td[3].children[2].enabled = false;
            //            td[3].children[2].style.visibility = "hidden";
            //            //$("input[type=text]", td)[0].value = "";
            //            $("input[type=text]", td).attr("disabled", "disabled");
            //            $('#lblmessage').hide();
            //        }
            //        //else {
            //        //    var td = $("td", $(this).closest("tr"));
            //        //    td[4].children[2].style.visibility = "hidden";
            //        //    $("input[type=text]", td)[0].value = "";
            //        //    td[4].children[2].enabled = false;
            //        //    $("input[type=text]", td).attr("disabled", "disabled");
            //        //}

            //    });
            //    $("[id*=rbnYes]").bind("click", function () {
            ...
            //        //    // $("#rfvtxtDiscrepancyRemark", td).removeAttr("disabled");
            //        //    td[4].children[2].enabled = true;
