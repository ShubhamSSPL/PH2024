...
{
    public partial class frmSubAFCCandidateConfirmedReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    gvSubAFCWiseReport.DataSource = reg.GetSubAFCEConfirmedCount(RegionID, InstituteID);
