...
{
    public partial class EVerificationQualificationDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(EVerificationQualificationDetails));
        ...
        //        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        //        {
        //            if (i == CurrentDocID && ds.Tables[0].Rows[i]["FilePath"].ToString() != "" && ds.Tables[0].Rows.Count > CurrentDocID)
        //            {
        //                string docpath = ds.Tables[0].Rows[i]["FilePath"].ToString();
        //                string docName = ds.Tables[0].Rows[i]["DocumentName"].ToString();
        //                string docfun = "LoadDocument('" + docpath + "','" + docName + "');";
        ...
        //{
        //    int CurrentDocID = Convert.ToInt32(ViewState["CurrentDocID"]);
        //    DataSet ds = reg.GetDocumentListForDataVerificationByStepID(Convert.ToInt64(ViewState["PID"]), Convert.ToInt32(ViewState["ApplicationFormStepID"]));
        //    if (ds.Tables[0].Rows.Count > 0)
        //    {
        //        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        //        {
        //            if (i == CurrentDocID - 1 && ds.Tables[0].Rows[i]["FilePath"].ToString() != "" && CurrentDocID != 0)
        //            {
        //                string docpath = ds.Tables[0].Rows[i]["FilePath"].ToString();
        //                string docName = ds.Tables[0].Rows[i]["DocumentName"].ToString();
        //                string docfun = "LoadDocument('" + docpath + "','" + docName + "');";
        //                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", docfun, true);
        //                ViewState["CurrentDocID"] = CurrentDocID - 1;


        //                if (Convert.ToInt16(ViewState["CurrentDocID"]) == 0)
        //                {
