<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmSubAFCCandidateConfirmedReport.aspx.cs" Inherits="Pharmacy2024.E_FCModule.frmSubAFCCandidateConfirmedReport" %>

<%@ Register Assembly="Synthesys.Controls.ContentBox" Namespace="Synthesys.Controls" TagPrefix="cc1" %> 

<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" Runat="Server">
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText = "Sub-SC Wise E-SC Verified / Confirmed Report">
        <asp:GridView ID="gvSubAFCWiseReport"  ShowFooter = "true" runat="server" AutoGenerateColumns="False" Width="100%" CssClass = "DataGrid">
            <Columns> 
                ...
                <asp:BoundField DataField = "TotalDiscrepancyMarked" HeaderText = "Total Application<br />Forms Confirmed" HtmlEncode = "false">
