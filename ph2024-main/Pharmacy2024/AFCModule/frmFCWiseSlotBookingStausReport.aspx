<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmFCWiseSlotBookingStausReport.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmFCWiseSlotBookingStausReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="server">
    ...
    <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="true" Width="100%" CssClass="DataGrid" RowStyle-HorizontalAlign="Center">
        <%--<Columns>
