<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPage.Master" AutoEventWireup="true" CodeBehind="frmMessagesRepliedRO.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesRepliedRO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../AFCModule/frmMessagesRepliedRO.aspx"><font size="2" color="red"><b>| Replied Messages |</b></font></a></td>
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Replied Messages Sent By SCs" Width="100%" Height="100%" ScrollBars="Auto">
