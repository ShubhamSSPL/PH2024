    ...
    public partial class frmUploadRequiredDocuments : System.Web.UI.Page
    {
        ...
        protected void btnSaveUpload_Click(object sender, EventArgs e)
        {
            ...
            if (flUpload.HasFile)
            {
                ...
                string fileurl = azureDocumentUpload.UploadDocument(ConfigurationManager.AppSettings["BlobContainerName"].ToLower(), sysfilename.ToLower(), objFileStream, flUpload.PostedFile.FileName, "studentdocuments");
                ...
                if (fileurl != "")
                {
                    ...
                    uploadedFileURL = fileurl.ToLower(); originalFileName = flUpload.PostedFile.FileName;
