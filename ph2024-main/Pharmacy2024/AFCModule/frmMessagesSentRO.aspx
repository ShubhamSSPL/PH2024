<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPage.Master" AutoEventWireup="true" CodeBehind="frmMessagesSentRO.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesSentRO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox2" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                <td><a href="../AFCModule/frmMessagesNonRepliedRO.aspx"><font size="2"><b>| Non Replied Messages |</b></font></a></td>
                <td><a href="../AFCModule/frmMessagesRepliedRO.aspx"><font size="2"><b>| Replied Messages |</b></font></a></td>
                <td><a href="../AFCModule/frmMessagesComposeRO.aspx"><font size="2"><b>| Compose Message |</b></font></a></td>
                <td><a href="../AFCModule/frmMessagesSentRO.aspx"><font size="2" color="red"><b>| Sent Messages |</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Sent Messages to SCs" Height="200px" Width="100%" ScrollBars="Auto">
