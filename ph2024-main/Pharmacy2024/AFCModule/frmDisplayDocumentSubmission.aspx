<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmDisplayDocumentSubmission.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmDisplayDocumentSubmission" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Confirmation of Document Verification">
        ...
        <table class="AppFormTable">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtComments" runat="server" Width="100%" Height="50px" MaxLength="250" TextMode="MultiLine"></asp:TextBox>
                    <font color="red"><sup>*</sup></font></td>
                    <asp:RequiredFieldValidator ID="rfvtxtComments" runat="server" Display="None" ErrorMessage="Please Enter Comment" ControlToValidate="txtComments"></asp:RequiredFieldValidator>
            </tr>
            <tr>
