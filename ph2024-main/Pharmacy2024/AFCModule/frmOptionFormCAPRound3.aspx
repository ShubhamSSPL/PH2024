<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmOptionFormCAPRound3.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmOptionFormCAPRound3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function OpenPopUpWindow() {
            window.open("frmPrintOptionFormCAPRound3.aspx?PID=<% = PID %>", "Password", "width=1000px,height=500px,resizable=yes,scrollbars=yes");
        }
    </script>
            ...
            <tr>
                ...
                <td style="width: 90%; border-left-width: 0px;" align="center">
                    <b>
                        ...
                        <br />
                        <br />
                        <font size="2"><b>Receipt-cum-Acknowledgement of Option Form for CAP Round - III for Admission to First Year of Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D for the Academic Year <%= AdmissionYear %></b></font>
                    </b>
                </td>
            </tr>
        </table>
        ...
        <table class="AppFormTable">
            ...
            <tr>
                <td colspan="2">
                    <p align="justify">
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        The Option Form for CAP Round - III for Admission to First Year of Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D for the Academic Year <%= AdmissionYear %> is confirmed as per the choices given above. We hereby acknowledge the confirmed Option Form.
                    </p>
                </td>
            </tr>
            <tr>
