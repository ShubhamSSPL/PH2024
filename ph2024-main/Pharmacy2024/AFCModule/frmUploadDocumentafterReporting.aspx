<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmUploadDocumentafterReporting.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmUploadDocumentafterReporting" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="server">
                ...
                if (data.length > 10) {
                    ...
                    if (documentID == "21") {
                        ...
                        if (hidJUD == "0") {
                            ...
                            var message = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.UploadDoc(data, documentID, hidJUD, hidDID, hidTID, fileName, fileExt, checkBarcode, barcode, '<%= Request["PID"] %>');
    ...
    <ccm:ContentBox ID="contentAppleSarkarBarti" runat="server" BoxType="ContentBox" Width="80%" Height="500px" Style="display: none;" HeaderText="Upload Document">
        ...
        <script>
            function viewUploadDocumentDiv(e) {
                e.preventDefault();
                if (Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.InsertUpdateDocumentFetchData(document.getElementById('<%=hidResponse.ClientID %>').value, $("#<%=hdnCurrentDocId.ClientID %>").get(0).value)) {
                    document.getElementById('<%=divup.ClientID %>').style.display = "block";
            ...
            function ValidateBarcode(e) {
                ...
                if (document.getElementById('<%=txtbarcode.ClientID %>').value > 0) {
                    ...
                    var dsResponse = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.FetchDocument(docID, document.getElementById('<%=txtbarcode.ClientID %>').value);
    ...
    <script type="text/javascript">
        ...
        function getDistrict(JurisdictionID) {
            ...
            var categoryID = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.getCategoryID('<%= Request["PID"] %>');
            ...
            var dsDistrict = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.getDistrictForJuridiction(JurisdictionID);
        ...
        function getTaluka(DistrictID) {
            ...
            opt.value = "0";
            if (DistrictID != 0) {
                var dsTaluka = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.getTalukaForDistrict(DistrictID);
        ...
        function OpenViewDocumentPopUp(cntrl) {
            ...
            if (IsBarcodeFetch == "Y") {
                var dsResponse = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.GetDocumentFetchData(personalID, documentID);
        ...
        function LoadDistrictTalukaJuridicaiton(documentId) {
            if (documentId == "21" || documentId == "22") {
                ...
                var ds = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.FillJuridiction(documentId, '<%= Request["PID"] %>');
                var categoryID = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.getCategoryID();
    ...
    <script type="text/javascript" lang="javascript">
        Pharmacy2024.AFCModule.frmUploadDocumentafterReporting
            ...
            if (files.length > 0) {
                ...
                if (documentID == "21") {
                    ...
                    if (hidJUD == "0") {
                        ...
                        var message = Pharmacy2024.AFCModule.frmUploadDocumentafterReporting.UploadDoc(files, documentID, hidJUD, hidDID, hidTID, '<%= Request["PID"] %>');
                        if (message.value == "The File has been uploaded.") {
                            $('#<%=btnUploadComplete.ClientID %>').show();
                            $('#<%=btnUploadComplete.ClientID %>').click();
                        }
