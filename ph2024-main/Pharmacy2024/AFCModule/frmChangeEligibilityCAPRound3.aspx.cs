...
{
    public partial class frmChangeEligibilityCAPRound3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (reg.isCandidateEligibleCAPRound3(PID))
                    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.changeCandidateEligibilityCAPRound3(PID, EligibilityStatus, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
