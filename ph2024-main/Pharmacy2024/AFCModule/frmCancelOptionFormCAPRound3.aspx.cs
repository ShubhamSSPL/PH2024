...
{
    public partial class frmCancelOptionFormCAPRound3 : System.Web.UI.Page
    {
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.cancelOptionFormCAPRound3(PID, txtReasonForCancellation.Text, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
