...
{
    public partial class frmCancelOptionFormCAPRound4 : System.Web.UI.Page
    {
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.cancelOptionFormCAPRound4(PID, txtReasonForCancellation.Text, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
