...
{
    public partial class frmChangeEligibilityCAPRound1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (reg.isCandidateEligibleCAPRound1(PID))
                    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.changeCandidateEligibilityCAPRound1(PID, EligibilityStatus, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
