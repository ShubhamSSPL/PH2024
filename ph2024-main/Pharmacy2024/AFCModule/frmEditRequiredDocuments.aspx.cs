...
{
    public partial class frmEditRequiredDocuments : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (reg.IsEditApplicationFormConfirmedUsingThisHSCSeatNo(PID))
                    {
        ...
        protected void gvDocuments_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Int32 DocumentID = Convert.ToInt32(((Label)e.Row.Cells[4].FindControl("lblDocumentID")).Text);
                string IsSubmitted = ((Label)e.Row.Cells[4].FindControl("lblIsSubmitted")).Text;
                string IsCompulsory = ((Label)e.Row.Cells[7].FindControl("lblIsCompulsory")).Text;
                ...
                if (IsCompulsory == "Y" && IsSubmitted == "Y")
                {
                    ((RadioButton)e.Row.Cells[2].FindControl("rbnYes")).Enabled = false;
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Response.Redirect("../AFCModule/frmEditDisplayDocumentSubmission.aspx?PID=" + PID + "&Code=" + PID.ToString().GetHashCode(), true);
                }
                else
                {
                    shInfo.SetMessage("There is some problem in Data Saving. Please try again.", ShowMessageType.Information);
