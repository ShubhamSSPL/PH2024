<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmGetAFCProfile.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmGetAFCProfile" %>
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Get Profile">
        ...
        <asp:UpdatePanel runat="server" ID="upResetPassword">
            <ContentTemplate>
                ...
                <table id="tblAFCProfile" runat="server" class="AppFormTable" visible="false">
                    <tr>
                        <th style="border-top-width: 0px" colspan="4" align="left">SC Details</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblAFCAddress" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 25%;" align="right">SC Phone No.</td>
                        <td style="width: 25%;">
                            <asp:Label ID="lblAFCPhoneNo" runat="server"></asp:Label></td>
                        <td style="width: 25%;" align="right">SC Fax No.</td>
                        <td style="width: 25%;">
                            <asp:Label ID="lblAFCFaxNo" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan = "2"><asp:Label ID="lblSecurityQuestion" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td colspan = "2" align="right">Security Answer</td>
                        <td colspan = "2"><asp:Label ID="lblSecurityAnswer" runat="server"></asp:Label></td>
                    </tr>--%>
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>
