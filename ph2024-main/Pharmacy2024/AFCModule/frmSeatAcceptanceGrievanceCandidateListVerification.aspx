<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceGrievanceCandidateListVerification.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmSeatAcceptanceGrievanceCandidateListVerification" %>
        ...
        <div class="col-xl-12">
            <div class="card mb-4">
                <div class="card-header card-Status">
                    ...
                    Seat Acceptance Grievance Pending List for Verification
                </div>
                            ...
                            <div class="card mb-4">
                                <asp:GridView ID="gvCandidateList" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="gvCandidateList_RowCommand" OnPreRender="gvCandidateList_PreRender" CssClass="table table-striped DataGridForBootstrap">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ConfirmedDateTime" HeaderText="Request Sent On">
