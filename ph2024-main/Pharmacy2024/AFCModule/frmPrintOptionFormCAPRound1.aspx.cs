...
{
    public partial class frmPrintOptionFormCAPRound1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsPersonalInformation = reg.getPersonalInformationCAPRound1(PID);
                    ...
                    DataSet dsPreferancedOptionsList = reg.getPreferancedOptionsListForDisplayCAPRound1(PID);
                    ...
                    DataSet dsInstructions = reg.getInstructionsCAPRound1(PID);
                    ...
                    DataSet dsOptionFormConfirmationDetails = reg.getOptionFormConfirmationDetailsCAPRound1(PID);
