...
{
    public partial class frmChangeEligibilityCAPRound2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (reg.isCandidateEligibleCAPRound2(PID))
                    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.changeCandidateEligibilityCAPRound2(PID, EligibilityStatus, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
