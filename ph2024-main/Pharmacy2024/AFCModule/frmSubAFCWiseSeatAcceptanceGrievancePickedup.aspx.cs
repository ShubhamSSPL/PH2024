...
{
    public partial class frmSubAFCWiseSeatAcceptanceGrievancePickedup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet ds = reg.GetSubAFCWiseSeatAcceptanceGrievancePickedupCount(RegionID, InstituteID, Global.CAPRound);
                    if (UserTypeID == 21)
                    {
