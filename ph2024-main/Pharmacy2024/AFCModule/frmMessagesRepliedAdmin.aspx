<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" CodeBehind="frmMessagesRepliedAdmin.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesRepliedAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" Runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class = "AppFormTableWithOutBorder">
            <tr align = "center">
                ...
                <td><a href="../AFCModule/frmMessagesRepliedAdmin.aspx"><font size = "2" color = "red"><b>| Replied Messages |</b></font></a></td>
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Replied Messages">
        ...
        <asp:UpdatePanel runat="server" ID="upMessages">
            <ContentTemplate>
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth = "1px" BorderStyle = "Solid" OnLoad="gvMessages_Load" OnRowDataBound="gvMessages_RowDataBound" CssClass="DataGrid" OnRowCommand="gvMessages_RowCommand">
            <Columns>
                <asp:BoundField DataField="" HeaderText="Sr. No.">
                    <ItemStyle Width="6%" HorizontalAlign="Center" Font-Size="9px" CssClass="Item" />
                ...
                <asp:TemplateField ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        ...
                        <%--<asp:ImageButton ID="btnUnStar" Text="Reply" runat="server" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" CommandName="Unstar" ToolTip="Remove Star" 
                            Visible='<%# Eval("IsStarMarked") %>' ImageUrl="~/Images/Star_Empty.png" />--%>
                        <%--<asp:Label ID="lblReplyCountDisplay" runat="server" Text='<%# Bind("ReplyCount") %>' />--%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="Subject" HeaderText="Subject">
                    <ItemStyle Width="10%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
                <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode = "false">
                    <ItemStyle Width="23%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item"/>
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="RepliedMessage" HeaderText="Reply">
                    <ItemStyle Width="22%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item"/>
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="RepliedBy" HeaderText="Replied By">
                    <ItemStyle Width="5%" HorizontalAlign="Center" Font-Size="9px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
