...
{
    public partial class frmSeatAcceptanceGrievanceCandidateListPickedup : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    gvCandidateList.DataSource = reg.GetSeatAcceptancePickedupGrievanceList(RegionID, InstituteID, AFCID, Global.CAPRound);
