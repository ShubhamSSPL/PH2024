<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" AutoEventWireup="true" CodeBehind="frmReplyGrievance.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmReplyGrievance" %>
        ...
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="DataGrid" OnRowCommand="gvMessages_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText = "Reply Message">
                    ...
                    <ItemStyle Width="35%" HorizontalAlign="Center" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:TemplateField>
