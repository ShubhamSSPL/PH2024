...
{
    public partial class frmConfirmedChoiceCodeListCAPRound1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    gvPreferencedOptionsList.DataSource = reg.getPreferancedOptionsListCAPRound1(PID);
