<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceGrievanceCandidateListApproved.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmSeatAcceptanceGrievanceCandidateListApproved" %>
        ...
        <div class="col-xl-12">
            <div class="card mb-4">
                <div class="card-header card-Status">
                  ...
                  Seat Acceptance Grievance Approved List
                </div>
                            ...
                            <div class="card mb-4">
                                <asp:GridView ID="gvCandidateList" runat="server" AutoGenerateColumns="False" Width="100%"   OnPreRender="gvCandidateList_PreRender" CssClass="table table-striped DataGridForBootstrap">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ModifiedDateTime" HeaderText="Approved Date Time">
                                            <ItemStyle HorizontalAlign="Center" Width="25%" CssClass="Item" Wrap="false" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="Header" Wrap="false" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ModifiedBy" HeaderText="Approved By">
                                            <ItemStyle HorizontalAlign="Center" Width="10%" CssClass="Item" Wrap="false" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="Header" Wrap="false" />
                                        </asp:BoundField>     
