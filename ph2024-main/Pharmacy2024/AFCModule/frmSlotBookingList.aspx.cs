...
{
    public partial class frmSlotBookingList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ddlDate.DataSource = reg.GetSlotDates("");
                    ...
                    gvCandidateList.DataSource = reg.GetFCWiseSlotBookingList(RegionID, InstituteID, AFCID, ConfirmationDate);
                    ...
                    for (Int32 i = 0; i < gvCandidateList.Rows.Count; i++)
                    {
                        ...
                        gvCandidateList.Rows[i].Cells[4].Text = dt.ToString("dd/MM/yyyy");
                    }
