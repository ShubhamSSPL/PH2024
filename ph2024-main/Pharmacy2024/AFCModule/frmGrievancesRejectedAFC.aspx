<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" CodeBehind="frmGrievancesRejectedAFC.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmGrievancesRejectedAFC" %>
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class = "AppFormTableWithOutBorder">
            <tr align = "center">
                ...
                <td><a href="../AFCModule/frmGrievancesRejectedAFC.aspx"><font size = "2" color = "red"><b>| Rejected Grievances |</b></font></a></td> 
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Rejected Grievances">
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth = "1px" BorderStyle = "Solid" CssClass="DataGrid">
            <Columns>
                ...
                <asp:BoundField DataField="ApprovedRemark" HeaderText="Reject Remark">
                    <ItemStyle Width="22%" HorizontalAlign="Left" Font-Size="12px" CssClass="Item"/>
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
                <asp:BoundField DataField="ApprovedDatetime" HeaderText="Reject Time">
                    <ItemStyle Width="12%" HorizontalAlign="Center" Font-Size="12px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header"  />
                </asp:BoundField>
                <asp:BoundField DataField="ApprovedBy" HeaderText="Rejected By">
        ...
        <table runat = "server" id = "tblMsg" visible="false" class = "AppFormTable">
            <tr>
                <th height = "100" align="center" valign = "middle">
                    <asp:Label ID="lbl_frmSentMessages_Messages" runat="server" Text="There is no Grievance in your Rejected Grievances" Font-Bold="True" Font-Size="Small"></asp:Label>
                </th>
            </tr>
        </table>
    </cc1:ContentBox>
