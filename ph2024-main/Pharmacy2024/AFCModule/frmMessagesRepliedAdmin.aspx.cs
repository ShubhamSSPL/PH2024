    ...
    public partial class frmMessagesRepliedAdmin : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataRow[] result = ds.Tables[0].Select("Sender LIKE '%" + txtSearch.Text + "%' or Message LIKE '%" + txtSearch.Text + "%' or RepliedMessage LIKE '%" + txtSearch.Text + "%'", "SentDateTime DESC");
            ...
            try
            {
                ...
                if (e.CommandName == "Star")
                {
                    if (reg.updateStarMessageStatus(MessageID))
                    {
                        ...
                        //shInfo.SetMessage("Message Stared Successfully.", ShowMessageType.Information);
                    }
                    else
                    {
