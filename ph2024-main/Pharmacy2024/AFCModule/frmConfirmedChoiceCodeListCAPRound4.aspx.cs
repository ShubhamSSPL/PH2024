...
{
    public partial class frmConfirmedChoiceCodeListCAPRound4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    gvPreferencedOptionsList.DataSource = reg.getPreferancedOptionsListCAPRound4(PID);
