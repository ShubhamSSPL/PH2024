<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPage.Master" AutoEventWireup="true" CodeBehind="frmMessagesComposeRO.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesComposeRO" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ClickOnChk(temp) {
            ...
            for (var i = 1; i < grid.rows.length; i++) {
                if (!grid.rows[i].cells[0].childNodes[0].checked) {
                    count = false;
                    break;
                }
            }
        ...
        function checkAll(select) {
            var grid = document.getElementById('<%=gvList.ClientID %>');
            for (var i = 1; i < grid.rows.length; i++) {
                grid.rows[i].cells[0].childNodes[0].checked = select;
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../AFCModule/frmMessagesComposeRO.aspx"><font size="2" color="red"><b>| Compose Message |</b></font></a></td>
                <td><a href="../AFCModule/frmMessagesSentRO.aspx"><font size="2"><b>| Sent Messages |</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
                ...
                <table class="AppFormTable" id="tblMessage" runat="server">
                    <tr>
                        ...
                        <td style="width: 85%;">
                            ...
                            &nbsp;&nbsp;
                            <asp:RadioButton ID="rbnAFC" runat="server" CssClass="AClass" Text=" SC" GroupName="Broadcast" AutoPostBack="True" OnCheckedChanged="Broadcast_CheckedChanged" />
                            <br />
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="fileInput1" type="file" runat="server" /><br />
                            (Only .JPG, .JPEG, .PDF, .ZIP, .RAR, .XLS, .XLSX Formats Supported)</td>
                    </tr>
                        ...
                        <td>
                            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth="1px" BorderStyle="Solid" CssClass="DataGrid">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="RO/SC Code" DataField="LoginID">
                                    ...
                                    <asp:BoundField HeaderText="RO/SC Name" DataField="Name">
