...
{
    public partial class frmCancelOptionFormCAPRound2 : System.Web.UI.Page
    {
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (reg.cancelOptionFormCAPRound2(PID, txtReasonForCancellation.Text, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
