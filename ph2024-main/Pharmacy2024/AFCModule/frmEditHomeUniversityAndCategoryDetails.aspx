<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmEditHomeUniversityAndCategoryDetails.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmEditHomeUniversityAndCategoryDetails" %>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Home University & Category Details">
        ...
        <asp:UpdatePanel runat="server" ID="upHomeUniversity">
            <ContentTemplate>
                <table class="AppFormTable">
                    <tr>
                        <th colspan="2" align="left">Home University Details
                        </th>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr runat="server" id="trDocumentForTypeA">
                        <td align="right">Select Document for Type-A
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlDocumentForTypeA" runat="server"></asp:DropDownList>
                    ...
                    <tr runat="server" id="trMothersName">
                        <td align="right">Enter Mother's Name as appeared in Domicile Certificate
                        </td>
                        <td valign="top">
                    ...
                    <tr runat="server" id="trQ2">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlDistrict2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDistrict2_SelectedIndexChanged"></asp:DropDownList>
                            <font color="red"><sup>*</sup></font>
                    ...
                    <tr runat="server" id="trQ21">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlTaluka2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlTaluka2_SelectedIndexChanged"></asp:DropDownList>
                            <font color="red"><sup>*</sup></font>
                    ...
                    <tr>
                        <td style="width: 50%;" align="right">Your Home University
                        </td>
                        <td style="width: 50%;">
                    ...
                    <tr runat="server" id="trCategoryHead">
                        <th colspan="2" align="left" style="border-top-width: 0px;">Category Details
                        </th>
                    </tr>
                    <tr runat="server" id="trCategory">
                        <td align="right">Select Category to Which You Belong
                        </td>
                        <td>
                    ...
                    <tr id="trAppliedForEWS1" runat="server" visible="false">
                        <td align="right">Your Annual Family Income
                        </td>
                        <td>
                    ...
                    <tr runat="server" id="trOpenCaste">
                        <td align="right">Enter Caste Name
                        </td>
                        <td>
                            <asp:TextBox ID="txtCasteNameForOpen" runat="server" MaxLength="100" autocomplete="off"></asp:TextBox>
                            <font color="red"><sup>*</sup></font>
                    ...
                    <tr runat="server" id="trReservedCaste">
                        <td align="right">Select Caste to Which You Belong
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlCaste" runat="server"></asp:DropDownList>
                            <font color="red"><sup>*</sup></font>
                    ...
                    <tr runat="server" id="trCasteValidityStatus">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCasteValidityStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCasteValidityStatus_SelectedIndexChanged">
                                <asp:ListItem Value="0">-- Select --</asp:ListItem>
                ...
                <table runat="server" id="tblCasteValidityApplied" class="AppFormTable">
                    <tr>
                        <td style="width: 50%; border-top-width: 0px;" align="right">Caste / Tribe Validity Certificate Application Number
                        </td>
                        <td style="width: 50%; border-top-width: 0px;">
                            <asp:TextBox ID="txtCVCApplicationNo" runat="server" MaxLength="18"></asp:TextBox>
                            <font color="red"><sup>*</sup></font>
                            ...
                            <%--<asp:RegularExpressionValidator ID="revApplicationNo" runat="server" ControlToValidate="txtCVCApplicationNo"
                                Display="None" ErrorMessage="Please Enter Validity Certificate Application Number" ValidationExpression="^[1-9]\d{9}$"></asp:RegularExpressionValidator>--%>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="AppFormTable">
                    <tr runat="server" id="trNCLStatus">
                        <td style="width: 50%; border-top-width: 0px;" align="right">Select Non-Creamy Layer Certificate Status
                        </td>
                        <td style="width: 50%; border-top-width: 0px;">
                ...
                <table runat="server" id="tblNCLApplied" class="AppFormTable">
                    <tr>
                        <td align="right" style="width: 50%; border-top-width: 0px;">Non-Creamy Layer Certificate Application Number
                        </td>
                        <td style="width: 50%; border-top-width: 0px;">
                    ...
                    <tr>
                        <td align="right">Non-Creamy Layer Certificate Application Date
                        </td>
                        <td>
                    ...
                    <tr>
                        <td align="right">Non-Creamy Layer Certificate Issuing Authority Name
                        </td>
                        <td>
                ...
                <table class="AppFormTable">
                    ...
                    <tr runat="server" id="trInstruction2">
                        <td style="border-top-width: 0px;">
                            <p align="justify"><font color="red">You are required to submit the Caste Certificate clearly mentioning the Category of the Candidate and also the remarks that the Caste is recognised as backward class in the State of Maharashtra at the time of Document Verification at SC.</font></p>
                        </td>
                    </tr>
                    <tr runat="server" id="trInstruction3">
                        <td style="border-top-width: 0px;">
                            <p align="justify"><font color="red">You are required to submit the Caste / Tribe Validity Certificate in the name of the Candidate, issued by the caste validity committee of Maharashtra State at the time of Document Verification at SC.</font></p>
                        </td>
                    </tr>
                    ...
                    <tr runat="server" id="trInstruction5">
                        <td style="border-top-width: 0px;">
                            <p align="justify"><font color="red">You are required to submit Non-Creamy Layer Certifiacte issued by Sub Divisional officer or Deputy Collector of the district in addition to the caste certificate valid upto 31st March <%=NextYear%> at the time of Document Verification at SC.</font></p>
                        </td>
                    </tr>
                    ...
                    <tr runat="server" id="trInstruction7">
                        <td style="border-top-width: 0px;">
                            <p align="justify"><font color="red">You are required to submit Eligibility Certificate for Economically Weaker Section at the time of Document Verification at SC.</font></p>
                        </td>
                    </tr>
                    <tr runat="server" id="trInstruction8">
                        <td style="border-top-width: 0px;">
                            <p align="justify"><font color="red">You are required to submit Receipt of Submission of Application Form for Caste / Tribe Validity Certificate at the time of Document Verification at SC.</font></p>
                        </td>
                    </tr>
                    <%--<tr runat="server" id="trInstruction9">
                        <td style="border-top-width: 0px;">
                            <p align="justify"><font color="red">You are required to submit Receipt of Submission of Application Form for Non-Creamy Layer Certificate at the time of Document Verification at SC.</font></p>
                        </td>
                    </tr>--%>
