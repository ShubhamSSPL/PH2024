<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmOptionFormCAPRound4.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmOptionFormCAPRound4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function OpenPopUpWindow() {
            window.open("frmPrintOptionFormCAPRound4.aspx?PID=<% = PID %>", "Password", "width=1000px,height=500px,resizable=yes,scrollbars=yes");
        }
    </script>
            ...
            <tr>
                ...
                <td style="width: 90%; border-left-width: 0px;" align="center">
                    <b>
                        ...
                        <br />
                        <br />
                        <font size="2"><b>Receipt-cum-Acknowledgement of Option Form for Additional Round for Government / Government-Aided Institutes for Admission to First Year of Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D for the Academic Year <%= AdmissionYear %></b></font>
                    </b>
                </td>
            </tr>
        </table>
        ...
        <table class="AppFormTable">
            ...
            <tr>
                <td colspan="2">
                    <ul class="list-text">
                        <li>
                            <p align="justify">I have read all the rules of admission and Information brochure for admission to UG courses <%=CurrentYear%> and on understanding these Rules, I have filled this Option Form for consideration for allotment in Additional Round for Government / Government-Aided Institutes.</p>
                        </li>
                        <li>
                            <p align="justify">I am aware that if I get allotment / betterment in this round then my earlier admission in Govt, Aided or University Department (if any) shall be cancelled automatically and it will be mandatory for me to report to the allotted institute in this round.</p>
                        </li>
                        <li>
                            <p align="justify">I also know that vacancy created due to cancellation of admission (if any) shall be offered to other eligible candidate as per the inter se merit, therefore I shall not request for restoration of the earlier cancelled admission.</p>
                        </li>
                        <li>
                            <p align="justify">The rules of refund of fees due to cancellation shall be applicable, if I get allotment in this round.</p>
                        </li>
                    </ul>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <p align="justify">
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        The Option Form for Additional Round for Government / Government-Aided Institutes for Admission to First Year of Under Graduate Technical Course in B.Pharmacy & Post Graduate Pharm.D for the Academic Year <%= AdmissionYear %> is confirmed as per the choices given above. We hereby acknowledge the confirmed Option Form.
                    </p>
                </td>
            </tr>
            <tr>
