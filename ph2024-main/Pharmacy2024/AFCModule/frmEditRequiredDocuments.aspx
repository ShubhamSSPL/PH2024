<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.Master" AutoEventWireup="true" CodeBehind="frmEditRequiredDocuments.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmEditRequiredDocuments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Edit Confirmed Documents">
                ...
                <td colspan="4">
                    ...
                    <asp:GridView ID="gvDocuments" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth="1px" BorderStyle="Solid" CssClass="DataGrid" OnRowDataBound="gvDocuments_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblIsCompulsory" runat="server" Text='<%# Eval("IsCompulsory") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
    ...
    <script language="javascript" type="text/javascript">
        function ViewDoc(cntrl) {
            ...
            if (m > -1) {
                ...
                //                $('#<%=hdnApplicationURL.ClientID %>').value + "viewdocument.aspx?fn=" + documentName);
            }
            return false;
        }
    </script>
