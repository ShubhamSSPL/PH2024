<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" CodeBehind="frmMessagesComposeAdmin.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesComposeAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function SMSChanged() {
            if (document.getElementById('rightContainer_ContentTable2_txtSMSContent').value.length > 300) {
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../AFCModule/frmMessagesComposeAdmin.aspx"><font size="2" color="red"><b>| Compose Message |</b></font></a></td>
    ...
    <cc1:ContentBox ID="ContentTable2" runat="server" HeaderText="Compose Message">
        ...
        <asp:UpdatePanel runat="server" ID="upExamCenter" UpdateMode="Conditional">
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="chkBroadcastAFC" />
                ...
                <table class="AppFormTable" id="tblMessage" runat="server">
                    <tr>
                        ...
                        <td style="width: 75%;">
                            ...
                            &nbsp;&nbsp;
                            <asp:CheckBox ID="chkBroadcastAFC" runat="server" CssClass="AClass" Text=" ALL SC" AutoPostBack="True" OnCheckedChanged="Broadcast_CheckedChanged" />
                            &nbsp;&nbsp;
