...
{
    public partial class frmMessagesNonRepliedRO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    gvMessages.DataSource = reg.getRONonRepliedMessages("AFC", Session["UserLoginID"].ToString());
                    gvMessages.DataBind();
        ...
        protected void gvMessages_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("../AFCModule/frmReplyMessagesRO.aspx?From=" + From + "&Sender=" + From);
            }
            catch (Exception ex)
            {
                Logging.LogException(ex, "[Page Level Error]");
