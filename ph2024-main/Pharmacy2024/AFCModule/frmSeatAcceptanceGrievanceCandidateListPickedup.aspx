<%@ Page Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" AutoEventWireup="true" CodeBehind="frmSeatAcceptanceGrievanceCandidateListPickedup.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmSeatAcceptanceGrievanceCandidateListPickedup" %>
        ...
        <div class="col-xl-12">
            <div class="card mb-4">
                <div class="card-header card-Status">
                  ...
                  Seat Acceptance Grievance Picked Up List
                </div>
                <div class="card-body" style="overflow-x: auto" >
                    <div class="row w-100 mx-auto">
                        <div class="col-xl-12">
                            <div class="card mb-4 border-0">
                                <asp:GridView ID="gvCandidateList" runat="server" AutoGenerateColumns="False" Width="100%"   OnRowCommand="gvCandidateList_RowCommand" OnPreRender="gvCandidateList_PreRender" CssClass="table table-striped DataGridForBootstrap table-responsive">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ModifiedDateTime" HeaderText="Picked Up Date Time">
                                            <ItemStyle HorizontalAlign="Center" Width="25%" CssClass="Item" Wrap="false" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="Header" Wrap="false" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ModifiedBy" HeaderText="Picked Up By">
                                            <ItemStyle HorizontalAlign="Center" Width="10%" CssClass="Item" Wrap="false" />
                                            <HeaderStyle HorizontalAlign="Center" CssClass="Header" Wrap="false" />
                                        </asp:BoundField>     
                                       
                                        <asp:ButtonField HeaderText="Verify Grievance" ButtonType="Button" CommandName="Verify" Text="Verify Grievance" ControlStyle-CssClass="InputButton">
