...
{
    public partial class frmSeatAcceptanceGrievanceCandidateListRejected : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    gvCandidateList.DataSource = reg.GetSeatAcceptanceRejectedGrievanceList(RegionID, InstituteID, AFCID, Global.CAPRound);
