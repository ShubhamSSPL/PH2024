...
{
    public partial class frmSubAFCWiseSeatAcceptanceGrievanceListForVerification : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet ds = reg.GetSubAFCWiseSeatAcceptanceGrievanceVerifcationCount(RegionID, InstituteID, Global.CAPRound);
                    if (UserTypeID == 21)
                    {
                    ...
                    hpr.NavigateUrl = "frmSeatAcceptanceGrievanceCandidateListVerification.aspx?RegionID=" + RegionID.ToString() + "&InstituteID=" + InstituteID.ToString() + "&AFCID=99";
                    hpr.Text = "<b>Total</b>";
