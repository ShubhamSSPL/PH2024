<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" CodeBehind="frmMessagesStarMarked.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesStarMarked" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentBox1" runat="server" HeaderVisible="false">
        <table class="AppFormTableWithOutBorder">
            <tr align="center">
                ...
                <td><a href="../AFCModule/frmMessagesStarMarked.aspx"><font size="2" color="red"><b>| Star Marked Messages |</b></font></a></td>
            </tr>
        </table>
    </cc1:ContentBox>
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Replied Messages">
        ...
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="2" BorderWidth="1px" BorderStyle="Solid" OnRowDataBound="gvMessages_RowDataBound" OnSelectedIndexChanging="gvMessages_SelectedIndexChanging" CssClass="DataGrid">
            <Columns>
                ...
                <asp:BoundField DataField="Subject" HeaderText="Subject">
                    <ItemStyle Width="20%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="Message">
                    <ItemTemplate>
                        <%# Eval("Message") %>
                        <br />
                        <b>Sent Time -  <%# Eval("SentDateTime","{0:dd/MM/yyyy hh:mm:ss tt}") %> </b>
                    </ItemTemplate>
                    <ItemStyle Width="25%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:TemplateField>
               <%-- <asp:BoundField DataField="SentDateTime" HeaderText="Sent Time" DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt}">
                ...
                <asp:TemplateField HeaderText="Reply">
                    ...
                    <ItemTemplate>
                        <%# Eval("RepliedMessage") %>
                        <br />
                        <b>Replied DateTime -  <%# Eval("RepliedDateTime","{0:dd/MM/yyyy hh:mm:ss tt}") %> </b>
                    </ItemTemplate>

                    <ItemStyle Width="25%" HorizontalAlign="Left" Font-Size="9px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:TemplateField>
                <%--<asp:BoundField DataField="" HeaderText="Reply Time" DataFormatString="{0:dd/MM/yyyy hh:mm:ss tt}">
                    <ItemStyle Width="12%" HorizontalAlign="Center" Font-Size="9px" CssClass="Item" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:BoundField>--%>
    ...
    <script type="text/javascript">
        ...
        function OpenViewDocumentPopUp(filePathFromDB) {
            ...
            switch (extension) {
                ...
                case 'zip':
                case 'rar':
                    document.getElementById('divDocument').innerHTML = '<iframe src="' + filebyteStreamPath + '" autostart="true" style="width:100%;height:98%;">';
                    break;
                case 'pdf':
