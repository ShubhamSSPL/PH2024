<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/DynamicMasterPageSB.master" CodeBehind="frmMessagesNonRepliedAdmin.aspx.cs" Inherits="Pharmacy2024.AFCModule.frmMessagesNonRepliedAdmin" %>
        ...
        <asp:GridView ID="gvMessages" runat="server" AutoGenerateColumns="False" Width="100%" OnSelectedIndexChanging="gvMessages_SelectedIndexChanging" CssClass="DataGrid">
            <Columns>
                ...
                <asp:BoundField DataField="Message" HeaderText="Message" HtmlEncode = "false">
                    <ItemStyle Width="43%" HorizontalAlign="Left" CssClass="Item" Wrap="true" />
                    <HeaderStyle HorizontalAlign="Center" CssClass="Header" />
                </asp:BoundField>
