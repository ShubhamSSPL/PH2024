<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmOptionFormSummary.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound1.frmOptionFormSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable3" runat="server" HeaderText="Preferences Given By You">
                ...
                <td>
                    <div class="row w-100 mx-auto">
                        ...
                        <div class="col-sm-7 text-md-right px-0">
                            ...
                            <asp:Button ID="btnInsertDirect" runat="server" Text="Insert Choice Code Directly" CssClass="InputButton Optionfrmbtn1" BackColor="#d9332c" OnClick="btnInsertDirect_Click" CausesValidation="false"></asp:Button>
        ...
        <asp:GridView ID="gvPreferencedOptionsList" runat="server" AutoGenerateColumns="False" Width="100%" CellPadding="5" CssClass="DataGrid table-responsive">
            <Columns>
        ...
        <table class="AppFormTableWithOutBorder">
            <tr>
                <td align="center">
                    <asp:Button ID="btnChangePreferances" runat="server" Text="<<< Change Preferences" OnClick="btnChangePreferances_Click" CssClass="InputButton" BackColor="#d9332c"></asp:Button>

                    <asp:Button ID="btnProceed" runat="server" Text="Save & Proceed >>>" CssClass="InputButton" OnClick="btnProceed_Click"></asp:Button>
                </td>
            </tr>
        </table>
        <br />
                    ...
                    <tr>
                        <td colspan="4">
                            <ol class="list-text">
                                ...
                                <li>
                                    <p align="justify">Carefully check the Preferences given by you to Courses and Institutes displayed below.</p>
                                </li>
                                <li>
                                    <p align="justify">If you again wish to change the Preferences click on the 'Change preferences' Button.</p>
                                </li>
                                <li>
                                    <p align="justify">If you are sure about the preferences set for courses and Institutes then click on 'Confirm Options' Button.</p>
                                </li>
                                <li>
                                    <p align="justify">Once you Confirm your Preferences, you will not be able to Edit it.</p>
                                </li>
                                <li>
                                    <p align="justify">If you want to Insert a Choice Code to a particular position, then click on 'Insert Choice Code' Button.</p>
                                </li>
                                <li>
                                    <p align="justify">If you want to Move a Preferenced Choice Code to a particular position, then click on 'Move Choice Code' Button.</p>
                                </li>
                            </ol>
                        </td>
                    </tr>
