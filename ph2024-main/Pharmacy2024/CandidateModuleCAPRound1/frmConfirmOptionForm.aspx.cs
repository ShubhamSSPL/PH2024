...
namespace Pharmacy2024.CandidateModuleCAPRound1
{
    public partial class frmConfirmOptionForm : System.Web.UI.Page
    {
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            if (reg.GetPreferancedOptionsListOnlyTFWSSelect(objSessionData.PID))
            {
            ...
            {
                Response.Redirect("../CandidateModuleCAPRound1/frmVerifyAndConfirmOptionForm.aspx?tms=101", true);
            }
        }
