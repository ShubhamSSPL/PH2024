<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DynamicMasterPageWithOutLeftMenuSB.Master" AutoEventWireup="true" CodeBehind="frmMoveChoiceCode.aspx.cs" Inherits="Pharmacy2024.CandidateModuleCAPRound1.frmMoveChoiceCode" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="rightContainer" runat="Server">
    ...
    <cc1:ContentBox ID="ContentTable1" runat="server" HeaderText="Move Choice Code">
        ...
        <asp:UpdatePanel runat="server" ID="upMoveOptions">
            <ContentTemplate>
                <table class="AppFormTable">
                    <tr>
                        <td style="width: 40%" align="right">Select Preference Number to which you want to Move</td>
                        <td style="width: 60%">
                            <asp:DropDownList ID="ddlPreferenceNo" runat="server" Width="30%"></asp:DropDownList>
                            <font color="red"><sup>*</sup></font>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">Select Choice Code to which you want to Move</td>
                        <td style="width: 50%">
                            <asp:DropDownList ID="ddlChoiceCode" Width="90%" runat="server"></asp:DropDownList>
                            <font color="red"><sup>*</sup></font>
                            <asp:CompareValidator ID="cvChoiceCode" runat="server" ControlToValidate="ddlChoiceCode" Display="None" ErrorMessage="Please Select Choice Code." Operator="NotEqual" ValueToCompare="0" ValidationGroup="Move"></asp:CompareValidator>
                        </td>
                    </tr>
                </table>
                <br />
                <table class="AppFormTableWithOutBorder">
                    <tr>
                        <td align="center">
                            <asp:Button ID="btnMove" runat="server" Text="Move Choice Code" CssClass="InputButton" BackColor="#5cb85c" OnClick="btnMove_click" ValidationGroup="Move" />
                            <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowSummary="False" ShowMessageBox="True" ValidationGroup="Move" />
                        </td>
                    </tr>
                </table>
                <br />
