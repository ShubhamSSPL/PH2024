    ...
    public partial class frmMoveChoiceCode : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    DataSet dsCurrentLink = reg.getCurrentLinkCAPRound1(objSessionData.PID, "frmMoveChoiceCode.aspx");
        ...
        protected void btnMove_click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (reg.moveOptionCAPRound1(objSessionData.PID, PreferenceNo, ChoiceCode, Session["UserLoginID"].ToString(), UserInfo.GetIPAddress()))
                {
                    case 0:
        ...
        {
            Response.Redirect("../CandidateModuleCAPRound1/frmInsertChoiceCodeDirect.aspx?tms=101");
        }
